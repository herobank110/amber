...
$p_title = filter_input(INPUT_POST, 'title', FILTER_SANITIZE_SPECIAL_CHARS);
$p_when = filter_input(INPUT_POST, 'when', FILTER_SANITIZE_SPECIAL_CHARS);
...
if (!$p_id || !$p_title || !$p_when || !$p_poster || !$p_thumb || !$p_facebook) {
