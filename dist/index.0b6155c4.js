...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class D extends K{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function Z(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const W={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},O=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:Z,toHexString:Z},W,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=W.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return W.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=W.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return W.toHexString(r)}}];class N extends K{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,O.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=Z(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class H extends K{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new G(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new j(this,e,t,n,i,r);case"boolean":return new D(this,e,t);case"string":return new X(this,e,t);case"function":return new H(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
	 ...
	 * @returns {Controller}
	 */addColor(e,t,n=1){return new N(this,e,t,n)}/**
...
n(i.find(".titleH")),i)},eB=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(A())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;// returns a full url string, for easier parsing and validation later.
    ...
    })})),ed=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),eh=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(v(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"})),ef=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],ep=t=>/*@__PURE__*/e(a)("<div>",{class:"pieceList"}).append(...t.map(t=>/*@__PURE__*/e(a)("<details>",{class:"piece"}).append(/*@__PURE__*/e(a)("<summary>",{text:t.composer+" - "+t.name}),/*@__PURE__*/e(a)("<span>",{html:"Played in:&nbsp;"}),...t.concerts.map(e=>E({href:`/concert/${e.id}`,text:e.title})))));/*@__PURE__*/e(a)(()=>void(eg(),Q(),window.addEventListener(b,eg),window.addEventListener("popstate",eg)));const eA={"/archive":function(){L().appendTo(document.body),m().appendTo(document.body)},"/catalogue":function(){C().appendTo(document.body),(V().then(t=>{/*@__PURE__*/e(a)("#cataloguePage .pieceList").replaceWith(ep(ef))}),ef.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),ep([]))).appendTo(document.body),m().appendTo(document.body)},"/admin":function(){$().appendTo(document.body)},"/concert/new":em,"/concert/:id":ev,"/concert/:id/edit":em};function eg(){// find handler
for(let[e,t]of(// reset state if re-using SPA
window.scrollTo(0,0),document.body.innerHTML="",Object.entries(eA))){let n=RegExp("^"+e.replace(/:\w+/,"\\w+")+"$");if(n.test(location.pathname)){console.log(`Route matched: '${e}' for '${location.pathname}'`),t();return}}// default handler
...
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(y("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new _,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function em(){C().appendTo(document.body),(await ec()).appendTo(document.body),m().appendTo(document.body)}async function ev(){C().appendTo(document.body),(await er()).appendTo(document.body),m().appendTo(document.body)}