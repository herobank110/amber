...
(s=s.replace(T,"$1")||void 0),""!==s||eF(e)||(s=E.style(e,t)),!h.pixelBoxStyles()&&eK.test(s)&&eN.test(t)&&(// Remember the original values
...
n(i.find(".titleH")),i)},eg=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(k({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(m())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;// returns a full url string, for easier parsing and validation later.
    return i.set("src",e),i.set("x",t.toString()),i.set("y",n.toString()),"https://roathchamber.org/php/resize.php?"+i.toString()}(o,160,120),l=ew(),c={id:t,title:n,when:i,poster:o,thumb:s,programme:l};return r&&(c.facebook=r),c}(),n=new/*@__PURE__*/(e(es))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){console.debug(`saveConcert(${JSON.stringify(e)})`);let t=V(g(A({},e),{// Set the operation explicitly.
    op:-1==e.id?"insert":"update"}));return new Promise(m()?(e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)}:(n,i)=>{fetch(R,{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),// Get the inserted ID if it was an insert, otherwise just
...
setTimeout(()=>{let i;let r=document.activeElement;r instanceof HTMLElement&&(i=-1==(i=/*@__PURE__*/e(a)(r).parent().find("input").index(r))?void 0:i),/*@__PURE__*/e(a)(".programmeItems").replaceWith(ey({items:n})),void 0!=i&&/*@__PURE__*/e(a)(".programmeItems li").eq(t.index).find("input").eq(i).trigger("focus")},0);return}/*@__PURE__*/e(a)(".programmeItems").replaceWith(ey({items:n}))}}}const ex=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eS=t=>/*@__PURE__*/e(a)("<div>",{class:"pieceList"}).append(...t.map(t=>/*@__PURE__*/e(a)("<details>",{class:"piece"}).append(/*@__PURE__*/e(a)("<summary>",{text:t.composer+" - "+t.name}),/*@__PURE__*/e(a)("<span>",{html:"Played in:&nbsp;"}),...t.concerts.map(e=>k({href:`/concert/${e.id}`,text:e.title})))));/*@__PURE__*/e(a)(()=>void(eT(),b(),window.addEventListener("popstate",eT),window.addEventListener("unload",()=>{// If we leave the page, clear the session storage
    // Ie .if we manually refresh the page, reload the db.
    sessionStorage.clear()})));const ek={"/admin":eQ(()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:eo()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),m()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=eo()}):/*@__PURE__*/e(a)())),{navAndFooter:!1}),"/catalogue":eQ(function(){return q().then(t=>{/*@__PURE__*/e(a)("#cataloguePage .pieceList").replaceWith(eS(ex))}),ex.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),eS([]))}),"/concerts":eQ(()=>(q().then(t=>{/*@__PURE__*/e(a)(".concertsGrid").replaceWith(L(t))}),/*@__PURE__*/e(a)("<div>",{id:"archivePage"}).append(/*@__PURE__*/e(a)("<main>").append(E()?P():/*@__PURE__*/e(a)(),L([]))))),"/concert/new":eQ(ep),"/concert/:id":eQ(ec),"/concert/:id/edit":eQ(ep)};function eT(){// find handler
...
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(x("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new er,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}function eQ(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&z().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&w().appendTo(document.body)}}