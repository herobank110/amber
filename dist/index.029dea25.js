...
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}E.escapeSelector=function(e){return(e+"").replace(T,q)},function(){var t,n,r,s,c,u,F,d,f,p,g=a,m=E.expando,v=0,y=0,b=ee(),C=ee(),T=ee(),q=ee(),R=function(e,t){return e===t&&(c=!0),0},U="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
...
i[A.childNodes.length].nodeType}catch(e){g={apply:function(e,t){a.apply(e,o.call(t))},call:function(e){a.apply(e,o.call(arguments,1))}}}function $(e,t,n,i){var r,o,s,a,l,c,B,F=t&&t.ownerDocument,p=t?t.nodeType:9;// Return early from calls with invalid selector or context
...
(c=el(e)).length;o--;)c[o]=(a?"#"+a:":scope")+" "+ec(c[o]);B=c.join(",")}try{return g.apply(n,F.querySelectorAll(B)),n}catch(t){q(e,!0)}finally{a===m&&t.removeAttribute("id")}}}// All others
...
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(e.ownerDocument||e)!=u&&es(e);var i=n.attrHandle[t.toLowerCase()],r=i&&B.call(n.attrHandle,t.toLowerCase())?i(e,t,!d):void 0;return void 0!==r?r:e.getAttribute(t)},$.error=function(e){throw Error("Syntax error, unrecognized expression: "+e)},/**
...
(u=f[m]||(f[m]={}))[e]||[])[0]===v&&c[1])&&c[2],B=F&&f.childNodes[F];B=++F&&B&&B[h]||// Fallback to seeking `elem` from the start
(g=F=0)||d.pop();)if(1===B.nodeType&&++g&&B===t){u[e]=[v,F,g];break}}else // xml :nth-child(...)
// or :nth-last-child(...) or :nth(-last)?-of-type(...)
if(A&&(g=F=(c=(u=t[m]||(t[m]={}))[e]||[])[0]===v&&c[1]),!1===g)// Use the same loop as above to seek `elem` from the start
for(;(B=++F&&B&&B[h]||(g=F=0)||d.pop())&&(!((a?w(B,p):1===B.nodeType)&&++g)||(A&&((u=B[m]||(B[m]={}))[e]=[v,g]),B!==t)););return(// Incorporate the offset, then check against cycle size
...
type:r[0].replace(Q," ")}),a=a.slice(i.length)),n.filter)(r=N[s].exec(a))&&(!c[s]||(r=c[s](r)))&&(i=r.shift(),o.push({value:i,type:s,matches:r}),a=a.slice(i.length));if(!i)break}return(// Return the length of the invalid excess
...
u[o]=B,B[2]=e(t,n,l))return!0}}return!1}}function eB(e){return e.length>1?function(t,n,i){for(var r=e.length;r--;)if(!e[r](t,n,i))return!1;return!0}:e[0]}function eF(e,t,n,i,r){for(var o,s=[],a=0,l=e.length,c=null!=t;a<l;a++)(o=e[a])&&(!n||n(o,i,r))&&(s.push(o),c&&t.push(a));return s}function ed(e,t/* Internal Use Only */){var i,o,s,a,c=[],B=[],F=T[e+" "];if(!F){for(t||(t=el(e)),a=t.length;a--;)(F=function e(t){for(var i,o,s,a=t.length,c=n.relative[t[0].type],u=c||n.relative[" "],B=c?1:0,F=eu(function(e){return e===i},u,!0),d=eu(function(e){return l.call(i,e)>-1},u,!0),h=[function(e,t,n){// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
var o=!c&&(n||t!=r)||((i=t).nodeType?F(e,t,n):d(e,t,n));return(// Avoid hanging onto element
// (see https://github.com/jquery/sizzle/issues/299)
...
s=++B;s<a&&!n.relative[t[s].type];s++);return function e(t,n,i,r,o,s){return r&&!r[m]&&(r=e(r)),o&&!o[m]&&(o=e(o,s)),et(function(e,s,a,c){var u,B,F,d,h=[],f=[],p=s.length,A=e||function(e,t,n){for(var i=0,r=t.length;i<r;i++)$(e,t[i],n);return n}(n||"*",a.nodeType?[a]:a,[]),m=t&&(e||!n)?eF(A,h,t,a,c):A;// Apply postFilter
if(i?// Find primary matches
i(m,// If we have a postFinder, or filtered seed, or non-seed postFilter
// or preexisting results,
d=o||(e?t:p||r)?[]:s,a,c):d=m,r)for(u=eF(d,f),r(u,[],a,c),// Un-match failing elements by moving them back to matcherIn
B=u.length;B--;)(F=u[B])&&(d[f[B]]=!(m[f[B]]=F));if(e){if(o||t){if(o){for(// Get the final matcherOut by condensing this intermediate into postFinder contexts
u=[],B=d.length;B--;)(F=d[B])&&u.push(m[B]=F);o(null,d=[],u,c)}for(// Move matched elements from seed to results to keep them synchronized
B=d.length;B--;)(F=d[B])&&(u=o?l.call(e,F):h[B])>-1&&(e[u]=!(s[u]=F))}}else d=eF(d===s?d.splice(p,d.length):d),o?o(null,s,d,c):g.apply(s,d)})}(B>1&&eB(h),B>1&&ec(t.slice(0,B-1).concat({value:" "===t[B-2].type?"*":""})).replace(Q,"$1"),o,B<s&&e(t.slice(B,s)),s<a&&e(t=t.slice(s)),s<a&&ec(t))}h.push(o)}return eB(h)}(t[a]))[m]?c.push(F):B.push(F);// Save selector and tokenization
// Cache the compiled function
(F=T(e,(i=c.length>0,o=B.length>0,s=function(e,t,s,a,l){var F,h,f,p=0,A="0",m=e&&[],y=[],b=r,C=e||o&&n.find.TAG("*",l),w=v+=null==b?1:Math.random()||.1,x=C.length;// Add elements passing elementMatchers directly to results
...
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(r=t==u||t||l);A!==x&&null!=(F=C[A]);A++){if(o&&F){for(h=0,t||F.ownerDocument==u||(es(F),s=!d);f=B[h++];)if(f(F,t||u,s)){g.call(a,F);break}l&&(v=w)}// Track unmatched elements for set filters
...
g.apply(a,y),l&&!e&&y.length>0&&p+c.length>1&&E.uniqueSort(a)}return l&&(v=w,r=b),m},i?et(s):s))).selector=e}return F}/**
...
(s=B[0]=B[0].slice(0)).length>2&&"ID"===(a=s[0]).type&&9===t.nodeType&&d&&n.relative[s[1].type]){if(!(t=(n.find.ID(a.matches[0].replace(X,J),t)||[])[0]))return i;u&&(t=t.parentNode),e=e.slice(s.shift().value.length)}for(// Fetch a seed set for right-to-left matching
...
(u||ed(e,B))(r,t,!d,i,!t||G.test(e)&&eo(t.parentNode)||t),i)}ea.prototype=n.filters=n.pseudos,n.setFilters=new ea,// One-time assignments
...
promise:function(e,t){var n,i=1,r=E.Deferred(),o=this,s=this.length,a=function(){--i||r.resolveWith(o,[o])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";s--;)(n=ei.get(o[s],e+"queueHooks"))&&n.empty&&(i++,n.empty.add(a));return a(),r.promise(t)}});var el=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ec=RegExp("^(?:([+-])=|)("+el+")([a-z%]*)$","i"),eu=["Top","Right","Bottom","Left"],eB=A.documentElement,eF=function(e){return E.contains(e.ownerDocument,e)},ed={composed:!0};eB.getRootNode&&(eF=function(e){return E.contains(e.ownerDocument,e)||e.getRootNode(ed)===e.ownerDocument});var eh=function(e,t){// Inline style trumps all
...
// in the document.
eF(e)&&"none"===E.css(e,"display")};function ef(e,t,n,i){var r,o,s=20,a=i?function(){return i.cur()}:function(){return E.css(e,t,"")},l=a(),c=n&&n[3]||(E.cssNumber[t]?"":"px"),u=e.nodeType&&(E.cssNumber[t]||"px"!==c&&+l)&&ec.exec(E.css(e,t));if(u&&u[3]!==c){for(// Support: Firefox <=54
...
u.textContent="",F=0;o=B[F++];){// Skip elements already in the context collection (trac-4087)
 ...
 */E.event={global:{},add:function(e,t,n,i,r){var o,s,a,l,c,u,B,F,d,h,f,p=ei.get(e);// Only attach events to objects that accept data
...
u=E.extend({type:d,origType:f,data:i,handler:n,guid:n.guid,selector:r,needsContext:r&&E.expr.match.needsContext.test(r),namespace:h.join(".")},o),(F=l[d])||((F=l[d]=[]).delegateCount=0,(!B.setup||!1===B.setup.call(e,i,h,s))&&e.addEventListener&&e.addEventListener(d,s)),B.add&&(B.add.call(e,u),u.handler.guid||(u.handler.guid=n.guid)),r?F.splice(F.delegateCount++,0,u):F.push(u),// Keep track of which events have ever been used, for event optimization
E.event.global[d]=!0)},// Detach an event or set of events from an element
remove:function(e,t,n,i,r){var o,s,a,l,c,u,B,F,d,h,f,p=ei.hasData(e)&&ei.get(e);if(p&&(l=p.events)){for(c=// Once for each type.namespace in types; type may be omitted
...
s=o=F.length;o--;)u=F[o],(r||f===u.origType)&&(!n||n.guid===u.guid)&&(!a||a.test(u.namespace))&&(!i||i===u.selector||"**"===i&&u.selector)&&(F.splice(o,1),u.selector&&F.delegateCount--,B.remove&&B.remove.call(e,u));s&&!F.length&&(B.teardown&&!1!==B.teardown.call(e,h,p.handle)||E.removeEvent(e,d,p.handle),delete l[d])}E.isEmptyObject(l)&&ei.remove(e,"handle events")}},dispatch:function(e){var t,n,i,r,o,s,a=Array(arguments.length),l=E.event.fix(e),c=(ei.get(this,"events")||Object.create(null))[l.type]||[],u=E.event.special[l.type]||{};for(t=1,// Use the fix-ed jQuery.Event rather than the (read-only) native event
...
t=s(t);var r,o,a,l,c,u,B=0,F=e.length,d=F-1,p=t[0],A=f(p);// We can't cloneNode fragments that contain checked, in WebKit
...
for(l=(a=E.map(eb(r,"script"),eV)).length;B<F;B++)c=r,B!==d&&(c=E.clone(c,!0,!0),l&&// push.apply(_, arraylike) throws on ancient WebKit
...
m(c.textContent.replace(eR,""),c,u))}return e}function ez(e,t,n){for(var i,r=t?E.filter(t,e):e,o=0;null!=(i=r[o]);o++)n||1!==i.nodeType||E.cleanData(eb(i)),i.parentNode&&(n&&eF(i)&&eE(eb(i,"script")),i.parentNode.removeChild(i));return e}E.extend({htmlPrefilter:function(e){return e},clone:function(e,t,n){var i,r,o,s,a=e.cloneNode(!0),l=eF(e);// Fix IE cloning issues
...
for(r in i=n.call(e),t)e.style[r]=o[r];return i},eN=RegExp(eu.join("|"),"i");function eO(e,t,n){var i,r,o,s,a=eZ.test(t),// Retrieving style before computed somehow
...
var r,o,s,a=ee(t),l=eZ.test(t),c=e.style;// Check if we're setting a value
...
c.progress(c.opts.progress).done(c.opts.done,c.opts.complete).fail(c.opts.fail).always(c.opts.always),E.fx.timer(E.extend(l,{elem:e,anim:c,queue:c.opts.queue})),c}E.Animation=E.extend(ti,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return ef(n.elem,e,ec.exec(t),n),n}]},tweener:function(e,t){f(e)?(t=e,e=["*"]):e=e.match(W);for(var n,i=0,r=e.length;i<r;i++)n=e[i],ti.tweeners[n]=ti.tweeners[n]||[],ti.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var i,r,o,s,a,l,c,u,B="width"in t||"height"in t,F=this,d={},h=e.style,f=e.nodeType&&eh(e),p=ei.get(e,"fxshow");// Detect show/hide animations
...
l=!1,d)l||(p?"hidden"in p&&(f=p.hidden):p=ei.access(e,"fxshow",{display:c}),o&&(p.hidden=!f),f&&eA([e],!0),/* eslint-disable no-loop-func */F.done(function(){for(i in f||eA([e]),ei.remove(e,"fxshow"),d)E.style(e,i,d[i])})),// Per-property setup
...
try{n=new e.DOMParser().parseFromString(t,"text/xml")}catch(e){}return i=n&&n.getElementsByTagName("parsererror")[0],(!n||i)&&E.error("Invalid XML: "+(i?E.map(i.childNodes,function(e){return e.textContent}).join("\n"):t)),n};var tA=/^(?:focusinfocus|focusoutblur)$/,tg=function(e){e.stopPropagation()};E.extend(E.event,{trigger:function(t,n,i,r){var o,s,a,l,c,u,F,d,h=[i||A],g=B.call(t,"type")?t.type:t,m=B.call(t,"namespace")?t.namespace.split("."):[];// Don't do events on text and comment nodes
...
(u=c&&s[c])&&u.apply&&et(s)&&(t.result=u.apply(s,n),!1===t.result&&t.preventDefault());return t.type=g,!r&&!t.isDefaultPrevented()&&(!F._default||!1===F._default.apply(h.pop(),n))&&et(i)&&c&&f(i[g])&&!p(i)&&(// Don't re-trigger an onFOO event when we call its FOO() method
...
function tU(e,t,n,i){var r={},o=e===tQ;function s(a){var l;return r[a]=!0,E.each(e[a]||[],function(e,a){var c=a(t,n,i);return"string"!=typeof c||o||r[c]?o?!(l=c):void 0:(t.dataTypes.unshift(c),s(c),!1)}),l}return s(t.dataTypes[0])||!r["*"]&&s("*")}// A special extend for ajax options
...
n=n||{};var i,r,o,s,a,l,c,u,B,F,d=E.ajaxSetup({},n),h=d.context||d,f=d.context&&(h.nodeType||h.jquery)?E(h):E.event,p=E.Deferred(),g=E.Callbacks("once memory"),m=d.statusCode||{},v={},y={},b="canceled",C={readyState:0,// Builds headers hashtable if needed
...
tU(tk,d,n,C),c)return C;// Check for headers option
...
if(C.readyState=1,u&&f.trigger("ajaxSend",[C,d]),c)return C;d.async&&d.timeout>0&&(a=e.setTimeout(function(){C.abort("timeout")},d.timeout));try{c=!1,i.send(v,w)}catch(e){// Rethrow post-completion exceptions
...
C.statusCode(m),m=void 0,u&&f.trigger(B?"ajaxSuccess":"ajaxError",[C,d,B?F:A]),// Complete
g.fireWith(h,[C,b]),!u||(f.trigger("ajaxComplete",[C,d]),--E.active||E.event.trigger("ajaxStop")))}return C},getJSON:function(e,t,n){return E.get(e,t,n,"json")},getScript:function(e,t){return E.get(e,void 0,t,"script")}}),E.each(["get","post"],function(e,t){E[t]=function(e,n,i,r){// The url can be an options object (which then must have .url)
...
let e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}/**
	 ...
	 */destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}constructor(e,t,n,i,r="div"){/**
		 ...
		 * @type {HTMLElement}
		 */this.$name=document.createElement("div"),this.$name.classList.add("name"),K.nextNameID=K.nextNameID||0,this.$name.id=`lil-gui-name-${++K.nextNameID}`,/**
...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class Z extends K{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function D(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const W={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},N=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:D,toHexString:D},W,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=W.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return W.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=W.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return W.toHexString(r)}}];class O extends K{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,N.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=D(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class H extends K{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class j extends K{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class G extends K{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class X extends K{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const J=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new G(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new j(this,e,t,n,i,r);case"boolean":return new Z(this,e,t);case"string":return new X(this,e,t);case"function":return new H(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
	 ...
	 * @returns {Controller}
	 */addColor(e,t,n=1){return new O(this,e,t,n)}/**
	 ...
	 * @returns {GUI}
	 */addFolder(e){let t=new _({parent:this,title:e});return this.root._closeFolders&&t.close(),t}/**
	 * Recalls values that were saved with `gui.save()`.
	 * @param {object} obj
	 * @param {boolean} recursive Pass false to exclude folders descending from this GUI.
	 * @returns {this}
	 */load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{!(t instanceof H)&&t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}/**
...
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!Y&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(J),Y=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=o}}const $=()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:ee()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),A()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=ee()}):/*@__PURE__*/e(a)()));function ee(){return sessionStorage.getItem("adminLoginRedirectTo")||"/"}var et={};et=/******/function(e){/******/// The module cache
...
return n.call(this,e,0)}}}!function(){try{n="function"==typeof setTimeout?setTimeout:s}catch(e){n=s}try{i="function"==typeof clearTimeout?clearTimeout:a}catch(e){i=a}}();var c=[],u=!1,B=-1;function F(){u&&r&&(u=!1,r.length?c=r.concat(c):B=-1,c.length&&d())}function d(){if(!u){var e=l(F);u=!0;for(var t=c.length;t;){for(r=c,c=[];++B<t;)r&&r[B].run();B=-1,t=c.length}r=null,u=!1,function(e){if(i===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
...
var en={};async function ei(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e(en),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1],i=await V();return i.find(e=>e.id==n)}async function er(){let t=await ei();if(!t)throw Error("Concert not found");return /*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(es(t))}en=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const eo=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined",href:`/php/concertDelete.php?id=${t.id}`}).on("click",e=>{confirm("Are you sure you want to delete this concert?")||e.preventDefault()})),es=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(E({href:"/archive",text:"\uD83E\uDC84 Back to All Concerts",class:"backButton"}),eo({id:t.id}),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",hour12:!0}).format(new Date(n))),class:"when"})),t.facebook?y(t.facebook):/*@__PURE__*/e(a)())},ea={success:!0,url:"https://wales-armenia.87.org.uk/share/homePage/splash01A.jpg"};async function el(t){let n;console.debug(`uploadFile(${t.name})`);let i=new/*@__PURE__*/(e(et))({text:"Uploading, please wait...",type:"info",layout:"center"});if(i.show(),A())await new Promise(e=>setTimeout(e,1e3)),n=ea;else{let e=new FormData;e.append("file",t),n=await fetch("/php/upload.php",{method:"POST",body:e}).then(e=>e.json())}if(i.close(),!n.success){new/*@__PURE__*/(e(et))({text:"Failed to upload file: "+n.error,type:"error",layout:"center",timeout:3e3}).show();return}return new/*@__PURE__*/(e(et))({text:"File uploaded successfully",type:"success",layout:"center",timeout:3e3}).show(),n.url}async function ec(){let t=await ei();if(!t)throw Error("Concert not found");console.log(`Editing concert ${t.id}`);// Start with the viewer page and modify it to the things we want.
let n=await er();return n.append(/*@__PURE__*/e(a)("<input>",{type:"hidden",class:"idInput",value:t.id})),n.addClass("concertEditorPage"),n.find(".adminControls").remove(),n.find(".posterWrap").append(eF()),n.find(".title").replaceWith(eu({val:t.title})),n.find(".when").replaceWith(ed(t.when)),n.find(".fbLink").remove(),n.find(".concertDetails").append(eh({val:t.facebook})),n.find(".concertDetails").append(eB({id:t.id})),n}const eu=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
.on("input",t=>n(/*@__PURE__*/e(a)(t.target))));return(// initialize state.
n(i.find(".titleH")),i)},eB=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(A())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;return i.set("src",e),i.set("x",t.toString()),i.set("y",n.toString()),"/php/resize.php?"+i.toString()}(o,160,120),l={id:t,title:n,when:i,poster:o,thumb:s};return r&&(l.facebook=r),l}(),n=new/*@__PURE__*/(e(et))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){if(console.debug(`saveConcert(${JSON.stringify(e)})`),A())return new Promise((e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)});let t=function(e){let t=new FormData;for(let[n,i]of Object.entries(e))t.append(n,i.toString());return t}(e);return new Promise((e,n)=>{fetch("/php/concertEdit.php",{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),e(t.id)}).catch(n)})})(t).then(t=>{n.close(),new/*@__PURE__*/(e(et))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),window.history.pushState({},"",`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(et))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),E({text:"Cancel",class:"adminButton",href:-1==t.id?"/archive":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),eF=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{text:"Click to Upload",for:"posterInput"}),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",t=>{var n;let i=null===(n=t.target.files)||void 0===n?void 0:n[0];console.debug("posterControls: File changed: ",i),i&&el(i).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
    })})),ed=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),eh=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(v(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));/*@__PURE__*/e(a)(()=>void(ep(),T(),window.addEventListener(b,ep),window.addEventListener("popstate",ep)));const ef={"/archive":function(){L().appendTo(document.body),m().appendTo(document.body)},"/admin":function(){$().appendTo(document.body)},"/concert/new":eA,"/concert/:id":eg,"/concert/:id/edit":eA};function ep(){// find handler
for(let[e,t]of(// reset state if re-using SPA
window.scrollTo(0,0),document.body.innerHTML="",Object.entries(ef))){let n=RegExp("^"+e.replace(/:\w+/,"\\w+")+"$");if(n.test(location.pathname)){console.log(`Route matched: '${e}' for '${location.pathname}'`),t();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=p(),C().prependTo(".t1"),m().appendTo(document.body),/** Prepare 10 year video autoplay on scroll in */function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
...
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(y("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new _,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function eA(){C().appendTo(document.body),(await ec()).appendTo(document.body),m().appendTo(document.body)}async function eg(){C().appendTo(document.body),(await er()).appendTo(document.body),m().appendTo(document.body)}