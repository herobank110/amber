...
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+V+"))|)"+k+"*\\]",P=":("+V+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+L+")*)|.*)\\)|)",M=RegExp(k+"+","g"),z=RegExp("^"+k+"*,"+k+"*"),K=RegExp("^"+k+"*([>+~]|"+k+")"+k+"*"),D=RegExp(k+"|>"),Z=new RegExp(P),W=RegExp("^"+V+"$"),O={ID:RegExp("^#("+V+")"),CLASS:RegExp("^\\.("+V+")"),TAG:RegExp("^("+V+"|[*])"),ATTR:RegExp("^"+L),PSEUDO:RegExp("^"+P),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+k+"*(even|odd|(([+-]|)(\\d*)n|)"+k+"*(?:([+-]|)"+k+"*(\\d+)|))"+k+"*\\)|)","i"),bool:RegExp("^(?:"+U+")$","i"),// For use in libraries implementing .is()
...
type:r[0].replace(Q," ")}),a=a.slice(i.length)),n.filter)(r=O[s].exec(a))&&(!c[s]||(r=c[s](r)))&&(i=r.shift(),o.push({value:i,type:s,matches:r}),a=a.slice(i.length));if(!i)break}return(// Return the length of the invalid excess
...
(s=s.replace(Q,"$1")||void 0),""!==s||eF(e)||(s=E.style(e,t)),!h.pixelBoxStyles()&&eK.test(s)&&eO.test(t)&&(// Remember the original values
...
let e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}/**
	 ...
	 */destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}constructor(e,t,n,i,r="div"){/**
		 ...
		 * @type {HTMLElement}
		 */this.$name=document.createElement("div"),this.$name.classList.add("name"),N.nextNameID=N.nextNameID||0,this.$name.id=`lil-gui-name-${++N.nextNameID}`,/**
...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class H extends N{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function j(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const G={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},X=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:j,toHexString:j},G,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=G.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return G.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=G.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return G.toHexString(r)}}];class J extends N{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,X.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=j(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class Y extends N{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class _ extends N{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class $ extends N{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class ee extends N{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const et=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new $(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new _(this,e,t,n,i,r);case"boolean":return new H(this,e,t);case"string":return new ee(this,e,t);case"function":return new Y(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
...
n(i.find(".titleH")),i)},ep=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(S({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(m())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;// returns a full url string, for easier parsing and validation later.
    return i.set("src",e),i.set("x",t.toString()),i.set("y",n.toString()),"https://roathchamber.org/php/resize.php?"+i.toString()}(o,160,120),l={id:t,title:n,when:i,poster:o,thumb:s};return r&&(l.facebook=r),l}(),n=new/*@__PURE__*/(e(eo))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){if(console.debug(`saveConcert(${JSON.stringify(e)})`),m())return new Promise((e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)});let t=U(g(A({},e),{// Set the operation explicitly.
    op:-1==e.id?"insert":"update"}));return new Promise((n,i)=>{fetch(q,{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),// Get the inserted ID if it was an insert, otherwise just
    // return the same ID to simplify app logic.
    n(-1==e.id?t.id:e.id)})// Reject so we can show an error message to the user.
    .catch(i)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await T(!1),new/*@__PURE__*/(e(eo))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),v(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(eo))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),S({text:"Cancel",class:"adminButton outlined",href:-1==t.id?"/concerts":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),eA=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{for:"posterInput"}).on("drop",e=>{var t,n,i,r;console.log("posterControls: Poster drop event"),e.preventDefault();let o=null!==(r=null===(i=e.originalEvent)||void 0===i?void 0:null===(n=i.dataTransfer)||void 0===n?void 0:null===(t=n.files)||void 0===t?void 0:t.item(0))&&void 0!==r?r:void 0;ev(o)}).on("dragover",e=>e.preventDefault()).append(/*@__PURE__*/e(a)("<span>",{text:"Click or Drop File"})),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("posterControls: File input changed");let n=null===(t=e.target.files)||void 0===t?void 0:t[0];ev(n)})),eg=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),em=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(I(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));function ev(t){console.debug(`onFileChanged(file=${t})`),t&&ed(t).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
})}const ey=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eb=t=>/*@__PURE__*/e(a)("<div>",{class:"pieceList"}).append(...t.map(t=>/*@__PURE__*/e(a)("<details>",{class:"piece"}).append(/*@__PURE__*/e(a)("<summary>",{text:t.composer+" - "+t.name}),/*@__PURE__*/e(a)("<span>",{html:"Played in:&nbsp;"}),...t.concerts.map(e=>S({href:`/concert/${e.id}`,text:e.title})))));/*@__PURE__*/e(a)(()=>void(eC(),b(),window.addEventListener("popstate",eC)));const eE={"/admin":ew(()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:er()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),m()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=er()}):/*@__PURE__*/e(a)())),{navAndFooter:!1}),"/catalogue":ew(function(){return T().then(t=>{/*@__PURE__*/e(a)("#cataloguePage .pieceList").replaceWith(eb(ey))}),ey.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),eb([]))}),"/concerts":ew(()=>(T().then(t=>{/*@__PURE__*/e(a)(".concertsGrid").replaceWith(L(t))}),/*@__PURE__*/e(a)("<div>",{id:"archivePage"}).append(/*@__PURE__*/e(a)("<main>").append(E()?V():/*@__PURE__*/e(a)(),L([]))))),"/concert/new":ew(eh),"/concert/:id":ew(el),"/concert/:id/edit":ew(eh)};function eC(){// find handler
...
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=p(),M().prependTo(".t1"),w().appendTo(document.body),/** Prepare 10 year video autoplay on scroll in */function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
...
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(x("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new ei,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}function ew(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&M().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&w().appendTo(document.body)}}