var e,t,n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function i(e){return e&&e.__esModule?e.default:e}var o={},r={},s=n.parcelRequire4688;null==s&&((s=function(e){if(e in o)return o[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return o[e]=n,t.call(n.exports,n,n.exports),n.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){r[e]=t},n.parcelRequire4688=s);var a=s.register;a("918dL",function(e,t){e.exports=s("kUB7u")(s("8rCFS").resolve("kLz5U")).then(()=>s("36rp5"))}),a("kUB7u",function(e,t){var i=s("1U9sw");e.exports=i(function(e){return new Promise(function(t,i){// Add a global function to handle when the script loads.
var o="i".concat((""+Math.random()).slice(2));n[o]=function(e){t(e),r()};// Remove script on load or error
var r=function(){delete n[o],s.onerror=null,s.remove()},s=document.createElement("script");s.async=!0,s.type="module",s.charset="utf-8",s.textContent="import * as m from '".concat(e,"'; ").concat(o,"(m);"),s.onerror=function(e){i(e),r()},document.head.appendChild(s)})})}),a("1U9sw",function(e,t){var n={},i={},o={};e.exports=function(e,t){return function(r){var s=function(e){switch(e){case"preload":return i;case"prefetch":return o;default:return n}}(t);return s[r]?s[r]:s[r]=e.apply(null,arguments).catch(function(e){throw delete s[r],e})}}});var l={};e="undefined"!=typeof window?window:l,t=function(e,t){var n,i=[],o=Object.getPrototypeOf,r=i.slice,s=i.flat?function(e){return i.flat.call(e)}:function(e){return i.concat.apply([],e)},a=i.push,l=i.indexOf,c={},u=c.toString,B=c.hasOwnProperty,F=B.toString,d=F.call(Object),h={},f=function(e){// Support: Chrome <=57, Firefox <=52
...
return"function"==typeof e&&"number"!=typeof e.nodeType&&"function"!=typeof e.item},p=function(e){return null!=e&&e===e.window},A=e.document,g={type:!0,src:!0,nonce:!0,noModule:!0};function v(e,t,n){var i,o,r=(n=n||A).createElement("script");if(r.text=e,t)for(i in g)// Support: Firefox 64+, Edge 18+
...
// via an object.
(o=t[i]||t.getAttribute&&t.getAttribute(i))&&r.setAttribute(i,o);n.head.appendChild(r).parentNode.removeChild(r)}function m(e){return null==e?e+"":"object"==typeof e||"function"==typeof e?c[u.call(e)]||"object":typeof e}/* global Symbol */// Defining this global in .eslintrc.json would create a danger of using the global
// unguarded in another place, it seems safer to define global only for this module
var b="3.7.1",y=/HTML$/i,E=function(e,t){// The jQuery object is actually just the init constructor 'enhanced'
...
var t=!!e&&"length"in e&&e.length,n=m(e);return!(f(e)||p(e))&&("array"===n||0===t||"number"==typeof t&&t>0&&t-1 in e)}function w(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()}E.fn=E.prototype={// The current version of jQuery being used
jquery:b,constructor:E,// The default length of a jQuery object is 0
...
push:a,sort:i.sort,splice:i.splice},E.extend=E.fn.extend=function(){var e,t,n,i,o,r,s=arguments[0]||{},a=1,l=arguments.length,c=!1;for("boolean"==typeof s&&(c=s,// Skip the boolean and the target
s=arguments[a]||{},a++),"object"==typeof s||f(s)||(s={}),a===l&&(s=this,a--);a<l;a++)// Only deal with non-null/undefined values
if(null!=(e=arguments[a]))for(t in e)i=e[t],"__proto__"!==t&&s!==i&&(c&&i&&(E.isPlainObject(i)||(o=Array.isArray(i)))?(n=s[t],r=o&&!Array.isArray(n)?[]:o||E.isPlainObject(n)?n:{},o=!1,// Never move original objects, clone them
s[t]=E.extend(c,r,i)):void 0!==i&&(s[t]=i));// Return the modified object
return s},E.extend({// Unique for each copy of jQuery on the page
expando:"jQuery"+(b+Math.random()).replace(/\D/g,""),// Assume jQuery is ready without the ready module
...
!!e&&"[object Object]"===u.call(e)&&(!(t=o(e))||"function"==typeof// Objects with prototype are plain iff they were constructed by a global Object function
(n=B.call(t,"constructor")&&t.constructor)&&F.call(n)===d))},isEmptyObject:function(e){var t;for(t in e)return!1;return!0},// Evaluates a script in a provided context; falls back to the global one
// if not specified.
globalEval:function(e,t,n){v(e,{nonce:t&&t.nonce},n)},each:function(e,t){var n,i=0;if(C(e))for(n=e.length;i<n&&!1!==t.call(e[i],i,e[i]);i++);else for(i in e)if(!1===t.call(e[i],i,e[i]))break;return e},// Retrieve the text value of an array of DOM nodes
text:function(e){var t,n="",i=0,o=e.nodeType;if(!o)for(;t=e[i++];)n+=E.text(t);return 1===o||11===o?e.textContent:9===o?e.documentElement.textContent:3===o||4===o?e.nodeValue:n},// results is for internal usage only
...
// document fragments.
return!y.test(t||n&&n.nodeName||"HTML")},// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
merge:function(e,t){for(var n=+t.length,i=0,o=e.length;i<n;i++)e[o++]=t[i];return e.length=o,e},grep:function(e,t,n){// Go through the array, only saving the items
// that pass the validator function
for(var i=[],o=0,r=e.length,s=!n;o<r;o++)!t(e[o],o)!==s&&i.push(e[o]);return i},// arg is for internal usage only
map:function(e,t,n){var i,o,r=0,a=[];// Go through the array, translating each of the items to their new values
if(C(e))for(i=e.length;r<i;r++)null!=(o=t(e[r],r,n))&&a.push(o);else for(r in e)null!=(o=t(e[r],r,n))&&a.push(o);// Flatten any nested arrays
...
E.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(e,t){c["[object "+t+"]"]=t.toLowerCase()});var I=i.pop,x=i.sort,k=i.splice,Q="[\\x20\\t\\r\\n\\f]",S=RegExp("^"+Q+"+|((?:^|[^\\\\])(?:\\\\.)*)"+Q+"+$","g");// Note: an element does not contain itself
...
var q=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function U(e,t){return t?// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}E.escapeSelector=function(e){return(e+"").replace(q,U)},function(){var t,n,o,s,c,u,F,d,f,p,g=a,v=E.expando,m=0,b=0,y=ee(),C=ee(),q=ee(),U=ee(),R=function(e,t){return e===t&&(c=!0),0},V="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
K="(?:\\\\[\\da-fA-F]{1,6}"+Q+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+",T="\\["+Q+"*("+K+")(?:"+Q+// Operator (capture 2)
"*([*^$|!~]?=)"+Q+// "Attribute values must be CSS identifiers [capture 5] or strings [capture 3 or capture 4]"
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+K+"))|)"+Q+"*\\]",z=":("+K+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+T+")*)|.*)\\)|)",Z=RegExp(Q+"+","g"),L=RegExp("^"+Q+"*,"+Q+"*"),D=RegExp("^"+Q+"*([>+~]|"+Q+")"+Q+"*"),P=RegExp(Q+"|>"),W=new RegExp(z),H=RegExp("^"+K+"$"),M={ID:RegExp("^#("+K+")"),CLASS:RegExp("^\\.("+K+")"),TAG:RegExp("^("+K+"|[*])"),ATTR:RegExp("^"+T),PSEUDO:RegExp("^"+z),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+Q+"*(even|odd|(([+-]|)(\\d*)n|)"+Q+"*(?:([+-]|)"+Q+"*(\\d+)|))"+Q+"*\\)|)","i"),bool:RegExp("^(?:"+V+")$","i"),// For use in libraries implementing .is()
// We use this for POS matching in `select`
needsContext:RegExp("^"+Q+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+Q+"*((?:-\\d)?\\d*)"+Q+"*\\)|)(?=[^-]|$)","i")},j=/^(?:input|select|textarea|button)$/i,O=/^h\d$/i,G=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,X=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
N=RegExp("\\\\[\\da-fA-F]{1,6}"+Q+"?|\\\\([^\\r\\n\\f])","g"),J=function(e,t){var n="0x"+e.slice(1)-65536;return t||(n<0?String.fromCharCode(n+65536):String.fromCharCode(n>>10|55296,1023&n|56320))},// Support: IE 9 - 11+, Edge 12 - 18+
...
try{g.apply(i=r.call(A.childNodes),A.childNodes),// Support: Android <=4.0
// Detect silently failing push.apply
// eslint-disable-next-line no-unused-expressions
i[A.childNodes.length].nodeType}catch(e){g={apply:function(e,t){a.apply(e,r.call(t))},call:function(e){a.apply(e,r.call(arguments,1))}}}function $(e,t,n,i){var o,r,s,a,l,c,B,F=t&&t.ownerDocument,p=t?t.nodeType:9;// Return early from calls with invalid selector or context
if(n=n||[],"string"!=typeof e||!e||1!==p&&9!==p&&11!==p)return n;// Try to shortcut find operations (as opposed to filters) in HTML documents
if(!i&&(es(t),t=t||u,d)){// If the selector is sufficiently simple, try using a "get*By*" DOM method
// (excepting DocumentFragment context, where the methods don't exist)
if(11!==p&&(l=G.exec(e))){// ID selector
if(o=l[1]){// Document context
if(9===p){if(!(s=t.getElementById(o)))return n;if(s.id===o)return g.call(n,s),n;// Element context
}else // getElementById can match elements by name instead of ID
if(F&&(s=F.getElementById(o))&&$.contains(t,s)&&s.id===o)return g.call(n,s),n}else if(l[2])return g.apply(n,t.getElementsByTagName(e)),n;else if((o=l[3])&&t.getElementsByClassName)return g.apply(n,t.getElementsByClassName(o)),n}// Take advantage of querySelectorAll
if(!U[e+" "]&&(!f||!f.test(e))){// qSA considers elements outside a scoping root when evaluating child or
...
if(B=e,F=t,1===p&&(P.test(e)||D.test(e))){for(// Expand context for sibling selectors
(F=X.test(e)&&er(t.parentNode)||t)==t&&h.scope||((a=t.getAttribute("id"))?a=E.escapeSelector(a):t.setAttribute("id",a=v)),r=// Prefix every selector in the list
(c=el(e)).length;r--;)c[r]=(a?"#"+a:":scope")+" "+ec(c[r]);B=c.join(",")}try{return g.apply(n,F.querySelectorAll(B)),n}catch(t){U(e,!0)}finally{a===v&&t.removeAttribute("id")}}}// All others
return eh(e.replace(S,"$1"),t,n,i)}/**
 * Create key-value caches of limited size
 * @returns {function(string, object)} Returns the Object data after storing it on itself with
 *	property name the (space-suffixed) string and (if the cache is larger than Expr.cacheLength)
 *	deleting the oldest entry
 */function ee(){var e=[];function t(i,o){return e.push(i+" ")>n.cacheLength&&delete t[e.shift()],t[i+" "]=o}return t}/**
 * Mark a function for special use by jQuery selector module
 * @param {Function} fn The function to mark
 */function et(e){return e[v]=!0,e}/**
 ...
 * @param {Function} fn
 */function eo(e){return et(function(t){return t=+t,et(function(n,i){// Match elements found at the specified indexes
 ...
 */function es(e){var t,i=e?e.ownerDocument||e:A;return i!=u&&9===i.nodeType&&i.documentElement&&(F=// Update global variables
(u=i).documentElement,d=!E.isXMLDoc(u),// Support: iOS 7 only, IE 9 - 11+
// Older browsers didn't support unprefixed `matches`.
p=F.matches||F.webkitMatchesSelector||F.msMatchesSelector,F.msMatchesSelector&&// Support: IE 11+, Edge 17 - 18+
...
h.getById=en(function(e){return F.appendChild(e).id=E.expando,!u.getElementsByName||!u.getElementsByName(E.expando).length}),// Support: IE 9 only
...
// anyway.
h.cssHas=en(function(){try{return u.querySelector(":has(*,:jqfake)"),!1}catch(e){return!0}}),h.getById?(n.filter.ID=function(e){var t=e.replace(N,J);return function(e){return e.getAttribute("id")===t}},n.find.ID=function(e,t){if(void 0!==t.getElementById&&d){var n=t.getElementById(e);return n?[n]:[]}}):(n.filter.ID=function(e){var t=e.replace(N,J);return function(e){var n=void 0!==e.getAttributeNode&&e.getAttributeNode("id");return n&&n.value===t}},// Support: IE 6 - 7 only
// getElementById is not reliable as a find shortcut
n.find.ID=function(e,t){if(void 0!==t.getElementById&&d){var n,i,o,r=t.getElementById(e);if(r){if(// Verify the id attribute
(n=r.getAttributeNode("id"))&&n.value===e)return[r];for(// Fall back on getElementsByName
o=t.getElementsByName(e),i=0;r=o[i++];)if((n=r.getAttributeNode("id"))&&n.value===e)return[r]}return[]}}),// Tag
...
en(function(e){var t;F.appendChild(e).innerHTML="<a id='"+v+"' href='' disabled='disabled'></a><select id='"+v+"-\r\\' disabled='disabled'><option selected=''></option></select>",e.querySelectorAll("[selected]").length||f.push("\\["+Q+"*(?:value|"+V+")"),e.querySelectorAll("[id~="+v+"-]").length||f.push("~="),e.querySelectorAll("a#"+v+"+*").length||f.push(".#.+[+~]"),e.querySelectorAll(":checked").length||f.push(":checked"),// Support: Windows 8 Native Apps
...
F.appendChild(e).disabled=!0,2!==e.querySelectorAll(":disabled").length&&f.push(":enabled",":disabled"),// Support: IE 11+, Edge 15 - 18+
// IE 11/Edge don't find elements on a `[name='']` query in some cases.
// Adding a temporary attribute to the document before the selection works
// around the issue.
// Interestingly, IE 10 & older don't seem to have the issue.
(t=u.createElement("input")).setAttribute("name",""),e.appendChild(t),e.querySelectorAll("[name='']").length||f.push("\\["+Q+"*name"+Q+"*="+Q+"*(?:''|\"\")")}),h.cssHas||// Our regular `try-catch` mechanism fails to detect natively-unsupported
...
for(t in $.matches=function(e,t){return $(e,null,null,t)},$.matchesSelector=function(e,t){if(es(e),d&&!U[t+" "]&&(!f||!f.test(t)))try{var n=p.call(e,t);// IE 9's matchesSelector returns false on disconnected nodes
if(n||h.disconnectedMatch||// As well, disconnected nodes are said to be in a document
// fragment in IE 9
e.document&&11!==e.document.nodeType)return n}catch(e){U(t,!0)}return $(t,u,null,[e]).length>0},$.contains=function(e,t){return(e.ownerDocument||e)!=u&&es(e),E.contains(e,t)},$.attr=function(e,t){// Set document vars if needed
// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(e.ownerDocument||e)!=u&&es(e);var i=n.attrHandle[t.toLowerCase()],o=i&&B.call(n.attrHandle,t.toLowerCase())?i(e,t,!d):void 0;return void 0!==o?o:e.getAttribute(t)},$.error=function(e){throw Error("Syntax error, unrecognized expression: "+e)},/**
 * Document sorting and removing duplicates
 * @param {ArrayLike} results
 */E.uniqueSort=function(e){var t,n=[],i=0,o=0;if(// Unless we *know* we can detect duplicates, assume their presence
//
// Support: Android <=4.0+
// Testing for detecting duplicates is unpredictable so instead assume we can't
// depend on duplicate detection in all browsers without a stable sort.
c=!h.sortStable,s=!h.sortStable&&r.call(e,0),x.call(e,R),c){for(;t=e[o++];)t===e[o]&&(i=n.push(o));for(;i--;)k.call(e,n[i],1)}return(// Clear input after sorting to release objects
// See https://github.com/jquery/sizzle/pull/225
s=null,e)},E.fn.uniqueSort=function(){return this.pushStack(E.uniqueSort(r.apply(this)))},(n=E.expr={// Can be adjusted by the user
cacheLength:50,createPseudo:et,match:M,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(e){return e[1]=e[1].replace(N,J),// Move the given value to match[3] whether quoted or unquoted
e[3]=(e[3]||e[4]||e[5]||"").replace(N,J),"~="===e[2]&&(e[3]=" "+e[3]+" "),e.slice(0,4)},CHILD:function(e){return(/* matches from matchExpr["CHILD"]
				1 type (only|nth|...)
...
e[4]=+(e[4]?e[5]+(e[6]||1):2*("even"===e[3]||"odd"===e[3])),e[5]=+(e[7]+e[8]||"odd"===e[3])):e[3]&&$.error(e[0]),e)},PSEUDO:function(e){var t,n=!e[6]&&e[2];return M.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":n&&W.test(n)&&// Get excess from tokenize (recursively)
(t=el(n,!0))&&// advance to the next closing parenthesis
(t=n.indexOf(")",n.length-t)-n.length)&&(// excess is a negative index
e[0]=e[0].slice(0,t),e[2]=n.slice(0,t)),e.slice(0,3))}},filter:{TAG:function(e){var t=e.replace(N,J).toLowerCase();return"*"===e?function(){return!0}:function(e){return w(e,t)}},CLASS:function(e){var t=y[e+" "];return t||(t=RegExp("(^|"+Q+")"+e+"("+Q+"|$)"),y(e,function(e){return t.test("string"==typeof e.className&&e.className||void 0!==e.getAttribute&&e.getAttribute("class")||"")}))},ATTR:function(e,t,n){return function(i){var o=$.attr(i,e);return null==o?"!="===t:!t||((o+="","="===t)?o===n:"!="===t?o!==n:"^="===t?n&&0===o.indexOf(n):"*="===t?n&&o.indexOf(n)>-1:"$="===t?n&&o.slice(-n.length)===n:"~="===t?(" "+o.replace(Z," ")+" ").indexOf(n)>-1:"|="===t&&(o===n||o.slice(0,n.length+1)===n+"-"))}},CHILD:function(e,t,n,i,o){var r="nth"!==e.slice(0,3),s="last"!==e.slice(-4),a="of-type"===t;return 1===i&&0===o?function(e){return!!e.parentNode}:function(t,n,l){var c,u,B,F,d,h=r!==s?"nextSibling":"previousSibling",f=t.parentNode,p=a&&t.nodeName.toLowerCase(),A=!l&&!a,g=!1;if(f){// :(first|last|only)-(child|of-type)
if(r){for(;h;){for(B=t;B=B[h];)if(a?w(B,p):1===B.nodeType)return!1;// Reverse direction for :only-* (if we haven't yet done so)
d=h="only"===e&&!d&&"nextSibling"}return!0}// non-xml :nth-child(...) stores cache data on `parent`
if(d=[s?f.firstChild:f.lastChild],s&&A){for(g=(F=(c=// Seek `elem` from a previously-cached index
(u=f[v]||(f[v]={}))[e]||[])[0]===m&&c[1])&&c[2],B=F&&f.childNodes[F];B=++F&&B&&B[h]||// Fallback to seeking `elem` from the start
(g=F=0)||d.pop();)if(1===B.nodeType&&++g&&B===t){u[e]=[m,F,g];break}}else // xml :nth-child(...)
// or :nth-last-child(...) or :nth(-last)?-of-type(...)
if(A&&(g=F=(c=(u=t[v]||(t[v]={}))[e]||[])[0]===m&&c[1]),!1===g)// Use the same loop as above to seek `elem` from the start
for(;(B=++F&&B&&B[h]||(g=F=0)||d.pop())&&(!((a?w(B,p):1===B.nodeType)&&++g)||(A&&((u=B[v]||(B[v]={}))[e]=[m,g]),B!==t)););return(// Incorporate the offset, then check against cycle size
(g-=o)===i||g%i==0&&g/i>=0)}}},PSEUDO:function(e,t){// pseudo-class names are case-insensitive
// https://www.w3.org/TR/selectors/#pseudo-classes
// Prioritize by case sensitivity in case custom pseudos are added with uppercase letters
// Remember that setFilters inherits from pseudos
var i,o=n.pseudos[e]||n.setFilters[e.toLowerCase()]||$.error("unsupported pseudo: "+e);return(// The user may use createPseudo to indicate that
// arguments are needed to create the filter function
// just as jQuery does
o[v]?o(t):o.length>1?(i=[e,e,"",t],n.setFilters.hasOwnProperty(e.toLowerCase())?et(function(e,n){for(var i,r=o(e,t),s=r.length;s--;)i=l.call(e,r[s]),e[i]=!(n[i]=r[s])}):function(e){return o(e,0,i)}):o)}},pseudos:{// Potentially complex pseudos
not:et(function(e){// Trim the selector passed to compile
// to avoid treating leading and trailing
// spaces as combinators
var t=[],n=[],i=ed(e.replace(S,"$1"));return i[v]?et(function(e,t,n,o){// Match elements unmatched by `matcher`
for(var r,s=i(e,null,o,[]),a=e.length;a--;)(r=s[a])&&(e[a]=!(t[a]=r))}):function(e,o,r){return t[0]=e,i(t,null,r,n),// Don't keep the element
// (see https://github.com/jquery/sizzle/issues/299)
t[0]=null,!n.pop()}}),has:et(function(e){return function(t){return $(e,t).length>0}}),contains:et(function(e){return e=e.replace(N,J),function(t){return(t.textContent||E.text(t)).indexOf(e)>-1}}),// "Whether an element is represented by a :lang() selector
...
lang:et(function(e){return H.test(e||"")||$.error("unsupported lang: "+e),e=e.replace(N,J).toLowerCase(),function(t){var n;do if(n=d?t.lang:t.getAttribute("xml:lang")||t.getAttribute("lang"))return(n=n.toLowerCase())===e||0===n.indexOf(e+"-");while((t=t.parentNode)&&1===t.nodeType)return!1}}),// Miscellaneous
...
header:function(e){return O.test(e.nodeName)},input:function(e){return j.test(e.nodeName)},button:function(e){return w(e,"input")&&"button"===e.type||w(e,"button")},text:function(e){var t;return w(e,"input")&&"text"===e.type&&// Support: IE <10 only
...
function ea(){}function el(e,t){var i,o,r,s,a,l,c,u=C[e+" "];if(u)return t?0:u.slice(0);for(a=e,l=[],c=n.preFilter;a;){// Filters
for(s in(!i||(o=L.exec(a)))&&(o&&(a=a.slice(o[0].length)||a),l.push(r=[])),i=!1,(o=D.exec(a))&&(i=o.shift(),r.push({value:i,// Cast descendant combinators to space
type:o[0].replace(S," ")}),a=a.slice(i.length)),n.filter)(o=M[s].exec(a))&&(!c[s]||(o=c[s](o)))&&(i=o.shift(),r.push({value:i,type:s,matches:o}),a=a.slice(i.length));if(!i)break}return(// Return the length of the invalid excess
// if we're just parsing
// Otherwise, throw an error or return tokens
t?a.length:a?$.error(e):C(e,l).slice(0))}function ec(e){for(var t=0,n=e.length,i="";t<n;t++)i+=e[t].value;return i}function eu(e,t,n){var i=t.dir,o=t.next,r=o||i,s=n&&"parentNode"===r,a=b++;return t.first?function(t,n,o){for(;t=t[i];)if(1===t.nodeType||s)return e(t,n,o);return!1}:function(t,n,l){var c,u,B=[m,a];// We can't set arbitrary data on XML nodes, so they don't benefit from combinator caching
if(l){for(;t=t[i];)if((1===t.nodeType||s)&&e(t,n,l))return!0}else for(;t=t[i];)if(1===t.nodeType||s){if(u=t[v]||(t[v]={}),o&&w(t,o))t=t[i]||t;else{if((c=u[r])&&c[0]===m&&c[1]===a)return B[2]=c[2];// A match means we're done; a fail means we have to keep checking
if(// Reuse newcache so results back-propagate to previous elements
u[r]=B,B[2]=e(t,n,l))return!0}}return!1}}function eB(e){return e.length>1?function(t,n,i){for(var o=e.length;o--;)if(!e[o](t,n,i))return!1;return!0}:e[0]}function eF(e,t,n,i,o){for(var r,s=[],a=0,l=e.length,c=null!=t;a<l;a++)(r=e[a])&&(!n||n(r,i,o))&&(s.push(r),c&&t.push(a));return s}function ed(e,t/* Internal Use Only */){var i,r,s,a,c=[],B=[],F=q[e+" "];if(!F){for(t||(t=el(e)),a=t.length;a--;)(F=function e(t){for(var i,r,s,a=t.length,c=n.relative[t[0].type],u=c||n.relative[" "],B=c?1:0,F=eu(function(e){return e===i},u,!0),d=eu(function(e){return l.call(i,e)>-1},u,!0),h=[function(e,t,n){// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
var r=!c&&(n||t!=o)||((i=t).nodeType?F(e,t,n):d(e,t,n));return(// Avoid hanging onto element
// (see https://github.com/jquery/sizzle/issues/299)
i=null,r)}];B<a;B++)if(r=n.relative[t[B].type])h=[eu(eB(h),r)];else{// Return special upon seeing a positional matcher
if((r=n.filter[t[B].type].apply(null,t[B].matches))[v]){for(// Find the next relative operator (if any) for proper handling
s=++B;s<a&&!n.relative[t[s].type];s++);return function e(t,n,i,o,r,s){return o&&!o[v]&&(o=e(o)),r&&!r[v]&&(r=e(r,s)),et(function(e,s,a,c){var u,B,F,d,h=[],f=[],p=s.length,A=e||function(e,t,n){for(var i=0,o=t.length;i<o;i++)$(e,t[i],n);return n}(n||"*",a.nodeType?[a]:a,[]),v=t&&(e||!n)?eF(A,h,t,a,c):A;// Apply postFilter
if(i?// Find primary matches
i(v,// If we have a postFinder, or filtered seed, or non-seed postFilter
// or preexisting results,
d=r||(e?t:p||o)?[]:s,a,c):d=v,o)for(u=eF(d,f),o(u,[],a,c),// Un-match failing elements by moving them back to matcherIn
B=u.length;B--;)(F=u[B])&&(d[f[B]]=!(v[f[B]]=F));if(e){if(r||t){if(r){for(// Get the final matcherOut by condensing this intermediate into postFinder contexts
u=[],B=d.length;B--;)(F=d[B])&&u.push(v[B]=F);r(null,d=[],u,c)}for(// Move matched elements from seed to results to keep them synchronized
B=d.length;B--;)(F=d[B])&&(u=r?l.call(e,F):h[B])>-1&&(e[u]=!(s[u]=F))}}else d=eF(d===s?d.splice(p,d.length):d),r?r(null,s,d,c):g.apply(s,d)})}(B>1&&eB(h),B>1&&ec(t.slice(0,B-1).concat({value:" "===t[B-2].type?"*":""})).replace(S,"$1"),r,B<s&&e(t.slice(B,s)),s<a&&e(t=t.slice(s)),s<a&&ec(t))}h.push(r)}return eB(h)}(t[a]))[v]?c.push(F):B.push(F);// Save selector and tokenization
// Cache the compiled function
(F=q(e,(i=c.length>0,r=B.length>0,s=function(e,t,s,a,l){var F,h,f,p=0,A="0",v=e&&[],b=[],y=o,C=e||r&&n.find.TAG("*",l),w=m+=null==y?1:Math.random()||.1,x=C.length;// Add elements passing elementMatchers directly to results
...
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(o=t==u||t||l);A!==x&&null!=(F=C[A]);A++){if(r&&F){for(h=0,t||F.ownerDocument==u||(es(F),s=!d);f=B[h++];)if(f(F,t||u,s)){g.call(a,F);break}l&&(m=w)}// Track unmatched elements for set filters
i&&((F=!f&&F)&&p--,e&&v.push(F))}// Apply set filters to unmatched elements
...
p+=A,i&&A!==p){for(h=0;f=c[h++];)f(v,b,t,s);if(e){// Reintegrate element matches to eliminate the need for sorting
if(p>0)for(;A--;)v[A]||b[A]||(b[A]=I.call(a));// Discard index placeholder values to get only actual matches
b=eF(b)}// Add matches to results
g.apply(a,b),l&&!e&&b.length>0&&p+c.length>1&&E.uniqueSort(a)}return l&&(m=w,o=y),v},i?et(s):s))).selector=e}return F}/**
 ...
 */function eh(e,t,i,o){var r,s,a,l,c,u="function"==typeof e&&e,B=!o&&el(e=u.selector||e);// Try to minimize operations if there is only one selector in the list and no seed
// (the latter of which guarantees us context)
if(i=i||[],1===B.length){if(// Reduce context if the leading compound selector is an ID
(s=B[0]=B[0].slice(0)).length>2&&"ID"===(a=s[0]).type&&9===t.nodeType&&d&&n.relative[s[1].type]){if(!(t=(n.find.ID(a.matches[0].replace(N,J),t)||[])[0]))return i;u&&(t=t.parentNode),e=e.slice(s.shift().value.length)}for(// Fetch a seed set for right-to-left matching
r=M.needsContext.test(e)?0:s.length;// Abort if we hit a combinator
r--&&(a=s[r],!n.relative[l=a.type]);)if((c=n.find[l])&&(o=c(a.matches[0].replace(N,J),X.test(s[0].type)&&er(t.parentNode)||t))){if(// If seed is empty or no tokens remain, we can return early
s.splice(r,1),!(e=o.length&&ec(s)))return g.apply(i,o),i;break}}return(// Compile and execute a filtering function if one is not provided
// Provide `match` to avoid retokenization if we modified the selector above
(u||ed(e,B))(o,t,!d,i,!t||X.test(e)&&er(t.parentNode)||t),i)}ea.prototype=n.filters=n.pseudos,n.setFilters=new ea,// One-time assignments
// Support: Android <=4.0 - 4.1+
// Sort stability
h.sortStable=v.split("").sort(R).join("")===v,// Initialize against the default document
...
$.compile=ed,$.select=eh,$.setDocument=es,$.tokenize=el,$.escape=E.escapeSelector,$.getText=E.text,$.isXML=E.isXMLDoc,$.selectors=E.expr,$.support=E.support,$.uniqueSort=E.uniqueSort;/* eslint-enable */}();var R=function(e,t,n){for(var i=[],o=void 0!==n;(e=e[t])&&9!==e.nodeType;)if(1===e.nodeType){if(o&&E(e).is(n))break;i.push(e)}return i},V=function(e,t){for(var n=[];e;e=e.nextSibling)1===e.nodeType&&e!==t&&n.push(e);return n},K=E.expr.match.needsContext,T=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;// Implement the identical functionality for filter and not
function z(e,t,n){return f(t)?E.grep(e,function(e,i){return!!t.call(e,i,e)!==n}):t.nodeType?E.grep(e,function(e){return e===t!==n}):"string"!=typeof t?E.grep(e,function(e){return l.call(t,e)>-1!==n}):E.filter(t,e,n)}E.filter=function(e,t,n){var i=t[0];return(n&&(e=":not("+e+")"),1===t.length&&1===i.nodeType)?E.find.matchesSelector(i,e)?[i]:[]:E.find.matches(e,E.grep(t,function(e){return 1===e.nodeType}))},E.fn.extend({find:function(e){var t,n,i=this.length,o=this;if("string"!=typeof e)return this.pushStack(E(e).filter(function(){for(t=0;t<i;t++)if(E.contains(o[t],this))return!0}));for(t=0,n=this.pushStack([]);t<i;t++)E.find(e,o[t],n);return i>1?E.uniqueSort(n):n},filter:function(e){return this.pushStack(z(this,e||[],!1))},not:function(e){return this.pushStack(z(this,e||[],!0))},is:function(e){return!!z(this,// so $("p:first").is("p:last") won't return true for a doc with two "p".
...
(E.fn.init=function(e,t,n){var i,o;// HANDLE: $(""), $(null), $(undefined), $(false)
if(!e)return this;// Handle HTML strings
if(// Method init() accepts an alternate rootjQuery
// so migrate can support jQuery.sub (gh-2101)
n=n||Z,"string"==typeof e){// Match html or make sure no context is specified for #id
if((i="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:L.exec(e))&&(i[1]||!t)){// HANDLE: $(html) -> $(array)
if(!i[1])return(o=A.getElementById(i[2]))&&(// Inject the element directly into the jQuery object
...
E.merge(this,E.parseHTML(i[1],t&&t.nodeType?t.ownerDocument||t:A,!0)),T.test(i[1])&&E.isPlainObject(t))for(i in t)f(this[i])?this[i](t[i]):this.attr(i,t[i]);return this}return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e);// HANDLE: $(DOMElement)
...
Z=E(A);var D=/^(?:parents|prev(?:Until|All))/,P={children:!0,contents:!0,next:!0,prev:!0};function W(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}E.fn.extend({has:function(e){var t=E(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(E.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,o=this.length,r=[],s="string"!=typeof e&&E(e);// Positional selectors never match, since there's no _selection_ context
if(!K.test(e)){for(;i<o;i++)for(n=this[i];n&&n!==t;n=n.parentNode)if(n.nodeType<11&&(s?s.index(n)>-1:1===n.nodeType&&E.find.matchesSelector(n,e))){r.push(n);break}}return this.pushStack(r.length>1?E.uniqueSort(r):r)},// Determine the position of an element within the set
index:function(e){return(// No argument, return index in parent
e?"string"==typeof e?l.call(E(e),this[0]):l.call(this,e.jquery?e[0]:e):this[0]&&this[0].parentNode?this.first().prevAll().length:-1)},add:function(e,t){return this.pushStack(E.uniqueSort(E.merge(this.get(),E(e,t))))},addBack:function(e){return this.add(null==e?this.prevObject:this.prevObject.filter(e))}}),E.each({parent:function(e){var t=e.parentNode;return t&&11!==t.nodeType?t:null},parents:function(e){return R(e,"parentNode")},parentsUntil:function(e,t,n){return R(e,"parentNode",n)},next:function(e){return W(e,"nextSibling")},prev:function(e){return W(e,"previousSibling")},nextAll:function(e){return R(e,"nextSibling")},prevAll:function(e){return R(e,"previousSibling")},nextUntil:function(e,t,n){return R(e,"nextSibling",n)},prevUntil:function(e,t,n){return R(e,"previousSibling",n)},siblings:function(e){return V((e.parentNode||{}).firstChild,e)},children:function(e){return V(e.firstChild)},contents:function(e){return null!=e.contentDocument&&// Support: IE 11+
// <object> elements with no `data` attribute has an object
// `contentDocument` with a `null` prototype.
o(e.contentDocument)?e.contentDocument:(w(e,"template")&&(e=e.content||e),E.merge([],e.childNodes))}},function(e,t){E.fn[e]=function(n,i){var o=E.map(this,t,n);return"Until"!==e.slice(-5)&&(i=n),i&&"string"==typeof i&&(o=E.filter(i,o)),this.length>1&&(P[e]||E.uniqueSort(o),D.test(e)&&o.reverse()),this.pushStack(o)}});var H=/[^\x20\t\r\n\f]+/g;function M(e){return e}function j(e){throw e}function O(e,t,n,i){var o;try{// Check for promise aspect first to privilege synchronous behavior
e&&f(o=e.promise)?o.call(e).done(t).fail(n):e&&f(o=e.then)?o.call(e,t,n):// * false: [ value ].slice( 0 ) => resolve( value )
...
e="string"==typeof e?(t=e,n={},E.each(t.match(H)||[],function(e,t){n[t]=!0}),n):E.extend({},e);var t,n,i,o,r,s,a=[],l=[],c=-1,u=function(){for(// Enforce single-firing
s=s||e.once,// Execute callbacks for all pending executions,
// respecting firingIndex overrides and runtime changes
r=i=!0;l.length;c=-1)for(o=l.shift();++c<a.length;)!1===a[c].apply(o[0],o[1])&&e.stopOnFalse&&(// Jump to end and forget the data so .add doesn't re-fire
c=a.length,o=!1);e.memory||(o=!1),i=!1,s&&(a=o?[]:"")},B={// Add a callback or a collection of callbacks to the list
add:function(){return a&&(o&&!i&&(c=a.length-1,l.push(o)),function t(n){E.each(n,function(n,i){f(i)?e.unique&&B.has(i)||a.push(i):i&&i.length&&"string"!==m(i)&&t(i)})}(arguments),o&&!i&&u()),this},// Remove a callback from the list
...
disable:function(){return s=l=[],a=o="",this},disabled:function(){return!a},// Disable .fire
// Also disable .add unless we have memory (since it would have no effect)
// Abort any pending executions
lock:function(){return s=l=[],o||i||(a=o=""),this},locked:function(){return!!s},// Call all callbacks with the given context and arguments
...
fired:function(){return!!r}};return B},E.extend({Deferred:function(t){var n=[// action, add listener, callbacks,
...
var o=f(e[i[4]])&&e[i[4]];// deferred.progress(function() { bind to newDefer or newDefer.notify })
// deferred.done(function() { bind to newDefer or newDefer.resolve })
// deferred.fail(function() { bind to newDefer or newDefer.reject })
r[i[1]](function(){var e=o&&o.apply(this,arguments);e&&f(e.promise)?e.promise().progress(t.notify).done(t.resolve).fail(t.reject):t[i[0]+"With"](this,o?[e]:arguments)})}),e=null}).promise()},then:function(t,i,o){var r=0;function s(t,n,i,o){return function(){var a=this,l=arguments,c=function(){var e,c;// Support: Promises/A+ section 2.3.3.3.3
...
("object"==typeof e||"function"==typeof e)&&e.then)?o?c.call(e,s(r,n,M,o),s(r,n,j,o)):(// ...and disregard older resolution values
r++,c.call(e,s(r,n,M,o),s(r,n,j,o),s(r,n,M,n.notifyWith))):(i!==M&&(a=void 0,l=[e]),// Process the value(s)
// Default process is resolve
(o||n.resolveWith)(a,l))}},u=o?c:function(){try{c()}catch(e){E.Deferred.exceptionHook&&E.Deferred.exceptionHook(e,u.error),t+1>=r&&(i!==j&&(a=void 0,l=[e]),n.rejectWith(a,l))}};// Support: Promises/A+ section 2.3.3.3.1
...
n[0][3].add(s(0,e,f(o)?o:M,e.notifyWith)),// fulfilled_handlers.add( ... )
n[1][3].add(s(0,e,f(t)?t:M)),// rejected_handlers.add( ... )
n[2][3].add(s(0,e,f(i)?i:j))}).promise()},// Get a promise for this deferred
// If obj is provided, the promise aspect is added to the object
promise:function(e){return null!=e?E.extend(e,o):o}},r={};// All done!
return(// Add list-specific methods
E.each(n,function(e,t){var s=t[2],a=t[5];// promise.progress = list.add
// promise.done = list.add
// promise.fail = list.add
o[t[1]]=s.add,a&&s.add(function(){// state = "resolved" (i.e., fulfilled)
// state = "rejected"
...
r[t[0]+"With"]=s.fireWith}),// Make the deferred a promise
o.promise(r),t&&t.call(r,r),r)},// Deferred helper
when:function(e){var t=arguments.length,n=t,i=Array(n),o=r.call(arguments),s=E.Deferred(),a=function(e){return function(n){i[e]=this,o[e]=arguments.length>1?r.call(arguments):n,--t||s.resolveWith(i,o)}};// Single- and empty arguments are adopted like Promise.resolve
if(t<=1&&(O(e,s.done(a(n)).resolve,s.reject,!t),"pending"===s.state()||f(o[n]&&o[n].then)))return s.then();// Multiple arguments are aggregated like Promise.all array elements
for(;n--;)O(o[n],a(n),s.reject);return s.promise()}});// These usually indicate a programmer mistake during development,
...
e.console&&e.console.warn&&t&&G.test(t.name)&&e.console.warn("jQuery.Deferred exception: "+t.message,t.stack,n)},E.readyException=function(t){e.setTimeout(function(){throw t})};// The deferred used on DOM ready
var X=E.Deferred();// The ready event handler and self cleanup method
function N(){A.removeEventListener("DOMContentLoaded",N),e.removeEventListener("load",N),E.ready()}E.fn.ready=function(e){return X.then(e)// Wrap jQuery.readyException in a function so that the lookup
...
X.resolveWith(A,[E]))}}),E.ready.then=X.then,"complete"!==A.readyState&&("loading"===A.readyState||A.documentElement.doScroll)?(// Use the handy event callback
A.addEventListener("DOMContentLoaded",N),// A fallback to window.onload, that will always work
e.addEventListener("load",N)):e.setTimeout(E.ready);// Multifunctional method to get and set values of a collection
// The value/s can optionally be executed if it's a function
var J=function(e,t,n,i,o,r,s){var a=0,l=e.length,c=null==n;// Sets many values
if("object"===m(n))for(a in o=!0,n)J(e,t,a,n[a],!0,r,s);else if(void 0!==i&&(o=!0,f(i)||(s=!0),c&&(s?(t.call(e,i),t=null):(c=t,t=function(e,t,n){return c.call(E(e),n)})),t))for(;a<l;a++)t(e[a],n,s?i:i.call(e[a],a,t(e[a],n)));return o?e:c?t.call(e):l?t(e[0],n):r},Y=/^-ms-/,_=/-([a-z])/g;// Used by camelCase as callback to replace()
...
var t=e[this.expando];return!t&&(t={},et(e)&&(e.nodeType?e[this.expando]=t:Object.defineProperty(e,this.expando,{value:t,configurable:!0}))),t},set:function(e,t,n){var i,o=this.cache(e);// Handle: [ owner, key, value ] args
// Always use camelCase key (gh-2257)
if("string"==typeof t)o[ee(t)]=n;else for(i in t)o[ee(i)]=t[i];return o},get:function(e,t){return void 0===t?this.cache(e):e[this.expando]&&e[this.expando][ee(t)]},access:function(e,t,n){return(// In cases where either:
//
...
t=Array.isArray(t)?t.map(ee):((t=ee(t))in i)?[t]:t.match(H)||[]).length;n--;)delete i[t[n]];// Remove the expando if there's no more data
(void 0===t||E.isEmptyObject(i))&&(e.nodeType?e[this.expando]=void 0:delete e[this.expando])}},hasData:function(e){var t=e[this.expando];return void 0!==t&&!E.isEmptyObject(t)}};var ei=new en,eo=new en,er=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,es=/[A-Z]/g;function ea(e,t,n){var i,o;// If nothing was found internally, try to fetch any
// data from the HTML5 data-* attribute
if(void 0===n&&1===e.nodeType){if(i="data-"+t.replace(es,"-$&").toLowerCase(),"string"==typeof(n=e.getAttribute(i))){try{o=n,n="true"===o||"false"!==o&&("null"===o?null:o===+o+""?+o:er.test(o)?JSON.parse(o):o)}catch(e){}// Make sure we set the data so it isn't changed later
eo.set(e,t,n)}else n=void 0}return n}E.extend({hasData:function(e){return eo.hasData(e)||ei.hasData(e)},data:function(e,t,n){return eo.access(e,t,n)},removeData:function(e,t){eo.remove(e,t)},// TODO: Now that all calls to _data and _removeData have been replaced
// with direct calls to dataPriv methods, these can be deprecated.
_data:function(e,t,n){return ei.access(e,t,n)},_removeData:function(e,t){ei.remove(e,t)}}),E.fn.extend({data:function(e,t){var n,i,o,r=this[0],s=r&&r.attributes;// Gets all values
if(void 0===e){if(this.length&&(o=eo.get(r),1===r.nodeType&&!ei.get(r,"hasDataAttrs"))){for(n=s.length;n--;)// The attrs elements can be null (trac-14894)
s[n]&&0===(i=s[n].name).indexOf("data-")&&ea(r,i=ee(i.slice(5)),o[i]);ei.set(r,"hasDataAttrs",!0)}return o}return(// Sets multiple values
"object"==typeof e?this.each(function(){eo.set(this,e)}):J(this,function(t){var n;// The calling jQuery object (element matches) is not empty
...
(n=eo.get(r,e))||void 0!==// Attempt to "discover" the data in
// HTML5 custom data-* attrs
(n=ea(r,e))?n:// We tried really hard, but the data doesn't exist.
void 0;// Set the data...
this.each(function(){// We always store the camelCased key
eo.set(this,e,t)})},null,t,arguments.length>1,null,!0))},removeData:function(e){return this.each(function(){eo.remove(this,e)})}}),E.extend({queue:function(e,t,n){var i;if(e)return t=(t||"fx")+"queue",i=ei.get(e,t),n&&(!i||Array.isArray(n)?i=ei.access(e,t,E.makeArray(n)):i.push(n)),i||[]},dequeue:function(e,t){t=t||"fx";var n=E.queue(e,t),i=n.length,o=n.shift(),r=E._queueHooks(e,t);"inprogress"===o&&(o=n.shift(),i--),o&&("fx"===t&&n.unshift("inprogress"),// Clear up the last queue stop function
delete r.stop,o.call(e,function(){E.dequeue(e,t)},r)),!i&&r&&r.empty.fire()},// Not public - generate a queueHooks object, or return the current one
...
promise:function(e,t){var n,i=1,o=E.Deferred(),r=this,s=this.length,a=function(){--i||o.resolveWith(r,[r])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";s--;)(n=ei.get(r[s],e+"queueHooks"))&&n.empty&&(i++,n.empty.add(a));return a(),o.promise(t)}});var el=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,ec=RegExp("^(?:([+-])=|)("+el+")([a-z%]*)$","i"),eu=["Top","Right","Bottom","Left"],eB=A.documentElement,eF=function(e){return E.contains(e.ownerDocument,e)},ed={composed:!0};eB.getRootNode&&(eF=function(e){return E.contains(e.ownerDocument,e)||e.getRootNode(ed)===e.ownerDocument});var eh=function(e,t){// Inline style trumps all
...
// in the document.
eF(e)&&"none"===E.css(e,"display")};function ef(e,t,n,i){var o,r,s=20,a=i?function(){return i.cur()}:function(){return E.css(e,t,"")},l=a(),c=n&&n[3]||(E.cssNumber[t]?"":"px"),u=e.nodeType&&(E.cssNumber[t]||"px"!==c&&+l)&&ec.exec(E.css(e,t));if(u&&u[3]!==c){for(// Support: Firefox <=54
...
E.style(e,t,u+c),(1-r)*(1-(r=a()/l||.5))<=0&&(s=0),u/=r;u*=2,E.style(e,t,u+c),// Make sure we update the tween properties later on
n=n||[]}return n&&(u=+u||+l||0,// Apply relative offset (+=/-=) if specified
o=n[1]?u+(n[1]+1)*n[2]:+n[2],i&&(i.unit=c,i.start=u,i.end=o)),o}var ep={};function eA(e,t){// Determine new display value for elements that need to change
for(var n,i,o=[],r=0,s=e.length;r<s;r++)(i=e[r]).style&&(n=i.style.display,t?("none"!==n||(o[r]=ei.get(i,"display")||null,o[r]||(i.style.display="")),""===i.style.display&&eh(i)&&(o[r]=function(e){var t,n=e.ownerDocument,i=e.nodeName,o=ep[i];return o||(t=n.body.appendChild(n.createElement(i)),o=E.css(t,"display"),t.parentNode.removeChild(t),"none"===o&&(o="block"),ep[i]=o),o}(i))):"none"!==n&&(o[r]="none",// Remember what we're overwriting
ei.set(i,"display",n)));// Set the display of the elements in a second loop to avoid constant reflow
for(r=0;r<s;r++)null!=o[r]&&(e[r].style.display=o[r]);return e}E.fn.extend({show:function(){return eA(this,!0)},hide:function(){return eA(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){eh(this)?E(this).show():E(this).hide()})}});var eg=/^(?:checkbox|radio)$/i,ev=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,em=/^$|^module$|\/(?:java|ecma)script/i;e9=A.createDocumentFragment().appendChild(A.createElement("div")),// Support: Android 4.0 - 4.3 only
...
var eb={// XHTML parsers do not magically insert elements in the
// same way that tag soup parsers do. So we cannot shorten
// this by omitting <tbody> or other required elements.
thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};function ey(e,t){// Support: IE <=9 - 11 only
...
function eE(e,t){for(var n=0,i=e.length;n<i;n++)ei.set(e[n],"globalEval",!t||ei.get(t[n],"globalEval"))}eb.tbody=eb.tfoot=eb.colgroup=eb.caption=eb.thead,eb.th=eb.td,h.option||(eb.optgroup=eb.option=[1,"<select multiple='multiple'>","</select>"]);var eC=/<|&#?\w+;/;function ew(e,t,n,i,o){for(var r,s,a,l,c,u=t.createDocumentFragment(),B=[],F=0,d=e.length;F<d;F++)if((r=e[F])||0===r){// Add nodes directly
if("object"===m(r))// push.apply(_, arraylike) throws on ancient WebKit
E.merge(B,r.nodeType?[r]:r);else if(eC.test(r)){for(s=s||u.appendChild(t.createElement("div")),a=eb[(ev.exec(r)||["",""])[1].toLowerCase()]||eb._default,s.innerHTML=a[1]+E.htmlPrefilter(r)+a[2],// Descend through wrappers to the right content
...
(s=u.firstChild).textContent=""}else B.push(t.createTextNode(r))}for(// Remove wrapper from fragment
u.textContent="",F=0;r=B[F++];){// Skip elements already in the context collection (trac-4087)
if(i&&E.inArray(r,i)>-1){o&&o.push(r);continue}// Capture executables
if(l=eF(r),// Append to fragment
s=ey(u.appendChild(r),"script"),l&&eE(s),n)for(c=0;r=s[c++];)em.test(r.type||"")&&n.push(r)}return u}var eI=/^([^.]*)(?:\.(.+)|)/;function ex(){return!0}function ek(){return!1}function eQ(e,t,n,i,o,r){var s,a;// Types can be a map of types/handlers
if("object"==typeof t){for(a in"string"!=typeof n&&(// ( types-Object, data )
i=i||n,n=void 0),t)eQ(e,a,n,i,t[a],r);return e}if(null==i&&null==o?(// ( types, fn )
o=n,i=n=void 0):null==o&&("string"==typeof n?(// ( types, selector, fn )
o=i,i=void 0):(// ( types, data, fn )
o=i,i=n,n=void 0)),!1===o)o=ek;else if(!o)return e;return 1===r&&(s=o,// Use same guid so caller can remove using origFn
(o=function(e){return(// Can use an empty set, since event contains the info
E().off(e),s.apply(this,arguments))}).guid=s.guid||(s.guid=E.guid++)),e.each(function(){E.event.add(this,t,o,i,n)})}// Ensure the presence of an event listener that handles manually-triggered
// synthetic events by interrupting progress until reinvoked in response to
// *native* events that it fires directly, ensuring that state changes have
// already occurred before other listeners are invoked.
function eS(e,t,n){// Missing `isSetup` indicates a trigger call, which must force setup through jQuery.event.add
...
i=r.call(arguments),ei.set(this,t,i),// Trigger the native event and capture its result
 ...
 */E.event={global:{},add:function(e,t,n,i,o){var r,s,a,l,c,u,B,F,d,h,f,p=ei.get(e);// Only attach events to objects that accept data
if(et(e))for(n.handler&&(n=(r=n).handler,o=r.selector),o&&E.find.matchesSelector(eB,o),n.guid||(n.guid=E.guid++),(l=p.events)||(l=p.events=Object.create(null)),(s=p.handle)||(s=p.handle=function(t){// Discard the second event of a jQuery.event.trigger() and
...
(t=(t||"").match(H)||[""]).length;c--;)// There *must* be a type, no attaching namespace-only handlers
d=f=(a=eI.exec(t[c])||[])[1],h=(a[2]||"").split(".").sort(),d&&(// If event changes its type, use the special event handlers for the changed type
B=E.event.special[d]||{},// If selector defined, determine special event api type, otherwise given type
d=(o?B.delegateType:B.bindType)||d,// Update special based on newly reset type
B=E.event.special[d]||{},// handleObj is passed to all event handlers
u=E.extend({type:d,origType:f,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&E.expr.match.needsContext.test(o),namespace:h.join(".")},r),(F=l[d])||((F=l[d]=[]).delegateCount=0,(!B.setup||!1===B.setup.call(e,i,h,s))&&e.addEventListener&&e.addEventListener(d,s)),B.add&&(B.add.call(e,u),u.handler.guid||(u.handler.guid=n.guid)),o?F.splice(F.delegateCount++,0,u):F.push(u),// Keep track of which events have ever been used, for event optimization
E.event.global[d]=!0)},// Detach an event or set of events from an element
remove:function(e,t,n,i,o){var r,s,a,l,c,u,B,F,d,h,f,p=ei.hasData(e)&&ei.get(e);if(p&&(l=p.events)){for(c=// Once for each type.namespace in types; type may be omitted
(t=(t||"").match(H)||[""]).length;c--;){// Unbind all events (on this namespace, if provided) for the element
if(d=f=(a=eI.exec(t[c])||[])[1],h=(a[2]||"").split(".").sort(),!d){for(d in l)E.event.remove(e,d+t[c],n,i,!0);continue}for(B=E.event.special[d]||{},F=l[d=(i?B.delegateType:B.bindType)||d]||[],a=a[2]&&RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),// Remove matching events
s=r=F.length;r--;)u=F[r],(o||f===u.origType)&&(!n||n.guid===u.guid)&&(!a||a.test(u.namespace))&&(!i||i===u.selector||"**"===i&&u.selector)&&(F.splice(r,1),u.selector&&F.delegateCount--,B.remove&&B.remove.call(e,u));s&&!F.length&&(B.teardown&&!1!==B.teardown.call(e,h,p.handle)||E.removeEvent(e,d,p.handle),delete l[d])}E.isEmptyObject(l)&&ei.remove(e,"handle events")}},dispatch:function(e){var t,n,i,o,r,s,a=Array(arguments.length),l=E.event.fix(e),c=(ei.get(this,"events")||Object.create(null))[l.type]||[],u=E.event.special[l.type]||{};for(t=1,// Use the fix-ed jQuery.Event rather than the (read-only) native event
...
t=0;(o=s[t++])&&!l.isPropagationStopped();)for(l.currentTarget=o.elem,n=0;(r=o.handlers[n++])&&!l.isImmediatePropagationStopped();)// specially universal or its namespaces are a superset of the event's.
...
if(1===c.nodeType&&!("click"===e.type&&!0===c.disabled)){for(n=0,r=[],s={};n<l;n++)void 0===s[// Don't conflict with Object.prototype properties (trac-13203)
o=(i=t[n]).selector+" "]&&(s[o]=i.needsContext?E(o,this).index(c)>-1:E.find(o,this,null,[c]).length),s[o]&&r.push(i);r.length&&a.push({elem:c,handlers:r})}}return(// Add the remaining (directly-bound) handlers
...
return eg.test(t.type)&&t.click&&w(t,"input")&&eS(t,"click",!0),!1},trigger:function(e){// For mutual compressibility with _default, replace `this` access with a local var.
// `|| data` is dead code meant only to preserve the variable through minification.
var t=this||e;// Return non-false to allow normal event-path propagation
return eg.test(t.type)&&t.click&&w(t,"input")&&eS(t,"click"),!0},// For cross-browser consistency, suppress native .click() on links
...
!1===e.returnValue?ex:ek,// Create target properties
...
eS(this,e,!0),!A.documentMode)return!1;// Support: IE 9 - 11+
...
eS(this,e),!0)},teardown:function(){var e;if(!A.documentMode)return!1;(e=ei.get(this,t)-1)?ei.set(this,t,e):(this.removeEventListener(t,n),ei.remove(this,t))},// Suppress native focus or blur if we're currently inside
...
var i=this.ownerDocument||this.document||this,o=A.documentMode?this:i,r=ei.get(o,t);r||(A.documentMode?this.addEventListener(t,n):i.addEventListener(e,n,!0)),ei.set(o,t,(r||0)+1)},teardown:function(){var i=this.ownerDocument||this.document||this,o=A.documentMode?this:i,r=ei.get(o,t)-1;r?ei.set(o,t,r):(A.documentMode?this.removeEventListener(t,n):i.removeEventListener(e,n,!0),ei.remove(o,t))}}}),// Create mouseenter/leave events using mouseover/out and event-time checks
...
E.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(e,t){E.event.special[e]={delegateType:t,bindType:t,handle:function(e){var n,i=e.relatedTarget,o=e.handleObj;return i&&(i===this||E.contains(this,i))||(e.type=o.origType,n=o.handler.apply(this,arguments),e.type=t),n}}}),E.fn.extend({on:function(e,t,n,i){return eQ(this,e,t,n,i)},one:function(e,t,n,i){return eQ(this,e,t,n,i,1)},off:function(e,t,n){var i,o;if(e&&e.preventDefault&&e.handleObj)return(// ( event )  dispatched jQuery.Event
...
n=t,t=void 0),!1===n&&(n=ek),this.each(function(){E.event.remove(this,e,n,t)})}});var // In IE/Edge using regex groups here causes severe slowdowns.
// See https://connect.microsoft.com/IE/feedback/details/1736512/
eq=/<script|<style|<link/i,eU=/checked\s*(?:[^=]|=\s*.checked.)/i,eR=/^\s*<!\[CDATA\[|\]\]>\s*$/g;// Prefer a tbody over its parent table for containing new rows
function eV(e,t){return w(e,"table")&&w(11!==t.nodeType?t:t.firstChild,"tr")&&E(e).children("tbody")[0]||e}// Replace/restore the type attribute of script elements for safe DOM manipulation
function eK(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function eT(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function ez(e,t){var n,i,o,r,s,a;if(1===t.nodeType){// 1. Copy private data: events, handlers, etc.
if(ei.hasData(e)&&(a=ei.get(e).events))for(o in ei.remove(t,"handle events"),a)for(n=0,i=a[o].length;n<i;n++)E.event.add(t,o,a[o][n]);// 2. Copy user data
eo.hasData(e)&&(r=eo.access(e),s=E.extend({},r),eo.set(t,s))}}function eZ(e,t,n,i){// Flatten any nested arrays
t=s(t);var o,r,a,l,c,u,B=0,F=e.length,d=F-1,p=t[0],A=f(p);// We can't cloneNode fragments that contain checked, in WebKit
if(A||F>1&&"string"==typeof p&&!h.checkClone&&eU.test(p))return e.each(function(o){var r=e.eq(o);A&&(t[0]=p.call(this,o,r.html())),eZ(r,t,n,i)});if(F&&(r=(o=ew(t,e[0].ownerDocument,!1,e,i)).firstChild,1===o.childNodes.length&&(o=r),r||i)){// Use the original fragment for the last item
// instead of the first because it can end up
// being emptied incorrectly in certain situations (trac-8070).
for(l=(a=E.map(ey(o,"script"),eK)).length;B<F;B++)c=o,B!==d&&(c=E.clone(c,!0,!0),l&&// push.apply(_, arraylike) throws on ancient WebKit
E.merge(a,ey(c,"script"))),n.call(e[B],c,B);if(l)// Evaluate executable scripts on first document insertion
for(u=a[a.length-1].ownerDocument,// Re-enable scripts
E.map(a,eT),B=0;B<l;B++)c=a[B],em.test(c.type||"")&&!ei.access(c,"globalEval")&&E.contains(u,c)&&(c.src&&"module"!==(c.type||"").toLowerCase()?E._evalUrl&&!c.noModule&&E._evalUrl(c.src,{nonce:c.nonce||c.getAttribute("nonce")},u):// needed as in XML documents they're already not visible when
// inspecting element contents and in HTML documents they have no
// meaning but we're preserving that logic for backwards compatibility.
// This will be removed completely in 4.0. See gh-4904.
v(c.textContent.replace(eR,""),c,u))}return e}function eL(e,t,n){for(var i,o=t?E.filter(t,e):e,r=0;null!=(i=o[r]);r++)n||1!==i.nodeType||E.cleanData(ey(i)),i.parentNode&&(n&&eF(i)&&eE(ey(i,"script")),i.parentNode.removeChild(i));return e}E.extend({htmlPrefilter:function(e){return e},clone:function(e,t,n){var i,o,r,s,a=e.cloneNode(!0),l=eF(e);// Fix IE cloning issues
...
s=ey(a),o=(r=ey(e)).length;i<o;i++)!// Fix IE bugs, see support tests
function(e,t){var n=t.nodeName.toLowerCase();// Fails to persist the checked state of a cloned checkbox or radio button.
"input"===n&&eg.test(e.type)?t.checked=e.checked:("input"===n||"textarea"===n)&&(t.defaultValue=e.defaultValue)}(r[i],s[i]);// Copy the events from the original to the clone
if(t){if(n)for(i=0,r=r||ey(e),s=s||ey(a),o=r.length;i<o;i++)ez(r[i],s[i]);else ez(e,a)}// Return the cloned set
return(// Preserve script evaluation history
(s=ey(a,"script")).length>0&&eE(s,!l&&ey(e,"script")),a)},cleanData:function(e){for(var t,n,i,o=E.event.special,r=0;void 0!==(n=e[r]);r++)if(et(n)){if(t=n[ei.expando]){if(t.events)for(i in t.events)o[i]?E.event.remove(n,i):E.removeEvent(n,i,t.handle);// Support: Chrome <=35 - 45+
// Assign undefined instead of using delete, see Data#remove
n[ei.expando]=void 0}n[eo.expando]&&// Assign undefined instead of using delete, see Data#remove
(n[eo.expando]=void 0)}}}),E.fn.extend({detach:function(e){return eL(this,e,!0)},remove:function(e){return eL(this,e)},text:function(e){return J(this,function(e){return void 0===e?E.text(this):this.empty().each(function(){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&(this.textContent=e)})},null,e,arguments.length)},append:function(){return eZ(this,arguments,function(e){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&eV(this,e).appendChild(e)})},prepend:function(){return eZ(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=eV(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return eZ(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return eZ(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;null!=(e=this[t]);t++)1===e.nodeType&&(// Prevent memory leaks
E.cleanData(ey(e,!1)),// Remove any remaining nodes
...
if("string"==typeof e&&!eq.test(e)&&!eb[(ev.exec(e)||["",""])[1].toLowerCase()]){e=E.htmlPrefilter(e);try{for(;n<i;n++)t=this[n]||{},1===t.nodeType&&(E.cleanData(ey(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
return eZ(this,arguments,function(t){var n=this.parentNode;0>E.inArray(this,e)&&(E.cleanData(ey(this)),n&&n.replaceChild(t,this));// Force callback invocation
},e)}}),E.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){E.fn[e]=function(e){for(var n,i=[],o=E(e),r=o.length-1,s=0;s<=r;s++)n=s===r?this:this.clone(!0),E(o[s])[t](n),// Support: Android <=4.0 only, PhantomJS 1 only
// .get() because push.apply(_, arraylike) throws on ancient WebKit
a.apply(i,n.get());return this.pushStack(i)}});var eD=RegExp("^("+el+")(?!px)[a-z%]+$","i"),eP=/^--/,eW=function(t){// Support: IE <=11 only, Firefox <=30 (trac-15098, trac-14150)
// IE throws on elements created in popups
// FF meanwhile throws on frame elements through "defaultView.getComputedStyle"
var n=t.ownerDocument.defaultView;return n&&n.opener||(n=e),n.getComputedStyle(t)},eH=function(e,t,n){var i,o,r={};// Remember the old values, and insert the new ones
for(o in t)r[o]=e.style[o],e.style[o]=t[o];// Revert the old values
for(o in i=n.call(e),t)e.style[o]=r[o];return i},eM=RegExp(eu.join("|"),"i");function ej(e,t,n){var i,o,r,s,a=eP.test(t),// Retrieving style before computed somehow
...
(s=s.replace(S,"$1")||void 0),""!==s||eF(e)||(s=E.style(e,t)),!h.pixelBoxStyles()&&eD.test(s)&&eM.test(t)&&(// Remember the original values
i=l.width,o=l.minWidth,r=l.maxWidth,// Put in the new values to get a computed value out
l.minWidth=l.maxWidth=l.width=s,s=n.width,// Revert the changed values
l.width=i,l.minWidth=o,l.maxWidth=r)),void 0!==s?// IE returns zIndex value as an integer.
s+"":s}function eO(e,t){// Define the hook, we'll check on the first run if it's really needed.
...
u.style.position="absolute",r=12===n(u.offsetWidth/3),eB.removeChild(c),// Nullify the div so it wouldn't be stored in the memory and
// it will also be a sign that checks already performed
u=null}}function n(e){return Math.round(parseFloat(e))}var i,o,r,s,a,l,c=A.createElement("div"),u=A.createElement("div");// Finish early in limited (non-browser) environments
u.style&&(// Support: IE <=9 - 11 only
// Style of cloned element affects source element cloned (trac-8908)
u.style.backgroundClip="content-box",u.cloneNode(!0).style.backgroundClip="",h.clearCloneStyle="content-box"===u.style.backgroundClip,E.extend(h,{boxSizingReliable:function(){return t(),o},pixelBoxStyles:function(){return t(),s},pixelPosition:function(){return t(),i},reliableMarginLeft:function(){return t(),l},scrollboxSize:function(){return t(),r},// Support: IE 9 - 11+, Edge 15 - 18+
...
reliableTrDimensions:function(){var t,n,i,o;return null==a&&(t=A.createElement("table"),n=A.createElement("tr"),i=A.createElement("div"),t.style.cssText="position:absolute;left:-11111px;border-collapse:separate",n.style.cssText="box-sizing:content-box;border:1px solid",// Support: Chrome 86+
...
i.style.display="block",eB.appendChild(t).appendChild(n).appendChild(i),a=parseInt((o=e.getComputedStyle(n)).height,10)+parseInt(o.borderTopWidth,10)+parseInt(o.borderBottomWidth,10)===n.offsetHeight,eB.removeChild(t)),a}}))}();var eG=["Webkit","Moz","ms"],eX=A.createElement("div").style,eN={};// Return a potentially-mapped jQuery.cssProps or vendor prefixed property
function eJ(e){return E.cssProps[e]||eN[e]||(e in eX?e:eN[e]=// Return a vendor-prefixed property or undefined
...
var i=ec.exec(t);return i?Math.max(0,i[2]-(n||0))+(i[3]||"px"):t}function e0(e,t,n,i,o,r){var s="width"===t?1:0,a=0,l=0,c=0;// Adjustment may not be necessary
if(n===(i?"border":"content"))return 0;for(;s<4;s+=2)"margin"===n&&(c+=E.css(e,n+eu[s],!0,o)),i?("content"===n&&(l-=E.css(e,"padding"+eu[s],!0,o)),"margin"!==n&&(l-=E.css(e,"border"+eu[s]+"Width",!0,o))):(// Add padding
l+=E.css(e,"padding"+eu[s],!0,o),"padding"!==n?l+=E.css(e,"border"+eu[s]+"Width",!0,o):a+=E.css(e,"border"+eu[s]+"Width",!0,o));return!i&&r>=0&&// Assuming integer scroll gutter, subtract the rest and round down
(l+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-r-l-a-.5))||0),l+c}function e1(e,t,n){// Start with computed style
var i=eW(e),o=(!h.boxSizingReliable()||n)&&"border-box"===E.css(e,"boxSizing",!1,i),r=o,s=ej(e,t,i),a="offset"+t[0].toUpperCase()+t.slice(1);// Support: Firefox <=54
// Return a confounding non-pixel value or feign ignorance, as appropriate.
if(eD.test(s)){if(!n)return s;s="auto"}// Adjust for the element's box model
...
e.getClientRects().length&&(o="border-box"===E.css(e,"boxSizing",!1,i),// Where available, offsetWidth/offsetHeight approximate border box dimensions.
// Where not available (e.g., SVG), assume unreliable box-sizing and interpret the
// retrieved value as a content box dimension.
(r=a in e)&&(s=e[a])),// Normalize "" and auto
(s=parseFloat(s)||0)+e0(e,t,n||(o?"border":"content"),r,i,s)+"px"}function e3(e,t,n,i,o){return new e3.prototype.init(e,t,n,i,o)}E.extend({// Add in style property hooks for overriding the default
// behavior of getting and setting a style property
cssHooks:{opacity:{get:function(e,t){if(t){// We should always get a number back from opacity
var n=ej(e,"opacity");return""===n?"1":n}}}},// Don't automatically add "px" to these possibly-unitless properties
...
var o,r,s,a=ee(t),l=eP.test(t),c=e.style;// Check if we're setting a value
...
s&&"get"in s&&void 0!==(o=s.get(e,!1,i))?o:c[t]);// Make sure that null and NaN values aren't set (trac-7116)
"string"==(r=typeof n)&&(o=ec.exec(n))&&o[1]&&(n=ef(e,t,o),// Fixes bug trac-9237
r="number"),null!=n&&n==n&&("number"!==r||l||(n+=o&&o[3]||(E.cssNumber[a]?"":"px")),h.clearCloneStyle||""!==n||0!==t.indexOf("background")||(c[t]="inherit"),s&&"set"in s&&void 0===(n=s.set(e,n,i))||(l?c.setProperty(t,n):c[t]=n))}},css:function(e,t,n,i){var o,r,s,a=ee(t);return(// Make numeric if forced or a qualifier was provided and val looks numeric
(eP.test(t)||(t=eJ(a)),// Try prefixed name followed by the unprefixed name
(s=E.cssHooks[t]||E.cssHooks[a])&&"get"in s&&(o=s.get(e,!0,n)),void 0===o&&(o=ej(e,t,i)),"normal"===o&&t in e$&&(o=e$[t]),""===n||n)?(r=parseFloat(o),!0===n||isFinite(r)?r||0:o):o)}}),E.each(["height","width"],function(e,t){E.cssHooks[t]={get:function(e,n,i){if(n)// but it must have a current display style that would benefit
...
e.getClientRects().length&&e.getBoundingClientRect().width?e1(e,t,i):eH(e,e_,function(){return e1(e,t,i)})},set:function(e,n,i){var o,r=eW(e),// to avoid forcing a reflow.
s=!h.scrollboxSize()&&"absolute"===r.position,a=(s||i)&&"border-box"===E.css(e,"boxSizing",!1,r),l=i?e0(e,t,i,a,r):0;return a&&s&&(l-=Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-parseFloat(r[t])-e0(e,t,"border",!1,r)-.5)),l&&(o=ec.exec(n))&&"px"!==(o[3]||"px")&&(e.style[t]=n,n=E.css(e,t)),e2(e,n,l)}}}),E.cssHooks.marginLeft=eO(h.reliableMarginLeft,function(e,t){if(t)return(parseFloat(ej(e,"marginLeft"))||e.getBoundingClientRect().left-eH(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),// These hooks are used by animate to expand properties
E.each({margin:"",padding:"",border:"Width"},function(e,t){E.cssHooks[e+t]={expand:function(n){for(var i=0,o={},r="string"==typeof n?n.split(" "):[n];i<4;i++)o[e+eu[i]+t]=r[i]||r[i-2]||r[0];return o}},"margin"!==e&&(E.cssHooks[e+t].set=e2)}),E.fn.extend({css:function(e,t){return J(this,function(e,t,n){var i,o,r={},s=0;if(Array.isArray(t)){for(i=eW(e),o=t.length;s<o;s++)r[t[s]]=E.css(e,t[s],!1,i);return r}return void 0!==n?E.style(e,t,n):E.css(e,t)},e,t,arguments.length>1)}}),E.Tween=e3,e3.prototype={constructor:e3,init:function(e,t,n,i,o,r){this.elem=e,this.prop=n,this.easing=o||E.easing._default,this.options=t,this.start=this.now=this.cur(),this.end=i,this.unit=r||(E.cssNumber[n]?"":"px")},cur:function(){var e=e3.propHooks[this.prop];return e&&e.get?e.get(this):e3.propHooks._default.get(this)},run:function(e){var t,n=e3.propHooks[this.prop];return this.options.duration?this.pos=t=E.easing[this.easing](e,this.options.duration*e,0,1,this.options.duration):this.pos=t=e,this.now=(this.end-this.start)*t+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),n&&n.set?n.set(this):e3.propHooks._default.set(this),this}},e3.prototype.init.prototype=e3.prototype,e3.propHooks={_default:{get:function(e){var t;return(// Use a property on the element directly when it is not a DOM element,
...
function tt(e,t){var n,i=0,o={height:e};for(// If we include width, step value is 1 to do all cssExpand values,
// otherwise step value is 2 to skip over Left and Right
t=t?1:0;i<4;i+=2-t)o["margin"+(n=eu[i])]=o["padding"+n]=e;return t&&(o.opacity=o.width=e),o}function tn(e,t,n){for(var i,o=(ti.tweeners[t]||[]).concat(ti.tweeners["*"]),r=0,s=o.length;r<s;r++)if(i=o[r].call(n,t,e))return i}function ti(e,t,n){var i,o,r=0,s=ti.prefilters.length,a=E.Deferred().always(function(){// Don't match elem in the :animated selector
delete l.elem}),l=function(){if(o)return!1;for(var t=e5||te(),n=Math.max(0,c.startTime+c.duration-t),i=1-(n/c.duration||0),r=0,s=c.tweens.length;r<s;r++)c.tweens[r].run(i);return(// If there's more to do, yield
...
i=t?c.tweens.length:0;if(o)return this;for(o=!0;n<i;n++)c.tweens[n].run(1);return t?(a.notifyWith(e,[c,1,0]),a.resolveWith(e,[c,t])):a.rejectWith(e,[c,t]),this}}),u=c.props;for(function(e,t){var n,i,o,r,s;// camelCase, specialEasing and expand cssHook pass
for(n in e)if(o=t[i=ee(n)],Array.isArray(r=e[n])&&(o=r[1],r=e[n]=r[0]),n!==i&&(e[i]=r,delete e[n]),(s=E.cssHooks[i])&&("expand"in s))// Not quite $.extend, this won't overwrite existing keys.
// Reusing 'index' because we have the correct "name"
for(n in r=s.expand(r),delete e[i],r)(n in e)||(e[n]=r[n],t[n]=o);else t[i]=o}(u,c.opts.specialEasing);r<s;r++)if(i=ti.prefilters[r].call(c,e,u,c.opts))return f(i.stop)&&(E._queueHooks(c.elem,c.opts.queue).stop=i.stop.bind(i)),i;return E.map(u,tn,c),f(c.opts.start)&&c.opts.start.call(e,c),// Attach callbacks from options
c.progress(c.opts.progress).done(c.opts.done,c.opts.complete).fail(c.opts.fail).always(c.opts.always),E.fx.timer(E.extend(l,{elem:e,anim:c,queue:c.opts.queue})),c}E.Animation=E.extend(ti,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return ef(n.elem,e,ec.exec(t),n),n}]},tweener:function(e,t){f(e)?(t=e,e=["*"]):e=e.match(H);for(var n,i=0,o=e.length;i<o;i++)n=e[i],ti.tweeners[n]=ti.tweeners[n]||[],ti.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var i,o,r,s,a,l,c,u,B="width"in t||"height"in t,F=this,d={},h=e.style,f=e.nodeType&&eh(e),p=ei.get(e,"fxshow");// Detect show/hide animations
for(i in n.queue||(null==(s=E._queueHooks(e,"fx")).unqueued&&(s.unqueued=0,a=s.empty.fire,s.empty.fire=function(){s.unqueued||a()}),s.unqueued++,F.always(function(){// Ensure the complete handler is called before this completes
F.always(function(){s.unqueued--,E.queue(e,"fx").length||s.empty.fire()})})),t)if(o=t[i],e8.test(o)){if(delete t[i],r=r||"toggle"===o,o===(f?"hide":"show")){// Pretend to be hidden if this is a "show" and
// there is still data from a stopped show/hide
if("show"!==o||!p||void 0===p[i])continue;f=!0}d[i]=p&&p[i]||E.style(e,i)}if(!(!// Bail out if this is a no-op like .hide().hide()
(l=!E.isEmptyObject(t))&&E.isEmptyObject(d)))for(i in B&&1===e.nodeType&&(// Support: IE <=9 - 11, Edge 12 - 15
...
eA([e],!0),c=e.style.display||c,u=E.css(e,"display"),eA([e]))),("inline"===u||"inline-block"===u&&null!=c)&&"none"===E.css(e,"float")&&(l||(F.done(function(){h.display=c}),null!=c||(c="none"===(u=h.display)?"":u)),h.display="inline-block")),n.overflow&&(h.overflow="hidden",F.always(function(){h.overflow=n.overflow[0],h.overflowX=n.overflow[1],h.overflowY=n.overflow[2]})),// Implement show/hide animations
l=!1,d)l||(p?"hidden"in p&&(f=p.hidden):p=ei.access(e,"fxshow",{display:c}),r&&(p.hidden=!f),f&&eA([e],!0),/* eslint-disable no-loop-func */F.done(function(){for(i in f||eA([e]),ei.remove(e,"fxshow"),d)E.style(e,i,d[i])})),// Per-property setup
l=tn(f?p[i]:0,i,F),i in p||(p[i]=l.start,f&&(l.end=l.start,l.start=0))}],prefilter:function(e,t){t?ti.prefilters.unshift(e):ti.prefilters.push(e)}}),E.speed=function(e,t,n){var i=e&&"object"==typeof e?E.extend({},e):{complete:n||!n&&t||f(e)&&e,duration:e,easing:n&&t||t&&!f(t)&&t};return E.fx.off?i.duration=0:"number"!=typeof i.duration&&(i.duration in E.fx.speeds?i.duration=E.fx.speeds[i.duration]:i.duration=E.fx.speeds._default),(null==i.queue||!0===i.queue)&&(i.queue="fx"),// Queueing
...
.end().animate({opacity:t},e,n,i)},animate:function(e,t,n,i){var o=E.isEmptyObject(e),r=E.speed(t,n,i),s=function(){// Operate on a copy of prop so per-property easing won't be lost
var t=ti(this,E.extend({},e),r);// Empty animations, or finishing resolves immediately
(o||ei.get(this,"finish"))&&t.stop(!0)};return s.finish=s,o||!1===r.queue?this.each(s):this.queue(r.queue,s)},stop:function(e,t,n){var i=function(e){var t=e.stop;delete e.stop,t(n)};return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&this.queue(e||"fx",[]),this.each(function(){var t=!0,o=null!=e&&e+"queueHooks",r=E.timers,s=ei.get(this);if(o)s[o]&&s[o].stop&&i(s[o]);else for(o in s)s[o]&&s[o].stop&&e4.test(o)&&i(s[o]);for(o=r.length;o--;)r[o].elem===this&&(null==e||r[o].queue===e)&&(r[o].anim.stop(n),t=!1,r.splice(o,1));// Start the next in the queue if the last step wasn't forced.
// Timers currently will call their complete callbacks, which
// will dequeue but only if they were gotoEnd.
(t||!n)&&E.dequeue(this,e)})},finish:function(e){return!1!==e&&(e=e||"fx"),this.each(function(){var t,n=ei.get(this),i=n[e+"queue"],o=n[e+"queueHooks"],r=E.timers,s=i?i.length:0;// Look for any active animations, and finish them
for(// Enable finishing flag on private data
n.finish=!0,// Empty the queue first
E.queue(this,e,[]),o&&o.stop&&o.stop.call(this,!0),t=r.length;t--;)r[t].elem===this&&r[t].queue===e&&(r[t].anim.stop(!0),r.splice(t,1));// Look for any animations in the old queue and finish them
for(t=0;t<s;t++)i[t]&&i[t].finish&&i[t].finish.call(this);// Turn off finishing flag
delete n.finish})}}),E.each(["toggle","show","hide"],function(e,t){var n=E.fn[t];E.fn[t]=function(e,i,o){return null==e||"boolean"==typeof e?n.apply(this,arguments):this.animate(tt(t,!0),e,i,o)}}),// Generate shortcuts for custom animations
...
E.fn.delay=function(t,n){return t=E.fx&&E.fx.speeds[t]||t,n=n||"fx",this.queue(n,function(n,i){var o=e.setTimeout(n,t);i.stop=function(){e.clearTimeout(o)}})},to=A.createElement("input"),tr=A.createElement("select").appendChild(A.createElement("option")),to.type="checkbox",// Support: Android <=4.3 only
// Default value for a checkbox should be "on"
h.checkOn=""!==to.value,// Support: IE <=11 only
// Must access selectedIndex to make default options select
h.optSelected=tr.selected,// Support: IE <=11 only
// An input loses its value after becoming a radio
(to=A.createElement("input")).value="t",to.type="radio",h.radioValue="t"===to.value;var to,tr,ts,ta=E.expr.attrHandle;E.fn.extend({attr:function(e,t){return J(this,E.attr,e,t,arguments.length>1)},removeAttr:function(e){return this.each(function(){E.removeAttr(this,e)})}}),E.extend({attr:function(e,t,n){var i,o,r=e.nodeType;// Don't get/set attributes on text, comment and attribute nodes
if(3!==r&&8!==r&&2!==r){// Fallback to prop when attributes are not supported
if(void 0===e.getAttribute)return E.prop(e,t,n);if(1===r&&E.isXMLDoc(e)||(o=E.attrHooks[t.toLowerCase()]||(E.expr.match.bool.test(t)?ts:void 0)),void 0!==n){if(null===n){E.removeAttr(e,t);return}return o&&"set"in o&&void 0!==(i=o.set(e,n,t))?i:(e.setAttribute(t,n+""),n)}return o&&"get"in o&&null!==(i=o.get(e,t))?i:null==(i=E.find.attr(e,t))?void 0:i}},attrHooks:{type:{set:function(e,t){if(!h.radioValue&&"radio"===t&&w(e,"input")){var n=e.value;return e.setAttribute("type",t),n&&(e.value=n),t}}}},removeAttr:function(e,t){var n,i=0,// https://html.spec.whatwg.org/multipage/syntax.html#attributes-2
o=t&&t.match(H);if(o&&1===e.nodeType)for(;n=o[i++];)e.removeAttribute(n)}}),// Hooks for boolean attributes
ts={set:function(e,t,n){return!1===t?E.removeAttr(e,n):e.setAttribute(n,n),n}},E.each(E.expr.match.bool.source.match(/\w+/g),function(e,t){var n=ta[t]||E.find.attr;ta[t]=function(e,t,i){var o,r,s=t.toLowerCase();return i||(// Avoid an infinite loop by temporarily removing this function from the getter
r=ta[s],ta[s]=o,o=null!=n(e,t,i)?s:null,ta[s]=r),o}});var tl=/^(?:input|select|textarea|button)$/i,tc=/^(?:a|area)$/i;// Strip and collapse whitespace according to HTML spec
// https://infra.spec.whatwg.org/#strip-and-collapse-ascii-whitespace
function tu(e){return(e.match(H)||[]).join(" ")}function tB(e){return e.getAttribute&&e.getAttribute("class")||""}function tF(e){return Array.isArray(e)?e:"string"==typeof e&&e.match(H)||[]}E.fn.extend({prop:function(e,t){return J(this,E.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[E.propFix[e]||e]})}}),E.extend({prop:function(e,t,n){var i,o,r=e.nodeType;// Don't get/set properties on text, comment and attribute nodes
if(3!==r&&8!==r&&2!==r)return(1===r&&E.isXMLDoc(e)||(// Fix name and attach hooks
t=E.propFix[t]||t,o=E.propHooks[t]),void 0!==n)?o&&"set"in o&&void 0!==(i=o.set(e,n,t))?i:e[t]=n:o&&"get"in o&&null!==(i=o.get(e,t))?i:e[t]},propHooks:{tabIndex:{get:function(e){// Support: IE <=9 - 11 only
// elem.tabIndex doesn't always return the
// correct value when it hasn't been explicitly set
// Use proper attribute retrieval (trac-12072)
var t=E.find.attr(e,"tabindex");return t?parseInt(t,10):tl.test(e.nodeName)||tc.test(e.nodeName)&&e.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),h.optSelected||(E.propHooks.selected={get:function(e){/* eslint no-unused-expressions: "off" */var t=e.parentNode;return t&&t.parentNode&&t.parentNode.selectedIndex,null},set:function(e){/* eslint no-unused-expressions: "off" */var t=e.parentNode;t&&(t.selectedIndex,t.parentNode&&t.parentNode.selectedIndex)}}),E.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){E.propFix[this.toLowerCase()]=this}),E.fn.extend({addClass:function(e){var t,n,i,o,r,s;return f(e)?this.each(function(t){E(this).addClass(e.call(this,t,tB(this)))}):(t=tF(e)).length?this.each(function(){if(i=tB(this),n=1===this.nodeType&&" "+tu(i)+" "){for(r=0;r<t.length;r++)o=t[r],0>n.indexOf(" "+o+" ")&&(n+=o+" ");i!==// Only assign if different to avoid unneeded rendering.
(s=tu(n))&&this.setAttribute("class",s)}}):this},removeClass:function(e){var t,n,i,o,r,s;return f(e)?this.each(function(t){E(this).removeClass(e.call(this,t,tB(this)))}):arguments.length?(t=tF(e)).length?this.each(function(){if(i=tB(this),// This expression is here for better compressibility (see addClass)
n=1===this.nodeType&&" "+tu(i)+" "){for(r=0;r<t.length;r++)// Remove *all* instances
for(o=t[r];n.indexOf(" "+o+" ")>-1;)n=n.replace(" "+o+" "," ");i!==// Only assign if different to avoid unneeded rendering.
(s=tu(n))&&this.setAttribute("class",s)}}):this:this.attr("class","")},toggleClass:function(e,t){var n,i,o,r,s=typeof e,a="string"===s||Array.isArray(e);return f(e)?this.each(function(n){E(this).toggleClass(e.call(this,n,tB(this),t),t)}):"boolean"==typeof t&&a?t?this.addClass(e):this.removeClass(e):(n=tF(e),this.each(function(){if(a)for(o=0,// Toggle individual class names
r=E(this);o<n.length;o++)i=n[o],r.hasClass(i)?r.removeClass(i):r.addClass(i);else(void 0===e||"boolean"===s)&&((i=tB(this))&&ei.set(this,"__className__",i),this.setAttribute&&this.setAttribute("class",i||!1===e?"":ei.get(this,"__className__")||""))}))},hasClass:function(e){var t,n,i=0;for(t=" "+e+" ";n=this[i++];)if(1===n.nodeType&&(" "+tu(tB(n))+" ").indexOf(t)>-1)return!0;return!1}});var td=/\r/g;E.fn.extend({val:function(e){var t,n,i,o=this[0];return arguments.length?(i=f(e),this.each(function(n){var o;1!==this.nodeType||(null==(o=i?e.call(this,n,E(this).val()):e)?o="":"number"==typeof o?o+="":Array.isArray(o)&&(o=E.map(o,function(e){return null==e?"":e+""})),(t=E.valHooks[this.type]||E.valHooks[this.nodeName.toLowerCase()])&&"set"in t&&void 0!==t.set(this,o,"value")||(this.value=o))})):o?(t=E.valHooks[o.type]||E.valHooks[o.nodeName.toLowerCase()])&&"get"in t&&void 0!==(n=t.get(o,"value"))?n:"string"==typeof(n=o.value)?n.replace(td,""):null==n?"":n:void 0}}),E.extend({valHooks:{option:{get:function(e){var t=E.find.attr(e,"value");return null!=t?t:// option.text throws exceptions (trac-14686, trac-14858)
// Strip and collapse whitespace
// https://html.spec.whatwg.org/#strip-and-collapse-whitespace
tu(E.text(e))}},select:{get:function(e){var t,n,i,o=e.options,r=e.selectedIndex,s="select-one"===e.type,a=s?null:[],l=s?r+1:o.length;// Loop through all the selected options
...
a.push(t)}return a},set:function(e,t){for(var n,i,o=e.options,r=E.makeArray(t),s=o.length;s--;)/* eslint-disable no-cond-assign */((i=o[s]).selected=E.inArray(E.valHooks.option.get(i),r)>-1)&&(n=!0);return n||(e.selectedIndex=-1),r}}}}),// Radios and checkboxes getter/setter
...
try{n=new e.DOMParser().parseFromString(t,"text/xml")}catch(e){}return i=n&&n.getElementsByTagName("parsererror")[0],(!n||i)&&E.error("Invalid XML: "+(i?E.map(i.childNodes,function(e){return e.textContent}).join("\n"):t)),n};var tA=/^(?:focusinfocus|focusoutblur)$/,tg=function(e){e.stopPropagation()};E.extend(E.event,{trigger:function(t,n,i,o){var r,s,a,l,c,u,F,d,h=[i||A],g=B.call(t,"type")?t.type:t,v=B.call(t,"namespace")?t.namespace.split("."):[];// Don't do events on text and comment nodes
if(s=d=a=i=i||A,!(3===i.nodeType||8===i.nodeType||tA.test(g+E.event.triggered))&&(g.indexOf(".")>-1&&(g=// Namespaced trigger; create a regexp to match event type in handle()
(v=g.split(".")).shift(),v.sort()),c=0>g.indexOf(":")&&"on"+g,// Trigger bitmask: & 1 for native handlers; & 2 for jQuery (always true)
// Caller can pass in a jQuery.Event object, Object, or just an event type string
(t=t[E.expando]?t:new E.Event(g,"object"==typeof t&&t)).isTrigger=o?2:3,t.namespace=v.join("."),t.rnamespace=t.namespace?RegExp("(^|\\.)"+v.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,// Clean up the event in case it is being reused
...
F=E.event.special[g]||{},o||!F.trigger||!1!==F.trigger.apply(i,n))){// Determine event propagation path in advance, per W3C events spec (trac-9951)
// Bubble up to document, then to window; watch for a global ownerDocument var (trac-9724)
if(!o&&!F.noBubble&&!p(i)){for(l=F.delegateType||g,tA.test(l+g)||(s=s.parentNode);s;s=s.parentNode)h.push(s),a=s;a===(i.ownerDocument||A)&&h.push(a.defaultView||a.parentWindow||e)}for(// Fire handlers on the event path
r=0;(s=h[r++])&&!t.isPropagationStopped();)d=s,t.type=r>1?l:F.bindType||g,// jQuery handler
(u=(ei.get(s,"events")||Object.create(null))[t.type]&&ei.get(s,"handle"))&&u.apply(s,n),// Native handler
(u=c&&s[c])&&u.apply&&et(s)&&(t.result=u.apply(s,n),!1===t.result&&t.preventDefault());return t.type=g,!o&&!t.isDefaultPrevented()&&(!F._default||!1===F._default.apply(h.pop(),n))&&et(i)&&c&&f(i[g])&&!p(i)&&(// Don't re-trigger an onFOO event when we call its FOO() method
(a=i[c])&&(i[c]=null),// Prevent re-triggering of the same event, since we already bubbled it above
E.event.triggered=g,t.isPropagationStopped()&&d.addEventListener(g,tg),i[g](),t.isPropagationStopped()&&d.removeEventListener(g,tg),E.event.triggered=void 0,a&&(i[c]=a)),t.result}},// Piggyback on a donor event to simulate a different one
// Used only for `focus(in | out)` events
simulate:function(e,t,n){var i=E.extend(new E.Event,n,{type:e,isSimulated:!0});E.event.trigger(i,null,t)}}),E.fn.extend({trigger:function(e,t){return this.each(function(){E.event.trigger(e,t,this)})},triggerHandler:function(e,t){var n=this[0];if(n)return E.event.trigger(e,t,n,!0)}});var tv=/\[\]$/,tm=/\r?\n/g,tb=/^(?:submit|button|image|reset|file)$/i,ty=/^(?:input|select|textarea|keygen)/i;// Serialize an array of form elements or a set of
// key/values into a query string
E.param=function(e,t){var n,i=[],o=function(e,t){// If value is a function, invoke it and use its return value
...
for(n in e)!function e(t,n,i,o){var r;if(Array.isArray(n))E.each(n,function(n,r){i||tv.test(t)?o(t,r):e(t+"["+("object"==typeof r&&null!=r?n:"")+"]",r,i,o)});else if(i||"object"!==m(n))o(t,n);else for(r in n)e(t+"["+r+"]",n[r],i,o)}(n,e[n],t,o);// Return the resulting serialization
...
return this.name&&!E(this).is(":disabled")&&ty.test(this.nodeName)&&!tb.test(e)&&(this.checked||!eg.test(e))}).map(function(e,t){var n=E(this).val();return null==n?null:Array.isArray(n)?E.map(n,function(e){return{name:t.name,value:e.replace(tm,"\r\n")}}):{name:t.name,value:n.replace(tm,"\r\n")}}).get()}});var tE=/%20/g,tC=/#.*$/,tw=/([?&])_=[^&]*/,tI=/^(.*?):[ \t]*([^\r\n]*)$/mg,tx=/^(?:GET|HEAD)$/,tk=/^\/\//,/* Prefilters
	 ...
	 */tS={},tq="*/".concat("*"),tU=A.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
function tR(e){// dataTypeExpression is optional and defaults to "*"
return function(t,n){"string"!=typeof t&&(n=t,t="*");var i,o=0,r=t.toLowerCase().match(H)||[];if(f(n))// For each dataType in the dataTypeExpression
for(;i=r[o++];)"+"===i[0]?(e[i=i.slice(1)||"*"]=e[i]||[]).unshift(n):(e[i]=e[i]||[]).push(n)}}// Base inspection function for prefilters and transports
function tV(e,t,n,i){var o={},r=e===tS;function s(a){var l;return o[a]=!0,E.each(e[a]||[],function(e,a){var c=a(t,n,i);return"string"!=typeof c||r||o[c]?r?!(l=c):void 0:(t.dataTypes.unshift(c),s(c),!1)}),l}return s(t.dataTypes[0])||!o["*"]&&s("*")}// A special extend for ajax options
// that takes "flat" options (not to be deep extended)
// Fixes trac-9887
function tK(e,t){var n,i,o=E.ajaxSettings.flatOptions||{};for(n in t)void 0!==t[n]&&((o[n]?e:i||(i={}))[n]=t[n]);return i&&E.extend(!0,e,i),e}tU.href=th.href,E.extend({// Counter for holding the number of active queries
...
ajaxSetup:function(e,t){return t?tK(tK(e,E.ajaxSettings),t):tK(E.ajaxSettings,e)},ajaxPrefilter:tR(tQ),ajaxTransport:tR(tS),// Main method
ajax:function(t,n){"object"==typeof t&&(n=t,t=void 0),// Force options to be an object
n=n||{};var i,o,r,s,a,l,c,u,B,F,d=E.ajaxSetup({},n),h=d.context||d,f=d.context&&(h.nodeType||h.jquery)?E(h):E.event,p=E.Deferred(),g=E.Callbacks("once memory"),v=d.statusCode||{},m={},b={},y="canceled",C={readyState:0,// Builds headers hashtable if needed
getResponseHeader:function(e){var t;if(c){if(!s)for(s={};t=tI.exec(r);)s[t[1].toLowerCase()+" "]=(s[t[1].toLowerCase()+" "]||[]).concat(t[2]);t=s[e.toLowerCase()+" "]}return null==t?null:t.join(", ")},// Raw string
getAllResponseHeaders:function(){return c?r:null},// Caches the header
setRequestHeader:function(e,t){return null==c&&(m[e=b[e.toLowerCase()]=b[e.toLowerCase()]||e]=t),this},// Overrides response content-type header
overrideMimeType:function(e){return null==c&&(d.mimeType=e),this},// Status-dependent callbacks
statusCode:function(e){var t;if(e){if(c)C.always(e[C.status]);else for(t in e)v[t]=[v[t],e[t]]}return this},// Cancel the request
abort:function(e){var t=e||y;return i&&i.abort(t),w(0,t),this}};// A cross-domain request is in order when the origin doesn't match the current origin.
if(// Attach deferreds
p.promise(C),// Add protocol if not provided (prefilters might expect it)
// Handle falsy url in the settings object (trac-10093: consistency with old signature)
// We also use the url parameter if available
d.url=((t||d.url||th.href)+"").replace(tk,th.protocol+"//"),// Alias method option to type as per ticket trac-12004
d.type=n.method||n.type||d.method||d.type,// Extract dataTypes list
d.dataTypes=(d.dataType||"*").toLowerCase().match(H)||[""],null==d.crossDomain){l=A.createElement("a");// Support: IE <=8 - 11, Edge 12 - 15
// IE throws exception on accessing the href property if url is malformed,
// e.g. http://example.com:80x/
try{l.href=d.url,// Support: IE <=8 - 11 only
// Anchor's host property isn't correctly set when s.url is relative
l.href=l.href,d.crossDomain=tU.protocol+"//"+tU.host!=l.protocol+"//"+l.host}catch(e){// If there is an error parsing the URL, assume it is crossDomain,
...
tV(tQ,d,n,C),c)return C;// Check for headers option
for(B in// We can fire global events as of now if asked to
// Don't fire events if jQuery.event is undefined in an AMD-usage scenario (trac-15118)
(u=E.event&&d.global)&&0==E.active++&&E.event.trigger("ajaxStart"),// Uppercase the type
d.type=d.type.toUpperCase(),// Determine if request has content
d.hasContent=!tx.test(d.type),// Save the URL in case we're toying with the If-Modified-Since
// and/or If-None-Match header later on
// Remove hash to simplify url manipulation
o=d.url.replace(tC,""),d.hasContent?d.data&&d.processData&&0===(d.contentType||"").indexOf("application/x-www-form-urlencoded")&&(d.data=d.data.replace(tE,"+")):(// Remember the hash so we can put it back
F=d.url.slice(o.length),d.data&&(d.processData||"string"==typeof d.data)&&(o+=(tp.test(o)?"&":"?")+d.data,// trac-9682: remove data so that it's not used in an eventual retry
delete d.data),!1===d.cache&&(o=o.replace(tw,"$1"),F=(tp.test(o)?"&":"?")+"_="+tf.guid+++F),// Put hash and anti-cache on the URL that will be requested (gh-1732)
d.url=o+F),d.ifModified&&(E.lastModified[o]&&C.setRequestHeader("If-Modified-Since",E.lastModified[o]),E.etag[o]&&C.setRequestHeader("If-None-Match",E.etag[o])),(d.data&&d.hasContent&&!1!==d.contentType||n.contentType)&&C.setRequestHeader("Content-Type",d.contentType),// Set the Accepts header for the server, depending on the dataType
C.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+tq+"; q=0.01":""):d.accepts["*"]),d.headers)C.setRequestHeader(B,d.headers[B]);// Allow custom headers/mimetypes and early abort
if(d.beforeSend&&(!1===d.beforeSend.call(h,C,d)||c))return C.abort();// If no transport, we auto-abort
if(// Aborting is no longer a cancellation
y="abort",// Install callbacks on deferreds
g.add(d.complete),C.done(d.success),C.fail(d.error),// Get transport
i=tV(tS,d,n,C)){// If request was aborted inside ajaxSend, stop there
if(C.readyState=1,u&&f.trigger("ajaxSend",[C,d]),c)return C;d.async&&d.timeout>0&&(a=e.setTimeout(function(){C.abort("timeout")},d.timeout));try{c=!1,i.send(m,w)}catch(e){// Rethrow post-completion exceptions
if(c)throw e;// Propagate others as results
w(-1,e)}}else w(-1,"No Transport");// Callback for when everything is done
function w(t,n,s,l){var B,F,A,m,b,y=n;// Ignore repeat invocations
...
B=t>=200&&t<300||304===t,s&&(m=/* Handles responses to an ajax request:
 * - finds the right dataType (mediates between content-type and expected dataType)
 * - returns the corresponding response
 */function(e,t,n){// Remove auto dataType and get content-type in the process
for(var i,o,r,s,a=e.contents,l=e.dataTypes;"*"===l[0];)l.shift(),void 0===i&&(i=e.mimeType||t.getResponseHeader("Content-Type"));// Check if we're dealing with a known content-type
if(i){for(o in a)if(a[o]&&a[o].test(i)){l.unshift(o);break}}// Check to see if we have a response for the expected dataType
if(l[0]in n)r=l[0];else{// Try convertible dataTypes
for(o in n){if(!l[0]||e.converters[o+" "+l[0]]){r=o;break}s||(s=o)}// Or just use first one
r=r||s}// If we found a dataType
// We add the dataType to the list if needed
// and return the corresponding response
if(r)return r!==l[0]&&l.unshift(r),n[r]}(d,C,s)),!B&&E.inArray("script",d.dataTypes)>-1&&0>E.inArray("json",d.dataTypes)&&(d.converters["text script"]=function(){}),// Convert no matter what (that way responseXXX fields are always set)
m=/* Chain conversions given the request and the original response
 * Also sets the responseXXX fields on the jqXHR instance
 */function(e,t,n,i){var o,r,s,a,l,c={},u=e.dataTypes.slice();// Create converters map with lowercased keys
if(u[1])for(s in e.converters)c[s.toLowerCase()]=e.converters[s];// Convert to each sequential dataType
for(r=u.shift();r;)if(e.responseFields[r]&&(n[e.responseFields[r]]=t),!l&&i&&e.dataFilter&&(t=e.dataFilter(t,e.dataType)),l=r,r=u.shift()){// There's only work to do if current dataType is non-auto
if("*"===r)r=l;else if("*"!==l&&l!==r){// If none found, seek a pair
if(!// Seek a direct converter
(s=c[l+" "+r]||c["* "+r])){for(o in c)if(// If conv2 outputs current
(a=o.split(" "))[1]===r&&// If prev can be converted to accepted input
(s=c[l+" "+a[0]]||c["* "+a[0]])){// Condense equivalence converters
!0===s?s=c[o]:!0!==c[o]&&(r=a[0],u.unshift(a[1]));break}}// Apply converter (if not an equivalence)
if(!0!==s){// Unless errors are allowed to bubble, catch and return them
if(s&&e.throws)t=s(t);else try{t=s(t)}catch(e){return{state:"parsererror",error:s?e:"No conversion from "+l+" to "+r}}}}}return{state:"success",data:t}}(d,m,C,B),B?(d.ifModified&&((b=C.getResponseHeader("Last-Modified"))&&(E.lastModified[o]=b),(b=C.getResponseHeader("etag"))&&(E.etag[o]=b)),204===t||"HEAD"===d.type?y="nocontent":304===t?y="notmodified":(y=m.state,F=m.data,B=!(A=m.error))):(// Extract error from statusText and normalize for non-aborts
A=y,(t||!y)&&(y="error",t<0&&(t=0))),// Set data for the fake xhr object
C.status=t,C.statusText=(n||y)+"",B?p.resolveWith(h,[F,y,C]):p.rejectWith(h,[C,y,A]),// Status-dependent callbacks
C.statusCode(v),v=void 0,u&&f.trigger(B?"ajaxSuccess":"ajaxError",[C,d,B?F:A]),// Complete
g.fireWith(h,[C,y]),!u||(f.trigger("ajaxComplete",[C,d]),--E.active||E.event.trigger("ajaxStop")))}return C},getJSON:function(e,t,n){return E.get(e,t,n,"json")},getScript:function(e,t){return E.get(e,void 0,t,"script")}}),E.each(["get","post"],function(e,t){E[t]=function(e,n,i,o){// The url can be an options object (which then must have .url)
return f(n)&&(o=o||i,i=n,n=void 0),E.ajax(E.extend({url:e,type:t,dataType:o,data:n,success:i},E.isPlainObject(e)&&e))}}),E.ajaxPrefilter(function(e){var t;for(t in e.headers)"content-type"===t.toLowerCase()&&(e.contentType=e.headers[t]||"")}),E._evalUrl=function(e,t,n){return E.ajax({url:e,// Make this explicit, since user can override this through ajaxSetup (trac-11264)
...
t=E(e,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&t.insertBefore(this[0]),t.map(function(){for(var e=this;e.firstElementChild;)e=e.firstElementChild;return e}).append(this)),this},wrapInner:function(e){return f(e)?this.each(function(t){E(this).wrapInner(e.call(this,t))}):this.each(function(){var t=E(this),n=t.contents();n.length?n.wrapAll(e):t.append(e)})},wrap:function(e){var t=f(e);return this.each(function(n){E(this).wrapAll(t?e.call(this,n):e)})},unwrap:function(e){return this.parent(e).not("body").each(function(){E(this).replaceWith(this.childNodes)}),this}}),E.expr.pseudos.hidden=function(e){return!E.expr.pseudos.visible(e)},E.expr.pseudos.visible=function(e){return!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)},E.ajaxSettings.xhr=function(){try{return new e.XMLHttpRequest}catch(e){}};var tT={// File protocol always yields status code 0, assume 200
0:200,// Support: IE <=9 only
// trac-1450: sometimes IE returns 1223 when it should be 204
1223:204},tz=E.ajaxSettings.xhr();h.cors=!!tz&&"withCredentials"in tz,h.ajax=tz=!!tz,E.ajaxTransport(function(t){var n,i;// Cross domain only allowed if supported through XMLHttpRequest
if(h.cors||tz&&!t.crossDomain)return{send:function(o,r){var s,a=t.xhr();// Apply custom fields if provided
if(a.open(t.type,t.url,t.async,t.username,t.password),t.xhrFields)for(s in t.xhrFields)a[s]=t.xhrFields[s];// Set headers
for(s in t.mimeType&&a.overrideMimeType&&a.overrideMimeType(t.mimeType),t.crossDomain||o["X-Requested-With"]||(o["X-Requested-With"]="XMLHttpRequest"),o)a.setRequestHeader(s,o[s]);// Callback
n=function(e){return function(){n&&(n=i=a.onload=a.onerror=a.onabort=a.ontimeout=a.onreadystatechange=null,"abort"===e?a.abort():"error"===e?"number"!=typeof a.status?r(0,"error"):r(a.status,a.statusText):r(tT[a.status]||a.status,a.statusText,"text"!==// IE9 has no XHR2 but throws on binary (trac-11426)
...
if(e.crossDomain||e.scriptAttrs){var t,n;return{send:function(i,o){t=E("<script>").attr(e.scriptAttrs||{}).prop({charset:e.scriptCharset,src:e.url}).on("load error",n=function(e){t.remove(),n=null,e&&o("error"===e.type?404:200,e.type)}),// Use native DOM manipulation to avoid our domManip AJAX trickery
A.head.appendChild(t[0])},abort:function(){n&&n()}}}});var tZ=[],tL=/(=)\?(?=&|$)|\?\?/;// Default jsonp settings
E.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=tZ.pop()||E.expando+"_"+tf.guid++;return this[e]=!0,e}}),// Detect, normalize options and install callbacks for jsonp requests
E.ajaxPrefilter("json jsonp",function(t,n,i){var o,r,s,a=!1!==t.jsonp&&(tL.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&tL.test(t.data)&&"data");// Handle iff the expected data type is "jsonp" or we have a parameter to set
if(a||"jsonp"===t.dataTypes[0])// Delegate to script
return(// Get callback name, remembering preexisting value associated with it
o=t.jsonpCallback=f(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,a?t[a]=t[a].replace(tL,"$1"+o):!1!==t.jsonp&&(t.url+=(tp.test(t.url)?"&":"?")+t.jsonp+"="+o),// Use data converter to retrieve json after script execution
t.converters["script json"]=function(){return s||E.error(o+" was not called"),s[0]},// Force json dataType
t.dataTypes[0]="json",// Install callback
r=e[o],e[o]=function(){s=arguments},// Clean-up function (fires after converters)
i.always(function(){void 0===r?E(e).removeProp(o):e[o]=r,t[o]&&(// Make sure that re-using the options doesn't screw things around
t.jsonpCallback=n.jsonpCallback,// Save the callback name for future use
tZ.push(o)),s&&f(r)&&r(s[0]),s=r=void 0}),"script")}),// Support: Safari 8 only
...
E.parseHTML=function(e,t,n){var i,o,r;return"string"!=typeof e?[]:("boolean"==typeof t&&(n=t,t=!1),t||(h.createHTMLDocument?(// Set the base href for the created document
// so any parsed elements with URLs
// are based on the document's URL (gh-2965)
(i=(t=A.implementation.createHTMLDocument("")).createElement("base")).href=A.location.href,t.head.appendChild(i)):t=A),o=T.exec(e),r=!n&&[],o)?[t.createElement(o[1])]:(o=ew([e],t,r),r&&r.length&&E(r).remove(),E.merge([],o.childNodes))},/**
 * Load a url into a page
 */E.fn.load=function(e,t,n){var i,o,r,s=this,a=e.indexOf(" ");return a>-1&&(i=tu(e.slice(a)),e=e.slice(0,a)),f(t)?(// We assume that it's the callback
n=t,t=void 0):t&&"object"==typeof t&&(o="POST"),s.length>0&&E.ajax({url:e,// If "type" variable is undefined, then "GET" method will be used.
...
}).always(n&&function(e,t){s.each(function(){n.apply(this,r||[e.responseText,t,e])})}),this},E.expr.pseudos.animated=function(e){return E.grep(E.timers,function(t){return e===t.elem}).length},E.offset={setOffset:function(e,t,n){var i,o,r,s,a,l,c=E.css(e,"position"),u=E(e),B={};"static"===c&&(e.style.position="relative"),a=u.offset(),r=E.css(e,"top"),l=E.css(e,"left"),("absolute"===c||"fixed"===c)&&(r+l).indexOf("auto")>-1?(s=(i=u.position()).top,o=i.left):(s=parseFloat(r)||0,o=parseFloat(l)||0),f(t)&&(t=t.call(e,n,E.extend({},a))),null!=t.top&&(B.top=t.top-a.top+s),null!=t.left&&(B.left=t.left-a.left+o),"using"in t?t.using.call(e,B):u.css(B)}},E.fn.extend({// offset() relates an element's border box to the document origin
...
position:function(){if(this[0]){var e,t,n,i=this[0],o={top:0,left:0};// position:fixed elements are offset from the viewport, which itself always has zero offset
...
return{top:t.top-o.top-E.css(i,"marginTop",!0),left:t.left-o.left-E.css(i,"marginLeft",!0)}}},// This method will return documentElement in the following cases:
...
E.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(e,t){var n="pageYOffset"===t;E.fn[e]=function(i){return J(this,function(e,i,o){// Coalesce documents and windows
var r;if(p(e)?r=e:9===e.nodeType&&(r=e.defaultView),void 0===o)return r?r[t]:e[i];r?r.scrollTo(n?r.pageXOffset:o,n?o:r.pageYOffset):e[i]=o},e,i,arguments.length)}}),// Support: Safari <=7 - 9.1, Chrome <=37 - 49
// Add the top/left cssHooks using jQuery.fn.position
// Webkit bug: https://bugs.webkit.org/show_bug.cgi?id=29084
// Blink bug: https://bugs.chromium.org/p/chromium/issues/detail?id=589347
// getComputedStyle returns percent when specified for top/left/bottom/right;
// rather than make the css module depend on the offset module, just check for it here
E.each(["top","left"],function(e,t){E.cssHooks[t]=eO(h.pixelPosition,function(e,n){if(n)// If curCSS returns percentage, fallback to offset
return n=ej(e,t),eD.test(n)?E(e).position()[t]+"px":n})}),// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
...
E.fn[i]=function(o,r){var s=arguments.length&&(n||"boolean"!=typeof o),a=n||(!0===o||!0===r?"margin":"border");return J(this,function(t,n,o){var r;return p(t)?0===i.indexOf("outer")?t["inner"+e]:t.document.documentElement["client"+e]:9===t.nodeType?(r=t.documentElement,Math.max(t.body["scroll"+e],r["scroll"+e],t.body["offset"+e],r["offset"+e],r["client"+e])):void 0===o?E.css(t,n,a):E.style(t,n,o,a)},t,s?o:void 0,s)}})}),E.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){E.fn[t]=function(e){return this.on(t,e)}}),E.fn.extend({bind:function(e,t,n){return this.on(e,null,t,n)},unbind:function(e,t){return this.off(e,null,t)},delegate:function(e,t,n,i){return this.on(t,e,n,i)},undelegate:function(e,t,n){// ( namespace ) or ( selector, types [, fn] )
...
var tD=/^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;// Bind a function to a context, optionally partially applying any
// arguments.
// jQuery.proxy is deprecated to promote standards (specifically Function#bind)
// However, it is not slated for removal any time soon
E.proxy=function(e,t){var n,i,o;// Quick check to determine if target is callable, in the spec
...
(o=function(){return e.apply(t||this,i.concat(r.call(arguments)))}).guid=e.guid=e.guid||E.guid++,o)},E.holdReady=function(e){e?E.readyWait++:E.ready(!0)},E.isArray=Array.isArray,E.parseJSON=JSON.parse,E.nodeName=w,E.isFunction=f,E.isWindow=p,E.camelCase=ee,E.type=m,E.now=Date.now,E.isNumeric=function(e){// As of jQuery 3.0, isNumeric is limited to
...
n.on=function(){return"click"==arguments[0]?(t.push(arguments[1]),this):o.apply(this,arguments)},n)},U=()=>`
    ...
    <section>
      ...
      <div class="logoWrap">
        <svg id="logo" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          <image x="0" y="0" width="100" height="100" xlink:href="${/*@__PURE__*/i(c)}" />
  ...
  </div>`,R=e=>/*@__PURE__*/i(l)("<div>",{class:"upcoming"}).append(/*@__PURE__*/i(l)("<h2>",{text:"Upcoming Concert"}),/*@__PURE__*/i(l)("<div>",{class:"row"}).append(/*@__PURE__*/i(l)("<div>",{class:"poster",css:{backgroundImage:`url('${v(e.concert.poster,600,400)}')`}}),/*@__PURE__*/i(l)("<div>",{class:"info"}).append(/*@__PURE__*/i(l)("<h3>",{text:e.concert.title}),/*@__PURE__*/i(l)("<span>",{text:g(e.concert.when)}),e.concert.facebook?k(e.concert.facebook):[]))),V=()=>/*@__PURE__*/i(l)("<div>",{class:"upcoming"}).append(/*@__PURE__*/i(l)("<h2>",{text:"Upcoming Concert"}),/*@__PURE__*/i(l)("<p>",{text:"Check back soon for details of our next concert."})),K=[/*@__PURE__*/i(u),/*@__PURE__*/i(B),/*@__PURE__*/i(F),/*@__PURE__*/i(d),/*@__PURE__*/i(h),/*@__PURE__*/i(f),/*@__PURE__*/i(p)];// HAHAHA no structure for me!
let T=0;const z=()=>L(-1),Z=()=>L(1);function L(e){console.debug(`galleryMove(delta=${e})`),T=(T+e+K.length)%K.length;let t=/*@__PURE__*/i(l)(".gallery");// global!
t.find("img").attr("src",K[T]),t.find(".dot").removeClass("big").eq(T).addClass("big")}const D=()=>{let e=/*@__PURE__*/i(l)("<div>",{class:"gallery"}).append(/*@__PURE__*/i(l)("<div>",{class:"leftRight"}).append(/*@__PURE__*/i(l)("<div>").append(Q({icon:"chevron_left"})).on("click",z),/*@__PURE__*/i(l)("<div>").append(Q({icon:"chevron_right"})).on("click",Z)),/*@__PURE__*/i(l)("<img>"),/*@__PURE__*/i(l)("<div>",{class:"dots"}).append(K.map(()=>/*@__PURE__*/i(l)("<span>",{class:"dot"}))));return(// initialize after adding to the DOM
// stupid global state HAHAHA
setTimeout(()=>L(0),0),e)};function P(e,t,n){let i=document.querySelector(e);if(!i)throw Error(`Invalid element for selector: ${e}`);let o=/** general helper functions */function(e,t){let n=e;do n=n.parentElement;while(n&&!(null==n?void 0:n.matches(".t")))return n}(i,0);if(!o)throw Error(`Couldn't find track for selector ${e}`);let r=new ViewTimeline({subject:o});// if (!re.test(options.timeRange || ""))
//   throw new Error(`Invalid timeRange: ${options.timeRange}`);
// timeline.
i.animate(t,y(b({},n),{timeline:r}))}async function W(){/** Prepare 10 year video autoplay on scroll in */(function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
e.muted=!0,e.controls=!1,new IntersectionObserver(t=>{1!=t.length&&console.warn(`Expected 1 entry, got ${t.length}`),t.forEach(t=>{t.isIntersecting?(e.play(),e.controls=!0):e.pause()})},{threshold:0,rootMargin:"-50% 0% -40%"}).observe(e)})(),// @ts-ignore
await s("918dL"),P("#logo",{width:["40lvh","100px"]},{timeRange:"exit 0% 50%",fill:"both",easing:"linear"}),P(".logoWrap",{height:["40lvh","100px"]},{timeRange:"exit 10% 100%",fill:"both",easing:"linear"}),P(".upcomingCover",[{visibility:"visible",opacity:1},{visibility:"hidden",opacity:0}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),P("nav",[{visibility:"hidden",opacity:0},{visibility:"visible",opacity:1}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"});// [1, 3].forEach((n) => {
//   animate(
//     `.posters>:nth-child(${n})`,
//     // { marginTop: ["0%", "-120%"] },
...
let e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}/**
	 ...
	 */destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}constructor(e,t,n,i,o="div"){/**
		 ...
		 * @type {HTMLElement}
		 */this.domElement=document.createElement(o),this.domElement.classList.add("controller"),this.domElement.classList.add(i),/**
...
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=ec.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let o=e*i<<16^t*i<<8^n*i<<0;return ec.toHexString(o)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=ec.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let o=e*i<<16^t*i<<8^n*i<<0;return ec.toHexString(o)}}];class eB extends es{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var o;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(o=this.initialValue,eu.find(e=>e.match(o))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=el(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class eF extends es{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class ed extends es{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
this.$input.value=this.getValue())},n=!1,i,o,r,s,a,l=e=>{if(n){let t=e.clientX-i,r=e.clientY-o;Math.abs(r)>5?(e.preventDefault(),this.$input.blur(),n=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(t)>5&&c()}// This isn't an else so that the first move counts towards dragDelta
if(!n){let t=e.clientY-r;a-=t*this._step*this._arrowKeyMultiplier(e),s+a>this._max?a=this._max-s:s+a<this._min&&(a=this._min-s),this._snapClampSetValue(s+a)}r=e.clientY},c=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",c)};this.$input.addEventListener("input",()=>{let e=parseFloat(this.$input.value);isNaN(e)||(this._stepExplicit&&(e=this._snap(e)),this.setValue(this._clamp(e)))}),this.$input.addEventListener("keydown",e=>{"Enter"===e.key&&this.$input.blur(),"ArrowUp"===e.code&&(e.preventDefault(),t(this._step*this._arrowKeyMultiplier(e))),"ArrowDown"===e.code&&(e.preventDefault(),t(-(this._step*this._arrowKeyMultiplier(e)*1)))}),this.$input.addEventListener("wheel",e=>{this._inputFocused&&(e.preventDefault(),t(this._step*this._normalizeMouseWheel(e)))},{passive:!1}),this.$input.addEventListener("mousedown",e=>{i=e.clientX,o=r=e.clientY,n=!0,s=this.getValue(),a=0,window.addEventListener("mousemove",l),window.addEventListener("mouseup",c)}),this.$input.addEventListener("focus",()=>{this._inputFocused=!0}),this.$input.addEventListener("blur",()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()})}_initSlider(){let e;this._hasSlider=!0,// Build DOM
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
let t=(e,t,n,i,o)=>(e-t)/(n-t)*(o-i)+i,n=e=>{let n=this.$slider.getBoundingClientRect(),i=t(e,n.left,n.right,this._min,this._max);this._snapClampSetValue(i)},i=e=>{n(e.clientX)},o=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",i),window.removeEventListener("mouseup",o)},r=!1,s,a,l=e=>{e.preventDefault(),this._setDraggingStyle(!0),n(e.touches[0].clientX),r=!1},c=e=>{if(r){let t=e.touches[0].clientX-s,n=e.touches[0].clientY-a;Math.abs(t)>Math.abs(n)?l(e):(// This was, in fact, an attempt to scroll. Abort.
window.removeEventListener("touchmove",c),window.removeEventListener("touchend",u))}else e.preventDefault(),n(e.touches[0].clientX)},u=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",c),window.removeEventListener("touchend",u)},B=this._callOnFinishChange.bind(this);this.$slider.addEventListener("mousedown",e=>{this._setDraggingStyle(!0),n(e.clientX),window.addEventListener("mousemove",i),window.addEventListener("mouseup",o)}),this.$slider.addEventListener("touchstart",e=>{e.touches.length>1||(this._hasScrollBar?(s=e.touches[0].clientX,a=e.touches[0].clientY,r=!0):l(e),window.addEventListener("touchmove",c,{passive:!1}),window.addEventListener("touchend",u))},{passive:!1}),this.$slider.addEventListener("wheel",t=>{// ignore vertical wheels if there's a scrollbar
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,o){if(Object(n)===n)return new eh(this,e,t,n);let r=e[t];switch(typeof r){case"number":return new ed(this,e,t,n,i,o);case"boolean":return new ea(this,e,t);case"string":return new ef(this,e,t);case"function":return new eF(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,r)}/**
	 ...
	 * @returns {this}
	 */load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{!(t instanceof eF)&&t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}/**
...
let i=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this)}/**
	 ...
	 *
	 */constructor({parent:e,autoPlace:t=void 0===e,container:n,width:i,title:o="Controls",closeFolders:r=!1,injectStyles:s=!0,touchStyles:a=!0}={}){if(/**
...
this.$title.addEventListener("touchstart",()=>{},{passive:!0}),/**
		 ...
		 * @type {HTMLElement}
		 */this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(o),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);// Stop the constructor early, everything onward only applies to root GUI's
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!eA&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(ep),eA=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=r}}function ev(){return localStorage.getItem("adminLoginRedirectTo")||"/"}var em={};em=/******/function(e){/******/// The module cache
/******/var t={};/******//******/// The require function
/******/function n(i){/******//******/// Check if module is in cache
/******/if(t[i])/******/return t[i].exports;/******/// Create a new module (and put it into the cache)
/******/var o=t[i]={/******/i:i,/******/l:!1,/******/exports:{}};/******//******/// Return the exports of the module
/******/return(/******//******/// Execute the module function
/******/e[i].call(o.exports,o,o.exports,n),/******//******/// Flag the module as loaded
...
e.className=i.substring(1,i.length-1))},t.remove=a,t.classList=l,t.visibilityChangeFlow=function(){var e=void 0,t=void 0;function n(){o.PageHidden?setTimeout(function(){Object.keys(o.Store).forEach(function(e){o.Store.hasOwnProperty(e)&&o.Store[e].options.visibilityControl&&o.Store[e].stop()})},100):setTimeout(function(){Object.keys(o.Store).forEach(function(e){o.Store.hasOwnProperty(e)&&o.Store[e].options.visibilityControl&&o.Store[e].resume()}),o.queueRenderAll()},100)}void 0!==document.hidden?(// Opera 12.10 and Firefox 18 and later support
e="hidden",t="visibilitychange"):void 0!==document.msHidden?(e="msHidden",t="msvisibilitychange"):void 0!==document.webkitHidden&&(e="webkitHidden",t="webkitvisibilitychange"),t&&r(document,t,function(){o.PageHidden=document[e],n()}),r(window,"blur",function(){o.PageHidden=!0,n()}),r(window,"focus",function(){o.PageHidden=!1,n()})},t.createAudioElements=function(e){if(e.hasSound){var t=document.createElement("audio");e.options.sounds.sources.forEach(function(e){var n=document.createElement("source");n.src=e,n.type="audio/"+e.match(/\.([^.]+)$/)[1],t.appendChild(n)}),e.barDom?e.barDom.appendChild(t):document.querySelector("body").appendChild(t),t.volume=e.options.sounds.volume,e.soundPlayed||(t.play(),e.soundPlayed=!0),t.onended=function(){a(t)}}};var o=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}(n(1));function r(e,t,n){var i=arguments.length>3&&void 0!==arguments[3]&&arguments[3];t=t.split(" ");for(var o=0;o<t.length;o++)document.addEventListener?e.addEventListener(t[o],n,i):document.attachEvent&&e.attachEvent("on"+t[o],n)}function s(e,t){return("string"==typeof e?e:l(e)).indexOf(" "+t+" ")>=0}function a(e){e.parentNode&&e.parentNode.removeChild(e)}function l(e){return(" "+(e&&e.className||"")+" ").replace(/\s+/gi," ")}t.animationEndEvents="webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",t.deepExtend=function e(t){t=t||{};for(var n=1;n<arguments.length;n++){var o=arguments[n];if(o)for(var r in o)o.hasOwnProperty(r)&&(Array.isArray(o[r])?t[r]=o[r]:"object"===i(o[r])&&null!==o[r]?t[r]=e(t[r],o[r]):t[r]=o[r])}return t},t.css=function(){var e=["Webkit","O","Moz","ms"],t={};function n(n,i,o){var r;i=t[r=(r=i).replace(/^-ms-/,"ms-").replace(/-([\da-z])/gi,function(e,t){return t.toUpperCase()})]||(t[r]=function(t){var n=document.body.style;if(t in n)return t;for(var i=e.length,o=t.charAt(0).toUpperCase()+t.slice(1),r=void 0;i--;)if((r=e[i]+o)in n)return r;return t}(r)),n.style[i]=o}return function(e,t){var i=arguments,o=void 0,r=void 0;if(2===i.length)for(o in t)t.hasOwnProperty(o)&&void 0!==(r=t[o])&&t.hasOwnProperty(o)&&n(e,o,r);else n(e,i[1],i[2])}}();/***/},/* 1 *//***/function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0}),t.Defaults=t.Store=t.Queues=t.DefaultMaxVisible=t.docTitle=t.DocModalCount=t.PageHidden=void 0,t.getQueueCounts=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"global",t=0,n=a;return l.hasOwnProperty(e)&&(n=l[e].maxVisible,Object.keys(c).forEach(function(n){c[n].options.queue===e&&!c[n].closed&&t++})),{current:t,maxVisible:n}},t.addToQueue=/**
 * @param {Noty} ref
 * @return {void}
 ...
 * @param {Noty} ref
 * @return {void}
 */function(e){var n,r;e.options.modal&&(0===o&&(n=document.querySelector("body"),r=document.createElement("div"),i.addClass(r,"noty_modal"),n.insertBefore(r,n.firstChild),i.addClass(r,"noty_modal_open"),i.addListener(r,i.animationEndEvents,function(){i.removeClass(r,"noty_modal_open")})),t.DocModalCount=o+=1)},t.handleModalClose=/**
 * @param {Noty} ref
 * @return {void}
 */function(e){if(e.options.modal&&o>0&&(t.DocModalCount=o-=1,o<=0)){var n=document.querySelector(".noty_modal");n&&(i.removeClass(n,"noty_modal_open"),i.addClass(n,"noty_modal_close"),i.addListener(n,i.animationEndEvents,function(){i.remove(n)}))}},t.queueClose=F,t.dequeueClose=d,t.fire=h,t.openFlow=/**
 * @param {Noty} ref
 * @return {void}
 */function(e){h(e,"afterShow"),F(e),i.addListener(e.barDom,"mouseenter",function(){d(e)}),i.addListener(e.barDom,"mouseleave",function(){F(e)})},t.closeFlow=/**
 * @param {Noty} ref
 * @return {void}
 */function(e){delete c[e.id],e.closing=!1,h(e,"afterClose"),i.remove(e.barDom),0!==e.layoutDom.querySelectorAll(".noty_bar").length||e.options.container||i.remove(e.layoutDom),(i.inArray("docVisible",e.options.titleCount.conditions)||i.inArray("docHidden",e.options.titleCount.conditions))&&s.decrement(),u(e.options.queue)};var i=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}(n(0));t.PageHidden=!1;var o=t.DocModalCount=0,r={originalTitle:null,count:0,changed:!1},s=t.docTitle={increment:function(){r.count++,s._update()},decrement:function(){if(r.count--,r.count<=0){s._clear();return}s._update()},_update:function(){var e=document.title;r.changed?document.title="("+r.count+") "+r.originalTitle:(r.originalTitle=e,document.title="("+r.count+") "+e,r.changed=!0)},_clear:function(){r.changed&&(r.count=0,document.title=r.originalTitle,r.changed=!1)}},a=t.DefaultMaxVisible=5,l=t.Queues={global:{maxVisible:a,queue:[]}},c=t.Store={};/**
...
var e=setTimeout;return function(){return e(m,1)}}var v=Array(1e3);function m(){for(var e=0;e<c;e+=2)(0,v[e])(v[e+1]),v[e]=void 0,v[e+1]=void 0;c=0}var b=void 0;function y(e,t){var n,i=arguments,o=this,r=new this.constructor(w);void 0===r[C]&&D(r);var s=o._state;return s?(n=i[s-1],F(function(){return Z(s,r,n,o._result)})):V(o,r,e,t),r}/**
  ...
  `value`
*/function E(e){if(e&&"object"==typeof e&&e.constructor===this)return e;var t=new this(w);return S(t,e),t}p?b=function(){return t.nextTick(m)}:f?(o=0,r=new f(m),s=document.createTextNode(""),r.observe(s,{characterData:!0}),b=function(){s.data=o=++o%2}):A?((a=new MessageChannel).port1.onmessage=m,b=function(){return a.port2.postMessage(0)}):b=void 0===d?function(){try{var e=n(9);return u=e.runOnLoop||e.runOnContext,void 0!==u?function(){u(m)}:g()}catch(e){return g()}}():g();var C=Math.random().toString(36).substring(16);function w(){}var I=void 0,x=new T;function k(e){try{return e.then}catch(e){return x.error=e,x}}function Q(t,n,i){n.constructor===t.constructor&&i===y&&n.constructor.resolve===E?1===n._state?U(t,n._result):2===n._state?R(t,n._result):V(n,void 0,function(e){return S(t,e)},function(e){return R(t,e)}):i===x?(R(t,x.error),x.error=null):void 0===i?U(t,n):e(i)?F(function(e){var t=!1,o=function(e,t,n,i){try{e.call(t,n,i)}catch(e){return e}}(i,n,function(i){t||(t=!0,n!==i?S(e,i):U(e,i))},function(n){t||(t=!0,R(e,n))},"Settle: "+(e._label||" unknown promise"));!t&&o&&(t=!0,R(e,o))},t):U(t,n)}function S(e,t){if(e===t)R(e,TypeError("You cannot resolve a promise with itself"));else{var n;(n=typeof t,null!==t&&("object"===n||"function"===n))?Q(e,t,k(t)):U(e,t)}}function q(e){e._onerror&&e._onerror(e._result),K(e)}function U(e,t){e._state===I&&(e._result=t,e._state=1,0!==e._subscribers.length&&F(K,e))}function R(e,t){e._state===I&&(e._state=2,e._result=t,F(q,e))}function V(e,t,n,i){var o=e._subscribers,r=o.length;e._onerror=null,o[r]=t,o[r+1]=n,o[r+2]=i,0===r&&e._state&&F(K,e)}function K(e){var t=e._subscribers,n=e._state;if(0!==t.length){for(var i=void 0,o=void 0,r=e._result,s=0;s<t.length;s+=3)i=t[s],o=t[s+n],i?Z(n,i,o,r):o(r);e._subscribers.length=0}}function T(){this.error=null}var z=new T;function Z(t,n,i,o){var r=e(i),s=void 0,a=void 0,l=void 0,c=void 0;if(r){if((s=function(e,t){try{return e(t)}catch(e){return z.error=e,z}}(i,o))===z?(c=!0,a=s.error,s.error=null):l=!0,n===s){R(n,TypeError("A promises callback cannot return that same promise."));return}}else s=o,l=!0;n._state!==I||(r&&l?S(n,s):c?R(n,a):1===t?U(n,s):2===t&&R(n,s))}var L=0;function D(e){e[C]=L++,e._state=void 0,e._result=void 0,e._subscribers=[]}function P(e,t){this._instanceConstructor=e,this.promise=new e(w),this.promise[C]||D(this.promise),l(t)?(this.length=t.length,this._remaining=t.length,this._result=Array(this.length),0===this.length?U(this.promise,this._result):(this.length=this.length||0,this._enumerate(t),0===this._remaining&&U(this.promise,this._result))):R(this.promise,Error("Array Methods must be provided an Array"))}/**
  ...
  Useful for tooling.
  @constructor
*/function W(e){this[C]=L++,this._result=this._state=void 0,this._subscribers=[],w!==e&&("function"!=typeof e&&function(){throw TypeError("You must pass a resolver function as the first argument to the promise constructor")}(),this instanceof W?function(e,t){try{t(function(t){S(e,t)},function(t){R(e,t)})}catch(t){R(e,t)}}(this,e):function(){throw TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.")}())}return P.prototype._enumerate=function(e){for(var t=0;this._state===I&&t<e.length;t++)this._eachEntry(e[t],t)},P.prototype._eachEntry=function(e,t){var n=this._instanceConstructor,i=n.resolve;if(i===E){var o=k(e);if(o===y&&e._state!==I)this._settledAt(e._state,t,e._result);else if("function"!=typeof o)this._remaining--,this._result[t]=e;else if(n===W){var r=new n(w);Q(r,e,o),this._willSettleAt(r,t)}else this._willSettleAt(new n(function(t){return t(e)}),t)}else this._willSettleAt(i(e),t)},P.prototype._settledAt=function(e,t,n){var i=this.promise;i._state===I&&(this._remaining--,2===e?R(i,n):this._result[t]=n),0===this._remaining&&U(i,this._result)},P.prototype._willSettleAt=function(e,t){var n=this;V(e,void 0,function(e){return n._settledAt(1,t,e)},function(e){return n._settledAt(2,t,e)})},W.all=/**
  ...
  @static
*/function(e){return new P(this,e).promise},W.race=/**
  ...
  promise to settle.
*/function(e){/*jshint validthis:true */var t=this;return new t(l(e)?function(n,i){for(var o=e.length,r=0;r<o;r++)t.resolve(e[r]).then(n,i)}:function(e,t){return t(TypeError("You must pass an array to race."))})},W.resolve=E,W.reject=/**
...
*/function(e){var t=new this(w);return R(t,e),t},W._setScheduler=function(e){B=e},W._setAsap=function(e){F=e},W._asap=F,W.prototype={constructor:W,/**
...
W.polyfill=/*global self*/function(){var e=void 0;if(void 0!==i)e=i;else if("undefined"!=typeof self)e=self;else try{e=Function("return this")()}catch(e){throw Error("polyfill failed because global object is unavailable in this environment")}var t=e.Promise;if(t){var n=null;try{n=Object.prototype.toString.call(t.resolve())}catch(e){// silently ignored
}if("[object Promise]"===n&&!t.cast)return}e.Promise=W},W.Promise=W,W}();//# sourceMappingURL=es6-promise.map
/* WEBPACK VAR INJECTION */}).call(t,n(7),n(8));/***/},/* 5 *//***/function(e,t){// removed by extract-text-webpack-plugin
/***/},/* 6 *//***/function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var i,o=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();/* global VERSION */n(5);var r=(i=n(4))&&i.__esModule?i:{default:i},s=u(n(0)),a=u(n(1)),l=n(2),c=n(3);function u(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}var B=function(){/**
   * @param {object} options
   * @return {Noty}
...
var n,i,o,r=e.exports={};function s(){throw Error("setTimeout has not been defined")}function a(){throw Error("clearTimeout has not been defined")}function l(e){if(n===setTimeout)return setTimeout(e,0);// if setTimeout wasn't available but was latter defined
...
return n.call(this,e,0)}}}!function(){try{n="function"==typeof setTimeout?setTimeout:s}catch(e){n=s}try{i="function"==typeof clearTimeout?clearTimeout:a}catch(e){i=a}}();var c=[],u=!1,B=-1;function F(){u&&o&&(u=!1,o.length?c=o.concat(c):B=-1,c.length&&d())}function d(){if(!u){var e=l(F);u=!0;for(var t=c.length;t;){for(o=c,c=[];++B<t;)o&&o[B].run();B=-1,t=c.length}o=null,u=!1,function(e){if(i===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
...
var eb={};async function ey(){if("/concert/new"===location.pathname)return function(){let e=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",e),{id:-1,title:"",when:e,poster:/*@__PURE__*/i(eb),thumb:""}}();let e=/\/concert\/(\d+)/.exec(location.pathname);if(!e)throw Error("Invalid URL for concert viewer page");let t=+e[1],n=await j();return n.find(e=>e.id==t)}function eE(e=()=>{}){return ey().then(t=>{if(!t){new/*@__PURE__*/(i(em))({text:"Requested concert not found",type:"error",timeout:3e3,layout:"center"}).show(),m("/concerts");return}console.debug("concertViewerPage: Concert:",t),/*@__PURE__*/i(l)(".concertDetails").replaceWith(ew(t)),e()}),/*@__PURE__*/i(l)("<main>",{id:"concertDetailsPage"}).append(/*@__PURE__*/i(l)("<div>",{class:"concertDetails",text:"Loading..."}))}eb=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const eC=e=>/*@__PURE__*/i(l)("<div>",{class:"adminControls"}).append(q({text:"Edit",class:"adminButton",href:`/concert/${e.id}/edit`}),/*@__PURE__*/i(l)("<a>",{text:"Delete",class:"adminButton outlined"}).on("click",()=>ek(e.id))),ew=e=>/*@__PURE__*/i(l)("<div>",{class:"concertDetails"}).append(q({href:"/concerts",class:"backButton"}).append(Q({icon:"arrow_back"}),/*@__PURE__*/i(l)("<span>",{text:"Back to All Concerts"})),C()?eC({id:e.id}):/*@__PURE__*/i(l)(),/*@__PURE__*/i(l)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/i(l)("<img>",{class:"poster",src:e.poster})),/*@__PURE__*/i(l)("<div>").append(/*@__PURE__*/i(l)("<h2>",{text:e.title,class:"title"}),/*@__PURE__*/i(l)("<span>",{text:g(e.when),class:"when"})),eI({items:e.programme}),e.facebook?k(e.facebook):/*@__PURE__*/i(l)(),ex({id:e.id})),eI=e=>{var t;return /*@__PURE__*/i(l)("<div>",{class:"programme"}).toggleClass("empty",!e.items).append(/*@__PURE__*/i(l)("<h3>",{text:"Programme"}),/*@__PURE__*/i(l)("<ol>",{class:"programmeItems"}).append((null!==(t=e.items)&&void 0!==t?t:[]).map(e=>/*@__PURE__*/i(l)("<li>").append(/*@__PURE__*/i(l)("<strong>",{text:e.composer}).append(/*@__PURE__*/i(l)("<span>",{html:":&nbsp;"})),/*@__PURE__*/i(l)("<span>",{text:e.title}),e.performanceNotes?[/*@__PURE__*/i(l)("<br>"),/*@__PURE__*/i(l)("<em>",{text:e.performanceNotes})]:/*@__PURE__*/i(l)()))))},ex=e=>(j().then(t=>{t.sort((e,t)=>e.when.localeCompare(t.when));let n=new Date(t.find(t=>t.id===e.id).when),o=t.find(e=>new Date(e.when)>n),r=t.reverse().find(e=>new Date(e.when)<n);/*@__PURE__*/i(l)(".prevNextConcerts").append(r?q({href:`/concert/${r.id}`}).append(Q({icon:"arrow_back"}),/*@__PURE__*/i(l)("<span>",{text:"Previous Concert"})):[],o?q({href:`/concert/${o.id}`}).addClass("nextConcert").append(/*@__PURE__*/i(l)("<span>",{text:"Next Concert"}),Q({icon:"arrow_forward"})):[])}),/*@__PURE__*/i(l)("<div>",{class:"prevNextConcerts"}));async function ek(e){if(confirm("Are you sure you want to delete this concert?")){let t=new/*@__PURE__*/(i(em))({text:"Processing request...",type:"info",layout:"center"});t.show();let n=await G(e);t.close(),n&&(console.debug("adminControls: reloading concerts cache"),await j(!1)),new/*@__PURE__*/(i(em))({text:n?"Concert deleted successfully":"Failed to delete concert",type:n?"success":"error",timeout:3e3,layout:"center"}).show(),m("/concerts")}}const eQ={success:!0,url:"https://wales-armenia.87.org.uk/share/homePage/splash01A.jpg"};async function eS(e){let t;console.debug(`uploadFile(${e.name})`);let n=new/*@__PURE__*/(i(em))({text:"Uploading, please wait...",type:"info",layout:"center"});if(n.show(),A())await new Promise(e=>setTimeout(e,1e3)),t=eQ;else{let n=new FormData;n.append("file",e),t=await fetch("/php/upload.php",{method:"POST",body:n}).then(e=>e.json())}if(n.close(),!t.success){new/*@__PURE__*/(i(em))({text:"Failed to upload file: "+t.error,type:"error",layout:"center",timeout:3e3}).show();return}return new/*@__PURE__*/(i(em))({text:"File uploaded successfully",type:"success",layout:"center",timeout:3e3}).show(),t.url}function eq(){console.debug("concertEditorPage()"),setTimeout(()=>void(console.debug("requireAdminMode()"),C()||w()));// Start with the viewer page and modify it to the things we want.
let e=eE(async()=>{var t;let n=await ey();if(!n)throw Error("Concert not found");console.debug(`concertEditorPage: ConcertID: ${n.id}`),e.append(/*@__PURE__*/i(l)("<input>",{type:"hidden",class:"idInput",value:n.id})),e.addClass("concertEditorPage"),e.find(".backButton").remove(),e.find(".adminControls").replaceWith(eR({id:n.id})),e.find(".posterWrap").append(eV()),e.find(".title").replaceWith(eU({val:n.title})),e.find(".when").replaceWith(eK(n.when)),e.find(".fbLink").remove(),e.find(".programme").removeClass("empty"),e.find(".programmeItems").replaceWith(eT({items:null!==(t=n.programme)&&void 0!==t?t:[]})),e.find(".programme").after(eZ({val:n.facebook})),e.find(".concertDetails").append(eR({id:n.id}))});return e}const eU=e=>{function t(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let n=/*@__PURE__*/i(l)("<div>",{class:"title"}).append(/*@__PURE__*/i(l)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/i(l)("<h2>",{contenteditable:!0,text:e.val,class:"titleH"})//
.on("input",e=>{let n=/*@__PURE__*/i(l)(e.target),o=n.html().replace(/&nbsp;/g,"\xa0"),r=n.text();o!=r&&(console.debug(`titleInput: mismatching html detected: '${o}' != '${r}'`),n.html(n.text())),t(n)}).on("blur",e=>{// Get rid of the non-breaking spaces - sometimes they may be
// inserted by mobile browsers if you press space twice.
console.debug("titleInput: onblur()");let t=/*@__PURE__*/i(l)(e.target);t.html(t.text().replace(/\u00a0/g," "))}));return(// initialize state.
t(n.find(".titleH")),n)},eR=e=>/*@__PURE__*/i(l)("<div>",{class:"adminControls"}).append(q({text:"Save",class:"adminButton",href:""}).on("click",e=>{(function(){console.log("fileControls: Save clicked");let e=/** @returns current gui values to send to server for saving */function(){let e=+/*@__PURE__*/i(l)(".idInput").val(),t=/*@__PURE__*/i(l)(".titleH").text(),n=/*@__PURE__*/i(l)(".when").val(),o=/*@__PURE__*/i(l)("#fbInput").val(),r=/*@__PURE__*/i(l)(".poster")[0].src,s=v(r,160,120),a=eD(),c={id:e,title:t,when:n,poster:r,thumb:s,programme:a};return o&&(c.facebook=o),c}(),t=new/*@__PURE__*/(i(em))({text:"Saving...",type:"info",layout:"center"});t.show(),(function(e){console.debug(`saveConcert(${JSON.stringify(e)})`);let t=N(y(b({},e),{// Set the operation explicitly.
    op:-1==e.id?"insert":"update"}));return new Promise(A()?(e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)}:(n,i)=>{fetch(O,{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),// Get the inserted ID if it was an insert, otherwise just
    // return the same ID to simplify app logic.
    n(-1==e.id?t.id:e.id)})// Reject so we can show an error message to the user.
    .catch(i)})})(e).then(async e=>{console.debug(`fileControls: Save complete : ${e}`),t.close(),console.debug("fileControls: reloading concerts cache"),await j(!1),new/*@__PURE__*/(i(em))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),m(`/concert/${e}`)}).catch(e=>{console.error("Failed to save",e),new/*@__PURE__*/(i(em))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),t.close()})})(),e.stopPropagation()}),q({text:"Cancel",class:"adminButton outlined",href:-1==e.id?"/concerts":`/concert/${e.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),eV=()=>/*@__PURE__*/i(l)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/i(l)("<label>",{for:"posterInput"}).on("drop",e=>{var t,n,i,o;console.log("posterControls: Poster drop event"),e.preventDefault();let r=null!==(o=null===(i=e.originalEvent)||void 0===i?void 0:null===(n=i.dataTransfer)||void 0===n?void 0:null===(t=n.files)||void 0===t?void 0:t.item(0))&&void 0!==o?o:void 0;eL(r)}).on("dragover",e=>e.preventDefault()).append(/*@__PURE__*/i(l)("<span>",{text:"Click or Drop File"})),/*@__PURE__*/i(l)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("posterControls: File input changed");let n=null===(t=e.target.files)||void 0===t?void 0:t[0];eL(n)})),eK=e=>/*@__PURE__*/i(l)("<input>",{type:"datetime-local",value:e,class:"when"}),eT=e=>/*@__PURE__*/i(l)("<ol>",{class:"programmeItems"}).append(e.items.map((t,n)=>ez({item:t,index:n,total:e.items.length})),ez({item:{composer:"",title:""},index:e.items.length,total:e.items.length})),ez=e=>/*@__PURE__*/i(l)("<li>").append(/*@__PURE__*/i(l)("<div>",{class:"actions"}).append(S({icon:"remove"}).on("click",eP({index:e.index,op:"remove"})).prop("disabled",e.index==e.total),S({icon:"move_up"}).on("click",eP({index:e.index,op:"up"})).prop("disabled",e.index<1||e.index==e.total),S({icon:"move_down"}).on("click",eP({index:e.index,op:"down"})).prop("disabled",e.index>=e.total-1)),/*@__PURE__*/i(l)("<div>",{class:"inputs"}).append(/*@__PURE__*/i(l)("<input>",{placeholder:"Composer",value:e.item.composer})//
    .on("blur",eP({index:e.index,op:"blur"})),/*@__PURE__*/i(l)("<input>",{placeholder:"Title",value:e.item.title})//
    .on("blur",eP({index:e.index,op:"blur"})),/*@__PURE__*/i(l)("<input>",{placeholder:"Performance Notes (optional)",value:e.item.performanceNotes})//
    .on("blur",eP({index:e.index,op:"blur"})))),eZ=e=>/*@__PURE__*/i(l)("<div>",{class:"fbLink"}).append(x(),/*@__PURE__*/i(l)("<input>",{id:"fbInput",type:"text",value:e.val,placeholder:"Event Link (optional)"}));function eL(e){console.debug(`onFileChanged(file=${e})`),e&&eS(e).then(e=>{e&&(console.log("posterControls: File uploaded: ",e),/*@__PURE__*/i(l)(".poster").attr("src",e));// Noty displayed already
})}/**
 * @returns undefined if empty list, array always has at least
 * 1 item. may contain incomplete fields.
 */function eD(){let e=/*@__PURE__*/i(l)(".programmeItems li").toArray().map(e=>{let t=/*@__PURE__*/i(l)(e).find("input"),n={composer:t[0].value,title:t[1].value};if(t[2].value&&(n.performanceNotes=t[2].value),Object.values(n).some(e=>e))return n}).filter(e=>!!e);return e.length?e:void 0}/**
 * helper function for modifications to programme items rows
 * higher order function to simplify binding to event handlers.
 */function eP(e){return()=>{console.debug(`modifyProgramme(${JSON.stringify(e)})`);let t=eD();if(t){if("remove"==e.op)t.splice(e.index,1);else if("up"==e.op){let n=t[e.index];t[e.index]=t[e.index-1],t[e.index-1]=n}else if("down"==e.op){let n=t[e.index];t[e.index]=t[e.index+1],t[e.index+1]=n}else if("blur"==e.op){let n=/*@__PURE__*/i(l)(".programmeItems li").length;if(console.debug(`modifyProgramme: index: ${e.index}, # of items: ${t.length}, # of <li>: ${n}`),e.index!=n-1||n!=t.length)return;console.debug("modifyProgramme: adding new empty item to bottom"),// This timeout is for the tabindex to change to the next element 
// after the blur event, if it is going to be set to anything!
setTimeout(()=>{let n;let o=document.activeElement;o instanceof HTMLElement&&(n=-1==(n=/*@__PURE__*/i(l)(o).parent().find("input").index(o))?void 0:n),/*@__PURE__*/i(l)(".programmeItems").replaceWith(eT({items:t})),void 0!=n&&/*@__PURE__*/i(l)(".programmeItems li").eq(e.index).find("input").eq(n).trigger("focus")},0);return}/*@__PURE__*/i(l)(".programmeItems").replaceWith(eT({items:t}))}}}const eW=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eH=e=>/*@__PURE__*/i(l)("<div>",{class:"catalogueList"}).append(/*@__PURE__*/i(l)("<ul>").append(...e.composers.map(e=>/*@__PURE__*/i(l)("<li>",{text:e.name}).append(/*@__PURE__*/i(l)("<ul>").append(...e.works.map(e=>/*@__PURE__*/i(l)("<li>",{text:e.title}).append(/*@__PURE__*/i(l)("<ul>").append(...e.performances.map(e=>{var t;return /*@__PURE__*/i(l)("<li>").append(q({href:`/concert/${e.concert.id}`,text:`${e.concert.title} - ${(t=e.concert.when,Intl.DateTimeFormat("en-GB",{year:"numeric"}).format(new Date(t)))}`}),e.notes?[/*@__PURE__*/i(l)("<span>",{html:"&nbsp;"}),/*@__PURE__*/i(l)("<em>",{text:e.notes})]:[])})))))))));/*@__PURE__*/i(l)(()=>void(ej(),E(),window.addEventListener("popstate",ej),window.addEventListener("unload",()=>{// If we leave the page, clear the session storage
    // Ie .if we manually refresh the page, reload the db.
    sessionStorage.clear()})));const eM={"/admin":eG(()=>/*@__PURE__*/i(l)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/i(l)("<h2>",{text:"Admin Section"}),/*@__PURE__*/i(l)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/i(l)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/i(l)(),/*@__PURE__*/i(l)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/i(l)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/i(l)("<input>",{type:"hidden",name:"redirectTo",value:ev()}),/*@__PURE__*/i(l)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),A()?/*@__PURE__*/i(l)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=ev()}):/*@__PURE__*/i(l)())),{navAndFooter:!1}),"/catalogue":eG(function(){return X().then(e=>{console.debug("cataloguePage(): displaying results:",e),/*@__PURE__*/i(l)("#cataloguePage .catalogueList").replaceWith(eH(e))}),eW.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/i(l)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/i(l)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/i(l)("<h1>",{text:"Catalogue"}),q({href:"/concerts",text:"View Concerts"})),eH({composers:[]}))}),"/concerts":eG(()=>(j().then(e=>{/*@__PURE__*/i(l)(".concertsGrid").replaceWith(Y(e))}),/*@__PURE__*/i(l)("<div>",{id:"archivePage"}).append(/*@__PURE__*/i(l)("<main>").append(/*@__PURE__*/i(l)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/i(l)("<h1>",{text:"Concerts"}),q({href:"/catalogue",text:"View Catalogue"})),C()?J():/*@__PURE__*/i(l)(),Y([]))))),"/concert/new":eG(eq),"/concert/:id":eG(eE),"/concert/:id/edit":eG(eq)};function ej(){// find handler
for(let[e,t]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/i(l)("body>:not(.noty_layout)").remove(),Object.entries(eM))){let n=RegExp("^"+e.replace(/:\w+/,"\\w+")+"$");if(n.test(location.pathname)){console.debug(`renderRoute: Found match: '${e}' for '${location.pathname}'`),t();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=U(),$().prependTo(".t1"),I().appendTo(document.body),/*@__PURE__*/i(l)(":contains('Go To Concerts Archive')").filter(".primary").replaceWith(q({href:"/concerts",text:"Go To Concerts Archive"}).addClass("primary")),/*@__PURE__*/i(l)(".gallery").replaceWith(D()),eO().then(e=>{console.debug("showHome: upcomingConcert:",e),/*@__PURE__*/i(l)(".upcoming").replaceWith(e?R({concert:e}):V())}),W(),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new eg,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function eO(){return(await j()).sort((e,t)=>e.when.localeCompare(t.when)).find(e=>new Date(e.when)>new Date)}function eG(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&$().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&I().appendTo(document.body)}}