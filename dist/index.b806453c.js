...
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+V+"))|)"+k+"*\\]",M=":("+V+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+L+")*)|.*)\\)|)",P=RegExp(k+"+","g"),z=RegExp("^"+k+"*,"+k+"*"),K=RegExp("^"+k+"*([>+~]|"+k+")"+k+"*"),Z=RegExp(k+"|>"),D=new RegExp(M),W=RegExp("^"+V+"$"),N={ID:RegExp("^#("+V+")"),CLASS:RegExp("^\\.("+V+")"),TAG:RegExp("^("+V+"|[*])"),ATTR:RegExp("^"+L),PSEUDO:RegExp("^"+M),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+k+"*(even|odd|(([+-]|)(\\d*)n|)"+k+"*(?:([+-]|)"+k+"*(\\d+)|))"+k+"*\\)|)","i"),bool:RegExp("^(?:"+U+")$","i"),// For use in libraries implementing .is()
// We use this for POS matching in `select`
needsContext:RegExp("^"+k+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+k+"*((?:-\\d)?\\d*)"+k+"*\\)|)(?=[^-]|$)","i")},O=/^(?:input|select|textarea|button)$/i,H=/^h\d$/i,j=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,G=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
...
header:function(e){return H.test(e.nodeName)},input:function(e){return O.test(e.nodeName)},button:function(e){return w(e,"input")&&"button"===e.type||w(e,"button")},text:function(e){var t;return w(e,"input")&&"text"===e.type&&// Support: IE <10 only
...
var P,// Prioritize #id over <tag> to avoid XSS via location.hash (trac-9521)
...
n=n||P,"string"==typeof e){// Match html or make sure no context is specified for #id
...
P=E(A);var K=/^(?:parents|prev(?:Until|All))/,Z={children:!0,contents:!0,next:!0,prev:!0};function D(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}E.fn.extend({has:function(e){var t=E(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(E.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,r=this.length,o=[],s="string"!=typeof e&&E(e);// Positional selectors never match, since there's no _selection_ context
...
("object"==typeof e||"function"==typeof e)&&e.then)?r?u.call(e,s(o,n,N,r),s(o,n,O,r)):(// ...and disregard older resolution values
o++,u.call(e,s(o,n,N,r),s(o,n,O,r),s(o,n,N,n.notifyWith))):(i!==N&&(a=void 0,l=[e]),// Process the value(s)
// Default process is resolve
(r||n.resolveWith)(a,l))}},c=r?u:function(){try{u()}catch(e){E.Deferred.exceptionHook&&E.Deferred.exceptionHook(e,c.error),t+1>=o&&(i!==O&&(a=void 0,l=[e]),n.rejectWith(a,l))}};// Support: Promises/A+ section 2.3.3.3.1
...
if(t<=1&&(H(e,s.done(a(n)).resolve,s.reject,!t),"pending"===s.state()||f(r[n]&&r[n].then)))return s.then();// Multiple arguments are aggregated like Promise.all array elements
for(;n--;)H(r[n],a(n),s.reject);return s.promise()}});// These usually indicate a programmer mistake during development,
...
er.hasData(e)&&(o=er.access(e),s=E.extend({},o),er.set(t,s))}}function eP(e,t,n,i){// Flatten any nested arrays
t=s(t);var r,o,a,l,u,c,B=0,F=e.length,d=F-1,p=t[0],A=f(p);// We can't cloneNode fragments that contain checked, in WebKit
if(A||F>1&&"string"==typeof p&&!h.checkClone&&eq.test(p))return e.each(function(r){var o=e.eq(r);A&&(t[0]=p.call(this,r,o.html())),eP(o,t,n,i)});if(F&&(o=(r=ew(t,e[0].ownerDocument,!1,e,i)).firstChild,1===r.childNodes.length&&(r=o),o||i)){// Use the original fragment for the last item
...
m(u.textContent.replace(eR,""),u,c))}return e}function ez(e,t,n){for(var i,r=t?E.filter(t,e):e,o=0;null!=(i=r[o]);o++)n||1!==i.nodeType||E.cleanData(eb(i)),i.parentNode&&(n&&eF(i)&&eE(eb(i,"script")),i.parentNode.removeChild(i));return e}E.extend({htmlPrefilter:function(e){return e},clone:function(e,t,n){var i,r,o,s,a=e.cloneNode(!0),l=eF(e);// Fix IE cloning issues
...
(n[er.expando]=void 0)}}}),E.fn.extend({detach:function(e){return ez(this,e,!0)},remove:function(e){return ez(this,e)},text:function(e){return J(this,function(e){return void 0===e?E.text(this):this.empty().each(function(){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&(this.textContent=e)})},null,e,arguments.length)},append:function(){return eP(this,arguments,function(e){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&eU(this,e).appendChild(e)})},prepend:function(){return eP(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=eU(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return eP(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return eP(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;null!=(e=this[t]);t++)1===e.nodeType&&(// Prevent memory leaks
...
return eP(this,arguments,function(t){var n=this.parentNode;0>E.inArray(this,e)&&(E.cleanData(eb(this)),n&&n.replaceChild(t,this));// Force callback invocation
...
for(r in i=n.call(e),t)e.style[r]=o[r];return i},eN=RegExp(ec.join("|"),"i");function eO(e,t,n){var i,r,o,s,a=eZ.test(t),// Retrieving style before computed somehow
...
s+"":s}function eH(e,t){// Define the hook, we'll check on the first run if it's really needed.
...
var i=eD(e),r=(!h.boxSizingReliable()||n)&&"border-box"===E.css(e,"boxSizing",!1,i),o=r,s=eO(e,t,i),a="offset"+t[0].toUpperCase()+t.slice(1);// Support: Firefox <=54
...
A.head.appendChild(t[0])},abort:function(){n&&n()}}}});var tP=[],tz=/(=)\?(?=&|$)|\?\?/;// Default jsonp settings
E.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=tP.pop()||E.expando+"_"+tf.guid++;return this[e]=!0,e}}),// Detect, normalize options and install callbacks for jsonp requests
...
tP.push(r)),s&&f(o)&&o(s[0]),s=o=void 0}),"script")}),// Support: Safari 8 only
...
E.each(["top","left"],function(e,t){E.cssHooks[t]=eH(h.pixelPosition,function(e,n){if(n)// If curCSS returns percentage, fallback to offset
...
let e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}/**
	 ...
	 */destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}constructor(e,t,n,i,r="div"){/**
		 ...
		 * @type {HTMLElement}
		 */this.$name=document.createElement("div"),this.$name.classList.add("name"),P.nextNameID=P.nextNameID||0,this.$name.id=`lil-gui-name-${++P.nextNameID}`,/**
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class O extends P{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class H extends P{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class j extends P{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const G=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new H(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new O(this,e,t,n,i,r);case"boolean":return new z(this,e,t);case"string":return new j(this,e,t);case"function":return new N(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
...
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!X&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(G),X=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=o}}const Y=()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:_()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    ...
    localStorage.setItem("admin","true")}),A()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=_()}):/*@__PURE__*/e(a)()));function _(){return sessionStorage.getItem("adminLoginRedirectTo")||"/"}var $={};$=/******/function(e){/******/// The module cache
...
e.exports=n;/***/},/* 9 *//***/function(e,t){/* (ignored) *//***/}]);var ee={};function et(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e(ee),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1];return C.concerts.find(e=>e.id==n)}ee=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const en=()=>{let t=et();if(!t)throw Error("Concert not found");return /*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(er(t))},ei=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined",href:`/php/concertDelete.php?id=${t.id}`}).on("click",e=>{confirm("Are you sure you want to delete this concert?")||e.preventDefault()})),er=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(E({href:"/archive",text:"\uD83E\uDC84 Back to All Concerts",class:"backButton"}),ei({id:t.id}),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",hour12:!0}).format(new Date(n))),class:"when"})),t.facebook?y(t.facebook):/*@__PURE__*/e(a)())},eo=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
.on("input",t=>n(/*@__PURE__*/e(a)(t.target))));return(// initialize state.
n(i.find(".titleH")),i)},es=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=/*@__PURE__*/e(a)(".titleH").text(),n=/*@__PURE__*/e(a)(".when").val(),i=/*@__PURE__*/e(a)("#fbInput").val(),r=/*@__PURE__*/e(a)(".poster")[0].src,o={id:et().id,title:t,when:n,poster:r,thumb:r};return i&&(o.facebook=i),o}(),n=new/*@__PURE__*/(e($))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){if(console.debug(`saveConcert(${JSON.stringify(e)})`),A())return new Promise((e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(),1e3)});let t=function(e){let t=new FormData;for(let[n,i]of Object.entries(e))t.append(n,i.toString());return t}(e);return fetch("/php/concertEdit.php",{method:"POST",body:t})})(t).then(()=>{n.close(),new/*@__PURE__*/(e($))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show()}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e($))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),E({text:"Cancel",class:"adminButton",href:-1==t.id?"/archive":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),ea=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{text:"Click to Upload",for:"posterInput"}),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("File changed",null===(t=e.target.files)||void 0===t?void 0:t[0])})),el=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),eu=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(v(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));/*@__PURE__*/e(a)(()=>void(eB(),q(),window.addEventListener(b,eB),window.addEventListener("popstate",eB)));const ec={"/archive":function(){U().appendTo(document.body),m().appendTo(document.body)},"/admin":function(){Y().appendTo(document.body)},"/concert/new":eF,"/concert/:id":function(){w().appendTo(document.body),en().appendTo(document.body),m().appendTo(document.body)},"/concert/:id/edit":eF};function eB(){// find handler
