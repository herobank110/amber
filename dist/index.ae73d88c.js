...
e.composers.sort((e,t)=>e.name.localeCompare(t.name)),e.composers.forEach(e=>{e.works.sort((e,t)=>e.title.localeCompare(t.title)),e.works.forEach(e=>{e.performances.sort((e,t)=>e.concert.when.localeCompare(t.concert.when))})}),e)}function D(e){let t=new FormData;for(let[n,i]of Object.entries(e)){if(void 0===i)continue;let e="object"==typeof i?JSON.stringify(i):i.toString();t.append(n,e)}return t}/*@__PURE__*/e(a)("<div>",{id:"archivePage"});const Z=()=>T({text:"Add Concert",class:"adminBigButton",href:"/concert/new"}),W=t=>/*@__PURE__*/e(a)("<div>",{class:"concertsGrid"}).append(t.sort((e,t)=>t.when.localeCompare(e.when)).map(e=>N(e))),N=t=>{var n;return T({href:`/concert/${t.id}`,class:"concertCard"}).append(/*@__PURE__*/e(a)("<div>",{class:"media",css:{backgroundImage:`url('${t.thumb}')`}}),/*@__PURE__*/e(a)("<div>",{class:"info"}).append(/*@__PURE__*/e(a)("<p>",{class:"when",text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric"}).format(new Date(n)))}),/*@__PURE__*/e(a)("<h3>",{class:"title",text:t.title})))},O=()=>/*@__PURE__*/e(a)("<nav>").append(j(),X()),j=()=>/*@__PURE__*/e(a)("<ul>",{class:"desktop"}).append(H({text:"Upcoming",href:"/#upcoming"}),H({text:"Ten Years",href:"/#tenYears"}),H({text:"About Us",href:"/#about"}),G(),H({text:"Concerts",href:"/concerts"}),H({text:"Catalogue",href:"/catalogue"}),H({text:"Contact Us",href:"/#contact"}),/*@__PURE__*/e(a)("<span>")),H=t=>/*@__PURE__*/e(a)("<li>",{class:"navItem"}).append(T({href:t.href,text:t.text})),G=()=>T({href:"/",class:"logo"}),X=()=>/*@__PURE__*/e(a)("<div>",{class:"mobile"}).append(/*@__PURE__*/e(a)("<div>",{class:"hamburger"})//
    .on("click",()=>Y()),G(),J()),J=()=>/*@__PURE__*/e(a)("<div>",{class:"sidebar"}).append(/*@__PURE__*/e(a)("<div>",{class:"inner"}).append(/*@__PURE__*/e(a)("<div>",{class:"close"}).append(/*@__PURE__*/e(a)("<div>",{class:"img"})//
...
n(i.find(".titleH")),i)},eC=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(T({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=g(o,160,120),l=eQ(),c={id:t,title:n,when:i,poster:o,thumb:s,programme:l};return r&&(c.facebook=r),c}(),n=new/*@__PURE__*/(e(eF))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){console.debug(`saveConcert(${JSON.stringify(e)})`);let t=D(y(v({},e),{// Set the operation explicitly.
    ...
    .catch(i)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await P(!1),new/*@__PURE__*/(e(eF))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),m(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(eF))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),T({text:"Cancel",class:"adminButton outlined",href:-1==t.id?"/concerts":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),ew=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{for:"posterInput"}).on("drop",e=>{var t,n,i,r;console.log("posterControls: Poster drop event"),e.preventDefault();let o=null!==(r=null===(i=e.originalEvent)||void 0===i?void 0:null===(n=i.dataTransfer)||void 0===n?void 0:null===(t=n.files)||void 0===t?void 0:t.item(0))&&void 0!==r?r:void 0;eT(o)}).on("dragover",e=>e.preventDefault()).append(/*@__PURE__*/e(a)("<span>",{text:"Click or Drop File"})),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("posterControls: File input changed");let n=null===(t=e.target.files)||void 0===t?void 0:t[0];eT(n)})),eI=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),ex=t=>/*@__PURE__*/e(a)("<ol>",{class:"programmeItems"}).append(t.items.map((e,n)=>eS({item:e,index:n,total:t.items.length})),eS({item:{composer:"",title:""},index:t.items.length,total:t.items.length})),eS=t=>/*@__PURE__*/e(a)("<li>").append(/*@__PURE__*/e(a)("<div>",{class:"actions"}).append(k({icon:"remove"}).on("click",eq({index:t.index,op:"remove"})).prop("disabled",t.index==t.total),k({icon:"move_up"}).on("click",eq({index:t.index,op:"up"})).prop("disabled",t.index<1||t.index==t.total),k({icon:"move_down"}).on("click",eq({index:t.index,op:"down"})).prop("disabled",t.index>=t.total-1)),/*@__PURE__*/e(a)("<div>",{class:"inputs"}).append(/*@__PURE__*/e(a)("<input>",{placeholder:"Composer",value:t.item.composer})//
    .on("blur",eq({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Title",value:t.item.title})//
    .on("blur",eq({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Performance Notes (optional)",value:t.item.performanceNotes})//
    .on("blur",eq({index:t.index,op:"blur"})))),ek=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(I(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));function eT(t){console.debug(`onFileChanged(file=${t})`),t&&ey(t).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
})}/**
 ...
 */function eq(t){return()=>{console.debug(`modifyProgramme(${JSON.stringify(t)})`);let n=eQ();if(n){if("remove"==t.op)n.splice(t.index,1);else if("up"==t.op){let e=n[t.index];n[t.index]=n[t.index-1],n[t.index-1]=e}else if("down"==t.op){let e=n[t.index];n[t.index]=n[t.index+1],n[t.index+1]=e}else if("blur"==t.op){let i=/*@__PURE__*/e(a)(".programmeItems li").length;if(console.debug(`modifyProgramme: index: ${t.index}, # of items: ${n.length}, # of <li>: ${i}`),t.index!=i-1||i!=n.length)return;console.debug("modifyProgramme: adding new empty item to bottom"),// This timeout is for the tabindex to change to the next element 
// after the blur event, if it is going to be set to anything!
setTimeout(()=>{let i;let r=document.activeElement;r instanceof HTMLElement&&(i=-1==(i=/*@__PURE__*/e(a)(r).parent().find("input").index(r))?void 0:i),/*@__PURE__*/e(a)(".programmeItems").replaceWith(ex({items:n})),void 0!=i&&/*@__PURE__*/e(a)(".programmeItems li").eq(t.index).find("input").eq(i).trigger("focus")},0);return}/*@__PURE__*/e(a)(".programmeItems").replaceWith(ex({items:n}))}}}const eR=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eU=t=>/*@__PURE__*/e(a)("<div>",{class:"catalogueList"}).append(/*@__PURE__*/e(a)("<ul>").append(...t.composers.map(t=>/*@__PURE__*/e(a)("<li>",{text:t.name}).append(/*@__PURE__*/e(a)("<ul>").append(...t.works.map(t=>/*@__PURE__*/e(a)("<li>",{text:t.title}).append(/*@__PURE__*/e(a)("<ul>").append(...t.performances.map(t=>{var n;return /*@__PURE__*/e(a)("<li>").append(T({href:`/concert/${t.concert.id}`,text:`${t.concert.title} - ${(n=t.concert.when,Intl.DateTimeFormat("en-GB",{year:"numeric"}).format(new Date(n)))}`}),t.notes?[/*@__PURE__*/e(a)("<span>",{html:"&nbsp;"}),/*@__PURE__*/e(a)("<em>",{text:t.notes})]:[])})))))))));/*@__PURE__*/e(a)(()=>void(eL(),b(),window.addEventListener("popstate",eL),window.addEventListener("unload",()=>{// If we leave the page, clear the session storage
    // Ie .if we manually refresh the page, reload the db.
    sessionStorage.clear()})));const eV={"/admin":eM(()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:eB()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),p()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=eB()}):/*@__PURE__*/e(a)())),{navAndFooter:!1}),"/catalogue":eM(function(){return K().then(t=>{console.debug("cataloguePage(): displaying results:",t),/*@__PURE__*/e(a)("#cataloguePage .catalogueList").replaceWith(eU(t))}),eR.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),T({href:"/concerts",text:"View Concerts"})),eU({composers:[]}))}),"/concerts":eM(()=>(P().then(t=>{/*@__PURE__*/e(a)(".concertsGrid").replaceWith(W(t))}),/*@__PURE__*/e(a)("<div>",{id:"archivePage"}).append(/*@__PURE__*/e(a)("<main>").append(/*@__PURE__*/e(a)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Concerts"}),T({href:"/catalogue",text:"View Catalogue"})),E()?Z():/*@__PURE__*/e(a)(),W([]))))),"/concert/new":eM(eb),"/concert/:id":eM(ef),"/concert/:id/edit":eM(eb)};function eL(){// find handler
for(let[t,n]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/e(a)("body>:not(.noty_layout)").remove(),Object.entries(eV))){let e=RegExp("^"+t.replace(/:\w+/,"\\w+")+"$");if(e.test(location.pathname)){console.debug(`renderRoute: Found match: '${t}' for '${location.pathname}'`),n();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=Q(),O().prependTo(".t1"),w().appendTo(document.body),console.log(/*@__PURE__*/e(a)(":contains('Go To Concerts Archive')").filter(".primary").replaceWith(T({href:"/concerts",text:"Go To Concerts Archive"}).addClass("primary"))),eP().then(t=>{console.debug("showHome: upcomingConcert:",t),/*@__PURE__*/e(a)(".upcoming").replaceWith(t?q({concert:t}):R())}),/** Prepare 10 year video autoplay on scroll in */function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
e.muted=!0,e.controls=!1,new IntersectionObserver(t=>{1!=t.length&&console.warn(`Expected 1 entry, got ${t.length}`),t.forEach(t=>{t.isIntersecting?(e.play(),e.controls=!0):e.pause()})},{threshold:0,rootMargin:"-50% 0% -40%"}).observe(e)}(),U("#logo",{width:["100vmin","100px"]},{timeRange:"exit 0% 50%",fill:"both",easing:"linear"}),U(".logoWrap",{height:["80lvh","100px"]},{timeRange:"exit 10% 100%",fill:"both",easing:"linear"}),U(".upcomingCover",[{visibility:"visible",opacity:1},{visibility:"hidden",opacity:0}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),U("nav",[{visibility:"hidden",opacity:0},{visibility:"visible",opacity:1}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),U(".posters",// { marginTop: ["0%", "-120%"] },
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new eu,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function eP(){return(await P()).sort((e,t)=>e.when.localeCompare(t.when)).find(e=>new Date(e.when)>new Date)}function eM(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&O().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&w().appendTo(document.body)}}