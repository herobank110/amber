...
V="(?:\\\\[\\da-fA-F]{1,6}"+k+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+",P="\\["+k+"*("+V+")(?:"+k+// Operator (capture 2)
"*([*^$|!~]?=)"+k+// "Attribute values must be CSS identifiers [capture 5] or strings [capture 3 or capture 4]"
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+V+"))|)"+k+"*\\]",L=":("+V+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+P+")*)|.*)\\)|)",M=RegExp(k+"+","g"),z=RegExp("^"+k+"*,"+k+"*"),K=RegExp("^"+k+"*([>+~]|"+k+")"+k+"*"),D=RegExp(k+"|>"),Z=new RegExp(L),W=RegExp("^"+V+"$"),N={ID:RegExp("^#("+V+")"),CLASS:RegExp("^\\.("+V+")"),TAG:RegExp("^("+V+"|[*])"),ATTR:RegExp("^"+P),PSEUDO:RegExp("^"+L),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+k+"*(even|odd|(([+-]|)(\\d*)n|)"+k+"*(?:([+-]|)"+k+"*(\\d+)|))"+k+"*\\)|)","i"),bool:RegExp("^(?:"+U+")$","i"),// For use in libraries implementing .is()
...
if(B=e,F=t,1===p&&(D.test(e)||K.test(e))){for(// Expand context for sibling selectors
...
E.merge(this,E.parseHTML(i[1],t&&t.nodeType?t.ownerDocument||t:A,!0)),P.test(i[1])&&E.isPlainObject(t))for(i in t)f(this[i])?this[i](t[i]):this.attr(i,t[i]);return this}return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e);// HANDLE: $(DOMElement)
...
function eV(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function eP(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function eL(e,t){var n,i,r,o,s,a;if(1===t.nodeType){// 1. Copy private data: events, handlers, etc.
...
if(A||F>1&&"string"==typeof p&&!h.checkClone&&eq.test(p))return e.each(function(r){var o=e.eq(r);A&&(t[0]=p.call(this,r,o.html())),eM(o,t,n,i)});if(F&&(o=(r=ew(t,e[0].ownerDocument,!1,e,i)).firstChild,1===r.childNodes.length&&(r=o),o||i)){// Use the original fragment for the last item
...
E.map(a,eP),B=0;B<l;B++)c=a[B],ev.test(c.type||"")&&!ei.access(c,"globalEval")&&E.contains(u,c)&&(c.src&&"module"!==(c.type||"").toLowerCase()?E._evalUrl&&!c.noModule&&E._evalUrl(c.src,{nonce:c.nonce||c.getAttribute("nonce")},u):// needed as in XML documents they're already not visible when
...
if(t){if(n)for(i=0,o=o||eb(e),s=s||eb(a),r=o.length;i<r;i++)eL(o[i],s[i]);else eL(e,a)}// Return the cloned set
...
1223:204},tL=E.ajaxSettings.xhr();h.cors=!!tL&&"withCredentials"in tL,h.ajax=tL=!!tL,E.ajaxTransport(function(t){var n,i;// Cross domain only allowed if supported through XMLHttpRequest
if(h.cors||tL&&!t.crossDomain)return{send:function(r,o){var s,a=t.xhr();// Apply custom fields if provided
...
n=function(e){return function(){n&&(n=i=a.onload=a.onerror=a.onabort=a.ontimeout=a.onreadystatechange=null,"abort"===e?a.abort():"error"===e?"number"!=typeof a.status?o(0,"error"):o(a.status,a.statusText):o(tP[a.status]||a.status,a.statusText,"text"!==// IE9 has no XHR2 but throws on binary (trac-11426)
...
(i=(t=A.implementation.createHTMLDocument("")).createElement("base")).href=A.location.href,t.head.appendChild(i)):t=A),r=P.exec(e),o=!n&&[],r)?[t.createElement(r[1])]:(r=ew([e],t,o),o&&o.length&&E(o).remove(),E.merge([],r.childNodes))},/**
...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class H extends j{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function G(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const X={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},J=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:G,toHexString:G},X,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=X.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return X.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=X.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return X.toHexString(r)}}];class Y extends j{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,J.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=G(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class _ extends j{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class $ extends j{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class ee extends j{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class et extends j{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const en=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new ee(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new $(this,e,t,n,i,r);case"boolean":return new H(this,e,t);case"string":return new et(this,e,t);case"function":return new _(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
	 ...
	 * @returns {Controller}
	 */addColor(e,t,n=1){return new Y(this,e,t,n)}/**
	 ...
	 * @returns {GUI}
	 */addFolder(e){let t=new er({parent:this,title:e});return this.root._closeFolders&&t.close(),t}/**
	 * Recalls values that were saved with `gui.save()`.
	 * @param {object} obj
	 * @param {boolean} recursive Pass false to exclude folders descending from this GUI.
	 * @returns {this}
	 */load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{!(t instanceof _)&&t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}/**
...
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!ei&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(en),ei=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=o}}function eo(){return sessionStorage.getItem("adminLoginRedirectTo")||"/"}var es={};es=/******/function(e){/******/// The module cache
...
*/function(e){var t=new this(w);return R(t,e),t},Z._setScheduler=function(e){B=e},Z._setAsap=function(e){F=e},Z._asap=F,Z.prototype={constructor:Z,/**
...
var ea={};async function el(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e(ea),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1],i=await q();return i.find(e=>e.id==n)}function ec(t=()=>{}){return el().then(n=>{if(!n){new/*@__PURE__*/(e(es))({text:"Requested concert not found",type:"error",timeout:3e3,layout:"center"}).show(),v("/concerts");return}console.debug("concertViewerPage: Concert:",n),/*@__PURE__*/e(a)(".concertDetails").replaceWith(eB(n)),t()}),/*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(/*@__PURE__*/e(a)("<div>",{class:"concertDetails"}))}ea=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const eu=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(k({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined"}).on("click",()=>ed(t.id))),eB=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(k({href:"/concerts",text:"\uD83E\uDC84 Back to All Concerts",class:"backButton"}),E()?eu({id:t.id}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",hour12:!0}).format(new Date(n))),class:"when"})),eF({items:t.programme}),t.facebook?x(t.facebook):/*@__PURE__*/e(a)())},eF=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"programme"}).toggleClass("empty",!t.items).append(/*@__PURE__*/e(a)("<h3>",{text:"Programme"}),/*@__PURE__*/e(a)("<ol>",{class:"programmeItems"}).append((null!==(n=t.items)&&void 0!==n?n:[]).map(t=>/*@__PURE__*/e(a)("<li>").append(/*@__PURE__*/e(a)("<strong>",{text:t.composer}).append(/*@__PURE__*/e(a)("<span>",{html:":&nbsp;"})),/*@__PURE__*/e(a)("<span>",{text:t.title}),t.performanceNotes?[/*@__PURE__*/e(a)("<br>"),/*@__PURE__*/e(a)("<em>",{text:t.performanceNotes})]:/*@__PURE__*/e(a)()))))};async function ed(t){if(confirm("Are you sure you want to delete this concert?")){let n=new/*@__PURE__*/(e(es))({text:"Processing request...",type:"info",layout:"center"});n.show();let i=await U(t);n.close(),i&&(console.debug("adminControls: reloading concerts cache"),await q(!1)),new/*@__PURE__*/(e(es))({text:i?"Concert deleted successfully":"Failed to delete concert",type:i?"success":"error",timeout:3e3,layout:"center"}).show(),v("/concerts")}}const eh={success:!0,url:"https://wales-armenia.87.org.uk/share/homePage/splash01A.jpg"};async function ef(t){let n;console.debug(`uploadFile(${t.name})`);let i=new/*@__PURE__*/(e(es))({text:"Uploading, please wait...",type:"info",layout:"center"});if(i.show(),m())await new Promise(e=>setTimeout(e,1e3)),n=eh;else{let e=new FormData;e.append("file",t),n=await fetch("/php/upload.php",{method:"POST",body:e}).then(e=>e.json())}if(i.close(),!n.success){new/*@__PURE__*/(e(es))({text:"Failed to upload file: "+n.error,type:"error",layout:"center",timeout:3e3}).show();return}return new/*@__PURE__*/(e(es))({text:"File uploaded successfully",type:"success",layout:"center",timeout:3e3}).show(),n.url}function ep(){console.debug("concertEditorPage()"),setTimeout(()=>void(console.debug("requireAdminMode()"),E()||C()));// Start with the viewer page and modify it to the things we want.
let t=ec(async()=>{var n;let i=await el();if(!i)throw Error("Concert not found");console.debug(`concertEditorPage: ConcertID: ${i.id}`),t.append(/*@__PURE__*/e(a)("<input>",{type:"hidden",class:"idInput",value:i.id})),t.addClass("concertEditorPage"),t.find(".backButton").remove(),t.find(".adminControls").replaceWith(eg({id:i.id})),t.find(".posterWrap").append(em()),t.find(".title").replaceWith(eA({val:i.title})),t.find(".when").replaceWith(ev(i.when)),t.find(".fbLink").remove(),t.find(".programme").removeClass("empty"),t.find(".programmeItems").replaceWith(ey({items:null!==(n=i.programme)&&void 0!==n?n:[]})),t.find(".programme").after(eE({val:i.facebook})),t.find(".concertDetails").append(eg({id:i.id}))});return t}const eA=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
...
n(i.find(".titleH")),i)},eg=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(k({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(m())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;// returns a full url string, for easier parsing and validation later.
    return i.set("src",e),i.set("x",t.toString()),i.set("y",n.toString()),"https://roathchamber.org/php/resize.php?"+i.toString()}(o,160,120),l=ew(),c={id:t,title:n,when:i,poster:o,thumb:s,programme:l};return r&&(c.facebook=r),c}(),n=new/*@__PURE__*/(e(es))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){if(console.debug(`saveConcert(${JSON.stringify(e)})`),m())return new Promise((e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)});let t=V(g(A({},e),{// Set the operation explicitly.
    op:-1==e.id?"insert":"update"}));return new Promise((n,i)=>{fetch(R,{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),// Get the inserted ID if it was an insert, otherwise just
    // return the same ID to simplify app logic.
    n(-1==e.id?t.id:e.id)})// Reject so we can show an error message to the user.
    .catch(i)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await q(!1),new/*@__PURE__*/(e(es))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),v(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(es))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),k({text:"Cancel",class:"adminButton outlined",href:-1==t.id?"/concerts":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),em=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{for:"posterInput"}).on("drop",e=>{var t,n,i,r;console.log("posterControls: Poster drop event"),e.preventDefault();let o=null!==(r=null===(i=e.originalEvent)||void 0===i?void 0:null===(n=i.dataTransfer)||void 0===n?void 0:null===(t=n.files)||void 0===t?void 0:t.item(0))&&void 0!==r?r:void 0;eC(o)}).on("dragover",e=>e.preventDefault()).append(/*@__PURE__*/e(a)("<span>",{text:"Click or Drop File"})),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("posterControls: File input changed");let n=null===(t=e.target.files)||void 0===t?void 0:t[0];eC(n)})),ev=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),ey=t=>/*@__PURE__*/e(a)("<ol>",{class:"programmeItems"}).append(t.items.map((e,n)=>eb({item:e,index:n,total:t.items.length})),eb({item:{composer:"",title:""},index:t.items.length,total:t.items.length})),eb=t=>/*@__PURE__*/e(a)("<li>").append(/*@__PURE__*/e(a)("<div>",{class:"actions"}).append(S({icon:"remove"}).on("click",eI({index:t.index,op:"remove"})).prop("disabled",t.index==t.total),S({icon:"move_up"}).on("click",eI({index:t.index,op:"up"})).prop("disabled",t.index<1||t.index==t.total),S({icon:"move_down"}).on("click",eI({index:t.index,op:"down"})).prop("disabled",t.index>=t.total-1)),/*@__PURE__*/e(a)("<div>",{class:"inputs"}).append(/*@__PURE__*/e(a)("<input>",{placeholder:"Composer",value:t.item.composer})//
    .on("blur",eI({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Title",value:t.item.title})//
    .on("blur",eI({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Performance Notes (optional)",value:t.item.performanceNotes})//
    .on("blur",eI({index:t.index,op:"blur"})))),eE=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(I(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));function eC(t){console.debug(`onFileChanged(file=${t})`),t&&ef(t).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
})}/**
 * @returns undefined if empty list, array always has at least
 * 1 item. may contain incomplete fields.
 */function ew(){let t=/*@__PURE__*/e(a)(".programmeItems li").toArray().map(t=>{let n=/*@__PURE__*/e(a)(t).find("input"),i={composer:n[0].value,title:n[1].value};if(n[2].value&&(i.performanceNotes=n[2].value),Object.values(i).some(e=>e))return i}).filter(e=>!!e);return t.length?t:void 0}/**
 * helper function for modifications to programme items rows
 * higher order function to simplify binding to event handlers.
 */function eI(t){return()=>{console.debug(`modifyProgramme(${JSON.stringify(t)})`);let n=ew();if(n){if("remove"==t.op)n.splice(t.index,1);else if("up"==t.op){let e=n[t.index];n[t.index]=n[t.index-1],n[t.index-1]=e}else if("down"==t.op){let e=n[t.index];n[t.index]=n[t.index+1],n[t.index+1]=e}else if("blur"==t.op){let i=/*@__PURE__*/e(a)(".programmeItems li").length;if(console.debug(`modifyProgramme: index: ${t.index}, # of items: ${n.length}, # of <li>: ${i}`),t.index!=i-1||i!=n.length)return;console.debug("modifyProgramme: re-rendering list to add blank row")}/*@__PURE__*/e(a)(".programmeItems").replaceWith(ey({items:n}))}}}const ex=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eS=t=>/*@__PURE__*/e(a)("<div>",{class:"pieceList"}).append(...t.map(t=>/*@__PURE__*/e(a)("<details>",{class:"piece"}).append(/*@__PURE__*/e(a)("<summary>",{text:t.composer+" - "+t.name}),/*@__PURE__*/e(a)("<span>",{html:"Played in:&nbsp;"}),...t.concerts.map(e=>k({href:`/concert/${e.id}`,text:e.title})))));/*@__PURE__*/e(a)(()=>void(eQ(),b(),window.addEventListener("popstate",eQ),window.addEventListener("unload",()=>{// If we leave the page, clear the session storage
    // Ie .if we manually refresh the page, reload the db.
    sessionStorage.clear()})));const ek={"/admin":eT(()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:eo()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),m()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=eo()}):/*@__PURE__*/e(a)())),{navAndFooter:!1}),"/catalogue":eT(function(){return q().then(t=>{/*@__PURE__*/e(a)("#cataloguePage .pieceList").replaceWith(eS(ex))}),ex.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),eS([]))}),"/concerts":eT(()=>(q().then(t=>{/*@__PURE__*/e(a)(".concertsGrid").replaceWith(L(t))}),/*@__PURE__*/e(a)("<div>",{id:"archivePage"}).append(/*@__PURE__*/e(a)("<main>").append(E()?P():/*@__PURE__*/e(a)(),L([]))))),"/concert/new":eT(ep),"/concert/:id":eT(ec),"/concert/:id/edit":eT(ep)};function eQ(){// find handler
for(let[t,n]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/e(a)("body>:not(.noty_layout)").remove(),Object.entries(ek))){let e=RegExp("^"+t.replace(/:\w+/,"\\w+")+"$");if(e.test(location.pathname)){console.debug(`renderRoute: Found match: '${t}' for '${location.pathname}'`),n();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=p(),z().prependTo(".t1"),w().appendTo(document.body),/** Prepare 10 year video autoplay on scroll in */function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
e.muted=!0,e.controls=!1,new IntersectionObserver(t=>{1!=t.length&&console.warn(`Expected 1 entry, got ${t.length}`),t.forEach(t=>{t.isIntersecting?(e.play(),e.controls=!0):e.pause()})},{threshold:0,rootMargin:"-50% 0% -40%"}).observe(e)}(),y("#logo",{width:["100vmin","100px"]},{timeRange:"exit 0% 50%",fill:"both",easing:"linear"}),y(".logoWrap",{height:["80lvh","100px"]},{timeRange:"exit 10% 100%",fill:"both",easing:"linear"}),y(".upcomingCover",[{visibility:"visible",opacity:1},{visibility:"hidden",opacity:0}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),y("nav",[{visibility:"hidden",opacity:0},{visibility:"visible",opacity:1}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),y(".posters",// { marginTop: ["0%", "-120%"] },
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(x("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new er,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}function eT(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&z().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&w().appendTo(document.body)}}