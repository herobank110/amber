...
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(b("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new _,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function em(){C().appendTo(document.body),(await ec()).appendTo(document.body),v().appendTo(document.body)}async function ev(){C().appendTo(document.body),(await er()).appendTo(document.body),v().appendTo(document.body)}