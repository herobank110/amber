...
let V=0;const P=()=>M(-1),L=()=>M(1);function M(e){console.debug(`galleryMove(delta=${e})`);let t=(V+e+U.length)%U.length;z(t)}function z(t){V=t;let n=/*@__PURE__*/e(a)(".gallery");// global!
n.find("img").attr("src",U[t]),n.find(".dot").removeClass("big").eq(t).addClass("big")}const K=()=>{let t=/*@__PURE__*/e(a)("<div>",{class:"gallery"}).append(/*@__PURE__*/e(a)("<div>",{class:"leftRight"}).append(/*@__PURE__*/e(a)("<div>").append(S({icon:"chevron_left"})).on("click",P),/*@__PURE__*/e(a)("<div>").append(S({icon:"chevron_right"})).on("click",L)),/*@__PURE__*/e(a)("<img>"),/*@__PURE__*/e(a)("<div>",{class:"dots"}).append(U.map((t,n)=>/*@__PURE__*/e(a)("<span>",{class:"dot"})//
...
n(i.find(".titleH")),i)},eP=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(T({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=g(o,160,120),l=eW(),c={id:t,title:n,when:i,poster:o,thumb:s,programme:l};return r&&(c.facebook=r),c}(),n=new/*@__PURE__*/(e(ev))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){console.debug(`saveConcert(${JSON.stringify(e)})`);let t=X(y(v({},e),{// Set the operation explicitly.
    ...
    .catch(i)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await O(!1),new/*@__PURE__*/(e(ev))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),m(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(ev))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),T({text:"Cancel",class:"adminButton outlined",href:-1==t.id?"/concerts":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),eL=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{for:"posterInput"}).on("drop",e=>{var t,n,i,r;console.log("posterControls: Poster drop event"),e.preventDefault();let o=null!==(r=null===(i=e.originalEvent)||void 0===i?void 0:null===(n=i.dataTransfer)||void 0===n?void 0:null===(t=n.files)||void 0===t?void 0:t.item(0))&&void 0!==r?r:void 0;eZ(o)}).on("dragover",e=>e.preventDefault()).append(/*@__PURE__*/e(a)("<span>",{text:"Click or Drop File"})),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("posterControls: File input changed");let n=null===(t=e.target.files)||void 0===t?void 0:t[0];eZ(n)})),eM=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),ez=t=>/*@__PURE__*/e(a)("<ol>",{class:"programmeItems"}).append(t.items.map((e,n)=>eK({item:e,index:n,total:t.items.length})),eK({item:{composer:"",title:""},index:t.items.length,total:t.items.length})),eK=t=>/*@__PURE__*/e(a)("<li>").append(/*@__PURE__*/e(a)("<div>",{class:"actions"}).append(k({icon:"remove"}).on("click",eN({index:t.index,op:"remove"})).prop("disabled",t.index==t.total),k({icon:"move_up"}).on("click",eN({index:t.index,op:"up"})).prop("disabled",t.index<1||t.index==t.total),k({icon:"move_down"}).on("click",eN({index:t.index,op:"down"})).prop("disabled",t.index>=t.total-1)),/*@__PURE__*/e(a)("<div>",{class:"inputs"}).append(/*@__PURE__*/e(a)("<input>",{placeholder:"Composer",value:t.item.composer})//
    .on("blur",eN({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Title",value:t.item.title})//
    .on("blur",eN({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Performance Notes (optional)",value:t.item.performanceNotes})//
    .on("blur",eN({index:t.index,op:"blur"})))),eD=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(I(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));function eZ(t){console.debug(`onFileChanged(file=${t})`),t&&eR(t).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
})}/**
 ...
 */function eN(t){return()=>{console.debug(`modifyProgramme(${JSON.stringify(t)})`);let n=eW();if(n){if("remove"==t.op)n.splice(t.index,1);else if("up"==t.op){let e=n[t.index];n[t.index]=n[t.index-1],n[t.index-1]=e}else if("down"==t.op){let e=n[t.index];n[t.index]=n[t.index+1],n[t.index+1]=e}else if("blur"==t.op){let i=/*@__PURE__*/e(a)(".programmeItems li").length;if(console.debug(`modifyProgramme: index: ${t.index}, # of items: ${n.length}, # of <li>: ${i}`),t.index!=i-1||i!=n.length)return;console.debug("modifyProgramme: adding new empty item to bottom"),// This timeout is for the tabindex to change to the next element 
// after the blur event, if it is going to be set to anything!
setTimeout(()=>{let i;let r=document.activeElement;r instanceof HTMLElement&&(i=-1==(i=/*@__PURE__*/e(a)(r).parent().find("input").index(r))?void 0:i),/*@__PURE__*/e(a)(".programmeItems").replaceWith(ez({items:n})),void 0!=i&&/*@__PURE__*/e(a)(".programmeItems li").eq(t.index).find("input").eq(i).trigger("focus")},0);return}/*@__PURE__*/e(a)(".programmeItems").replaceWith(ez({items:n}))}}}const eO=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],ej=t=>/*@__PURE__*/e(a)("<div>",{class:"catalogueList"}).append(/*@__PURE__*/e(a)("<ul>").append(...t.composers.map(t=>/*@__PURE__*/e(a)("<li>",{text:t.name}).append(/*@__PURE__*/e(a)("<ul>").append(...t.works.map(t=>/*@__PURE__*/e(a)("<li>",{text:t.title}).append(/*@__PURE__*/e(a)("<ul>").append(...t.performances.map(t=>{var n;return /*@__PURE__*/e(a)("<li>").append(T({href:`/concert/${t.concert.id}`,text:`${t.concert.title} - ${(n=t.concert.when,Intl.DateTimeFormat("en-GB",{year:"numeric"}).format(new Date(n)))}`}),t.notes?[/*@__PURE__*/e(a)("<span>",{html:"&nbsp;"}),/*@__PURE__*/e(a)("<em>",{text:t.notes})]:[])})))))))));/*@__PURE__*/e(a)(()=>void(eG(),b(),window.addEventListener("popstate",eG),window.addEventListener("unload",()=>{// If we leave the page, clear the session storage
    // Ie .if we manually refresh the page, reload the db.
    sessionStorage.clear()})));const eH={"/admin":eJ(()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:em()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),p()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=em()}):/*@__PURE__*/e(a)())),{navAndFooter:!1}),"/catalogue":eJ(function(){return G().then(t=>{console.debug("cataloguePage(): displaying results:",t),/*@__PURE__*/e(a)("#cataloguePage .catalogueList").replaceWith(ej(t))}),eO.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),T({href:"/concerts",text:"View Concerts"})),ej({composers:[]}))}),"/concerts":eJ(()=>(O().then(t=>{/*@__PURE__*/e(a)(".concertsGrid").replaceWith(Y(t))}),/*@__PURE__*/e(a)("<div>",{id:"archivePage"}).append(/*@__PURE__*/e(a)("<main>").append(/*@__PURE__*/e(a)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Concerts"}),T({href:"/catalogue",text:"View Catalogue"})),E()?J():/*@__PURE__*/e(a)(),Y([]))))),"/concert/new":eJ(eU),"/concert/:id":eJ(eE),"/concert/:id/edit":eJ(eU)};function eG(){// find handler
for(let[t,n]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/e(a)("body>:not(.noty_layout)").remove(),Object.entries(eH))){let e=RegExp("^"+t.replace(/:\w+/,"\\w+")+"$");if(e.test(location.pathname)){console.debug(`renderRoute: Found match: '${t}' for '${location.pathname}'`),n();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=Q(),$().prependTo(".t1"),w().appendTo(document.body),/*@__PURE__*/e(a)(":contains('Go To Concerts Archive')").filter(".primary").replaceWith(T({href:"/concerts",text:"Go To Concerts Archive"}).addClass("primary")),/*@__PURE__*/e(a)(".gallery").replaceWith(K()),eX().then(t=>{console.debug("showHome: upcomingConcert:",t),/*@__PURE__*/e(a)(".upcoming").replaceWith(t?q({concert:t}):R())}),Z(),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new eg,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function eX(){return(await O()).sort((e,t)=>e.when.localeCompare(t.when)).find(e=>new Date(e.when)>new Date)}function eJ(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&$().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&w().appendTo(document.body)}}