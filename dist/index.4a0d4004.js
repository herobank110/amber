...
let V=0;const L=()=>M(-1),P=()=>M(1);function M(t){console.debug(`galleryMove(delta=${t})`),V=(V+t+U.length)%U.length;let n=/*@__PURE__*/e(a)(".gallery");// global!
n.find("img").attr("src",U[V]),n.find(".dot").removeClass("big").eq(V).addClass("big")}const z=()=>{let t=/*@__PURE__*/e(a)("<div>",{class:"gallery"}).append(/*@__PURE__*/e(a)("<div>",{class:"leftRight"}).append(/*@__PURE__*/e(a)("<div>").append(S({icon:"chevron_left"})).on("click",L),/*@__PURE__*/e(a)("<div>").append(S({icon:"chevron_right"})).on("click",P)),/*@__PURE__*/e(a)("<img>"),/*@__PURE__*/e(a)("<div>",{class:"dots"}).append(U.map(()=>/*@__PURE__*/e(a)("<span>",{class:"dot"}))));return(// initialize after adding to the DOM
// stupid global state HAHAHA
setTimeout(()=>M(0),0),t)};function K(e,t,n){let i=document.querySelector(e);if(!i)throw Error(`Invalid element for selector: ${e}`);let r=/** general helper functions */function(e,t){let n=e;do n=n.parentElement;while(n&&!(null==n?void 0:n.matches(".t")))return n}(i,0);if(!r)throw Error(`Couldn't find track for selector ${e}`);let o=new ViewTimeline({subject:r});// if (!re.test(options.timeRange || ""))
//   throw new Error(`Invalid timeRange: ${options.timeRange}`);
// timeline.
i.animate(t,y(v({},n),{timeline:o}))}async function D(){/** Prepare 10 year video autoplay on scroll in */(function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
e.muted=!0,e.controls=!1,new IntersectionObserver(t=>{1!=t.length&&console.warn(`Expected 1 entry, got ${t.length}`),t.forEach(t=>{t.isIntersecting?(e.play(),e.controls=!0):e.pause()})},{threshold:0,rootMargin:"-50% 0% -40%"}).observe(e)})(),K("#logo",{width:["40lvh","100px"]},{timeRange:"exit 0% 50%",fill:"both",easing:"linear"}),K(".logoWrap",{height:["40lvh","100px"]},{timeRange:"exit 10% 100%",fill:"both",easing:"linear"}),K(".upcomingCover",[{visibility:"visible",opacity:1},{visibility:"hidden",opacity:0}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),K("nav",[{visibility:"hidden",opacity:0},{visibility:"visible",opacity:1}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"});// [1, 3].forEach((n) => {
//   animate(
//     `.posters>:nth-child(${n})`,
//     // { marginTop: ["0%", "-120%"] },
...
e.composers.sort((e,t)=>e.name.localeCompare(t.name)),e.composers.forEach(e=>{e.works.sort((e,t)=>e.title.localeCompare(t.title)),e.works.forEach(e=>{e.performances.sort((e,t)=>e.concert.when.localeCompare(t.concert.when))})}),e)}function G(e){let t=new FormData;for(let[n,i]of Object.entries(e)){if(void 0===i)continue;let e="object"==typeof i?JSON.stringify(i):i.toString();t.append(n,e)}return t}/*@__PURE__*/e(a)("<div>",{id:"archivePage"});const X=()=>T({text:"Add Concert",class:"adminBigButton",href:"/concert/new"}),J=t=>/*@__PURE__*/e(a)("<div>",{class:"concertsGrid"}).append(t.sort((e,t)=>t.when.localeCompare(e.when)).map(e=>Y(e))),Y=t=>{var n;return T({href:`/concert/${t.id}`,class:"concertCard"}).append(/*@__PURE__*/e(a)("<div>",{class:"media",css:{backgroundImage:`url('${t.thumb}')`}}),/*@__PURE__*/e(a)("<div>",{class:"info"}).append(/*@__PURE__*/e(a)("<p>",{class:"when",text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric"}).format(new Date(n)))}),/*@__PURE__*/e(a)("<h3>",{class:"title",text:t.title})))},_=()=>/*@__PURE__*/e(a)("<nav>").append($(),en()),$=()=>/*@__PURE__*/e(a)("<ul>",{class:"desktop"}).append(ee({text:"Upcoming",href:"/#upcoming"}),ee({text:"Ten Years",href:"/#tenYears"}),ee({text:"About Us",href:"/#about"}),et(),ee({text:"Concerts",href:"/concerts"}),ee({text:"Catalogue",href:"/catalogue"}),ee({text:"Contact Us",href:"/#contact"}),/*@__PURE__*/e(a)("<span>")),ee=t=>/*@__PURE__*/e(a)("<li>",{class:"navItem"}).append(T({href:t.href,text:t.text})),et=()=>T({href:"/",class:"logo"}),en=()=>/*@__PURE__*/e(a)("<div>",{class:"mobile"}).append(/*@__PURE__*/e(a)("<div>",{class:"hamburger"}).append(S({icon:"menu"}))//
    .on("click",()=>er()),et(),ei()),ei=()=>/*@__PURE__*/e(a)("<div>",{class:"sidebar"}).append(/*@__PURE__*/e(a)("<div>",{class:"inner"}).append(/*@__PURE__*/e(a)("<div>",{class:"close"}).append(/*@__PURE__*/e(a)("<div>",{class:"img"}).append(S({icon:"close"}))//
    .on("click",()=>er())),/*@__PURE__*/e(a)("<ul>").append(ee({text:"Upcoming",href:"/#upcoming"}),ee({text:"Ten Years",href:"/#tenYears"}),ee({text:"About Us",href:"/#about"}),ee({text:"Concerts",href:"/concerts"}),ee({text:"Catalogue",href:"/catalogue"}),ee({text:"Contact Us",href:"/#contact"}))));function er(){/*@__PURE__*/e(a)("nav .mobile .sidebar").toggleClass("show")}/**
 * lil-gui
...
let e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}/**
	 ...
	 */destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}constructor(e,t,n,i,r="div"){/**
		 ...
		 * @type {HTMLElement}
		 */this.$name=document.createElement("div"),this.$name.classList.add("name"),eo.nextNameID=eo.nextNameID||0,this.$name.id=`lil-gui-name-${++eo.nextNameID}`,/**
...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class es extends eo{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function ea(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const el={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},ec=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:ea,toHexString:ea},el,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=el.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return el.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=el.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return el.toHexString(r)}}];class eu extends eo{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,ec.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=ea(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class eB extends eo{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class ed extends eo{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class eF extends eo{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class eh extends eo{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const ef=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new eF(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new ed(this,e,t,n,i,r);case"boolean":return new es(this,e,t);case"string":return new eh(this,e,t);case"function":return new eB(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
	 ...
	 * @returns {Controller}
	 */addColor(e,t,n=1){return new eu(this,e,t,n)}/**
	 ...
	 * @returns {GUI}
	 */addFolder(e){let t=new eA({parent:this,title:e});return this.root._closeFolders&&t.close(),t}/**
	 * Recalls values that were saved with `gui.save()`.
	 * @param {object} obj
	 * @param {boolean} recursive Pass false to exclude folders descending from this GUI.
	 * @returns {this}
	 */load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{!(t instanceof eB)&&t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}/**
...
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!ep&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(ef),ep=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=o}}function eg(){return localStorage.getItem("adminLoginRedirectTo")||"/"}var em={};em=/******/function(e){/******/// The module cache
...
var ev={};async function ey(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e(ev),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1],i=await N();return i.find(e=>e.id==n)}function eb(t=()=>{}){return ey().then(n=>{if(!n){new/*@__PURE__*/(e(em))({text:"Requested concert not found",type:"error",timeout:3e3,layout:"center"}).show(),m("/concerts");return}console.debug("concertViewerPage: Concert:",n),/*@__PURE__*/e(a)(".concertDetails").replaceWith(eC(n)),t()}),/*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(/*@__PURE__*/e(a)("<div>",{class:"concertDetails",text:"Loading..."}))}ev=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const eE=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(T({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined"}).on("click",()=>ex(t.id))),eC=t=>/*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(T({href:"/concerts",class:"backButton"}).append(S({icon:"arrow_back"}),/*@__PURE__*/e(a)("<span>",{text:"Back to All Concerts"})),E()?eE({id:t.id}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:A(t.when),class:"when"})),ew({items:t.programme}),t.facebook?x(t.facebook):/*@__PURE__*/e(a)(),eI({id:t.id})),ew=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"programme"}).toggleClass("empty",!t.items).append(/*@__PURE__*/e(a)("<h3>",{text:"Programme"}),/*@__PURE__*/e(a)("<ol>",{class:"programmeItems"}).append((null!==(n=t.items)&&void 0!==n?n:[]).map(t=>/*@__PURE__*/e(a)("<li>").append(/*@__PURE__*/e(a)("<strong>",{text:t.composer}).append(/*@__PURE__*/e(a)("<span>",{html:":&nbsp;"})),/*@__PURE__*/e(a)("<span>",{text:t.title}),t.performanceNotes?[/*@__PURE__*/e(a)("<br>"),/*@__PURE__*/e(a)("<em>",{text:t.performanceNotes})]:/*@__PURE__*/e(a)()))))},eI=t=>(N().then(n=>{n.sort((e,t)=>e.when.localeCompare(t.when));let i=new Date(n.find(e=>e.id===t.id).when),r=n.find(e=>new Date(e.when)>i),o=n.reverse().find(e=>new Date(e.when)<i);/*@__PURE__*/e(a)(".prevNextConcerts").append(o?T({href:`/concert/${o.id}`}).append(S({icon:"arrow_back"}),/*@__PURE__*/e(a)("<span>",{text:"Previous Concert"})):[],r?T({href:`/concert/${r.id}`}).addClass("nextConcert").append(/*@__PURE__*/e(a)("<span>",{text:"Next Concert"}),S({icon:"arrow_forward"})):[])}),/*@__PURE__*/e(a)("<div>",{class:"prevNextConcerts"}));async function ex(t){if(confirm("Are you sure you want to delete this concert?")){let n=new/*@__PURE__*/(e(em))({text:"Processing request...",type:"info",layout:"center"});n.show();let i=await j(t);n.close(),i&&(console.debug("adminControls: reloading concerts cache"),await N(!1)),new/*@__PURE__*/(e(em))({text:i?"Concert deleted successfully":"Failed to delete concert",type:i?"success":"error",timeout:3e3,layout:"center"}).show(),m("/concerts")}}const eS={success:!0,url:"https://wales-armenia.87.org.uk/share/homePage/splash01A.jpg"};async function ek(t){let n;console.debug(`uploadFile(${t.name})`);let i=new/*@__PURE__*/(e(em))({text:"Uploading, please wait...",type:"info",layout:"center"});if(i.show(),p())await new Promise(e=>setTimeout(e,1e3)),n=eS;else{let e=new FormData;e.append("file",t),n=await fetch("/php/upload.php",{method:"POST",body:e}).then(e=>e.json())}if(i.close(),!n.success){new/*@__PURE__*/(e(em))({text:"Failed to upload file: "+n.error,type:"error",layout:"center",timeout:3e3}).show();return}return new/*@__PURE__*/(e(em))({text:"File uploaded successfully",type:"success",layout:"center",timeout:3e3}).show(),n.url}function eT(){console.debug("concertEditorPage()"),setTimeout(()=>void(console.debug("requireAdminMode()"),E()||C()));// Start with the viewer page and modify it to the things we want.
let t=eb(async()=>{var n;let i=await ey();if(!i)throw Error("Concert not found");console.debug(`concertEditorPage: ConcertID: ${i.id}`),t.append(/*@__PURE__*/e(a)("<input>",{type:"hidden",class:"idInput",value:i.id})),t.addClass("concertEditorPage"),t.find(".backButton").remove(),t.find(".adminControls").replaceWith(eq({id:i.id})),t.find(".posterWrap").append(eR()),t.find(".title").replaceWith(eQ({val:i.title})),t.find(".when").replaceWith(eU(i.when)),t.find(".fbLink").remove(),t.find(".programme").removeClass("empty"),t.find(".programmeItems").replaceWith(eV({items:null!==(n=i.programme)&&void 0!==n?n:[]})),t.find(".programme").after(eP({val:i.facebook})),t.find(".concertDetails").append(eq({id:i.id}))});return t}const eQ=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
...
n(i.find(".titleH")),i)},eq=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(T({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=g(o,160,120),l=ez(),c={id:t,title:n,when:i,poster:o,thumb:s,programme:l};return r&&(c.facebook=r),c}(),n=new/*@__PURE__*/(e(em))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){console.debug(`saveConcert(${JSON.stringify(e)})`);let t=G(y(v({},e),{// Set the operation explicitly.
    op:-1==e.id?"insert":"update"}));return new Promise(p()?(e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)}:(n,i)=>{fetch(O,{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),// Get the inserted ID if it was an insert, otherwise just
    // return the same ID to simplify app logic.
    n(-1==e.id?t.id:e.id)})// Reject so we can show an error message to the user.
    .catch(i)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await N(!1),new/*@__PURE__*/(e(em))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),m(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(em))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),T({text:"Cancel",class:"adminButton outlined",href:-1==t.id?"/concerts":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),eR=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{for:"posterInput"}).on("drop",e=>{var t,n,i,r;console.log("posterControls: Poster drop event"),e.preventDefault();let o=null!==(r=null===(i=e.originalEvent)||void 0===i?void 0:null===(n=i.dataTransfer)||void 0===n?void 0:null===(t=n.files)||void 0===t?void 0:t.item(0))&&void 0!==r?r:void 0;eM(o)}).on("dragover",e=>e.preventDefault()).append(/*@__PURE__*/e(a)("<span>",{text:"Click or Drop File"})),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("posterControls: File input changed");let n=null===(t=e.target.files)||void 0===t?void 0:t[0];eM(n)})),eU=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),eV=t=>/*@__PURE__*/e(a)("<ol>",{class:"programmeItems"}).append(t.items.map((e,n)=>eL({item:e,index:n,total:t.items.length})),eL({item:{composer:"",title:""},index:t.items.length,total:t.items.length})),eL=t=>/*@__PURE__*/e(a)("<li>").append(/*@__PURE__*/e(a)("<div>",{class:"actions"}).append(k({icon:"remove"}).on("click",eK({index:t.index,op:"remove"})).prop("disabled",t.index==t.total),k({icon:"move_up"}).on("click",eK({index:t.index,op:"up"})).prop("disabled",t.index<1||t.index==t.total),k({icon:"move_down"}).on("click",eK({index:t.index,op:"down"})).prop("disabled",t.index>=t.total-1)),/*@__PURE__*/e(a)("<div>",{class:"inputs"}).append(/*@__PURE__*/e(a)("<input>",{placeholder:"Composer",value:t.item.composer})//
    .on("blur",eK({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Title",value:t.item.title})//
    .on("blur",eK({index:t.index,op:"blur"})),/*@__PURE__*/e(a)("<input>",{placeholder:"Performance Notes (optional)",value:t.item.performanceNotes})//
    .on("blur",eK({index:t.index,op:"blur"})))),eP=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(I(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));function eM(t){console.debug(`onFileChanged(file=${t})`),t&&ek(t).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
})}/**
 ...
 */function eK(t){return()=>{console.debug(`modifyProgramme(${JSON.stringify(t)})`);let n=ez();if(n){if("remove"==t.op)n.splice(t.index,1);else if("up"==t.op){let e=n[t.index];n[t.index]=n[t.index-1],n[t.index-1]=e}else if("down"==t.op){let e=n[t.index];n[t.index]=n[t.index+1],n[t.index+1]=e}else if("blur"==t.op){let i=/*@__PURE__*/e(a)(".programmeItems li").length;if(console.debug(`modifyProgramme: index: ${t.index}, # of items: ${n.length}, # of <li>: ${i}`),t.index!=i-1||i!=n.length)return;console.debug("modifyProgramme: adding new empty item to bottom"),// This timeout is for the tabindex to change to the next element 
// after the blur event, if it is going to be set to anything!
setTimeout(()=>{let i;let r=document.activeElement;r instanceof HTMLElement&&(i=-1==(i=/*@__PURE__*/e(a)(r).parent().find("input").index(r))?void 0:i),/*@__PURE__*/e(a)(".programmeItems").replaceWith(eV({items:n})),void 0!=i&&/*@__PURE__*/e(a)(".programmeItems li").eq(t.index).find("input").eq(i).trigger("focus")},0);return}/*@__PURE__*/e(a)(".programmeItems").replaceWith(eV({items:n}))}}}const eD=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eZ=t=>/*@__PURE__*/e(a)("<div>",{class:"catalogueList"}).append(/*@__PURE__*/e(a)("<ul>").append(...t.composers.map(t=>/*@__PURE__*/e(a)("<li>",{text:t.name}).append(/*@__PURE__*/e(a)("<ul>").append(...t.works.map(t=>/*@__PURE__*/e(a)("<li>",{text:t.title}).append(/*@__PURE__*/e(a)("<ul>").append(...t.performances.map(t=>{var n;return /*@__PURE__*/e(a)("<li>").append(T({href:`/concert/${t.concert.id}`,text:`${t.concert.title} - ${(n=t.concert.when,Intl.DateTimeFormat("en-GB",{year:"numeric"}).format(new Date(n)))}`}),t.notes?[/*@__PURE__*/e(a)("<span>",{html:"&nbsp;"}),/*@__PURE__*/e(a)("<em>",{text:t.notes})]:[])})))))))));/*@__PURE__*/e(a)(()=>void(eN(),b(),window.addEventListener("popstate",eN),window.addEventListener("unload",()=>{// If we leave the page, clear the session storage
    // Ie .if we manually refresh the page, reload the db.
    sessionStorage.clear()})));const eW={"/admin":ej(()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:eg()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),p()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=eg()}):/*@__PURE__*/e(a)())),{navAndFooter:!1}),"/catalogue":ej(function(){return H().then(t=>{console.debug("cataloguePage(): displaying results:",t),/*@__PURE__*/e(a)("#cataloguePage .catalogueList").replaceWith(eZ(t))}),eD.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),T({href:"/concerts",text:"View Concerts"})),eZ({composers:[]}))}),"/concerts":ej(()=>(N().then(t=>{/*@__PURE__*/e(a)(".concertsGrid").replaceWith(J(t))}),/*@__PURE__*/e(a)("<div>",{id:"archivePage"}).append(/*@__PURE__*/e(a)("<main>").append(/*@__PURE__*/e(a)("<div>",{class:"headingWithLink"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Concerts"}),T({href:"/catalogue",text:"View Catalogue"})),E()?X():/*@__PURE__*/e(a)(),J([]))))),"/concert/new":ej(eT),"/concert/:id":ej(eb),"/concert/:id/edit":ej(eT)};function eN(){// find handler
for(let[t,n]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/e(a)("body>:not(.noty_layout)").remove(),Object.entries(eW))){let e=RegExp("^"+t.replace(/:\w+/,"\\w+")+"$");if(e.test(location.pathname)){console.debug(`renderRoute: Found match: '${t}' for '${location.pathname}'`),n();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=Q(),_().prependTo(".t1"),w().appendTo(document.body),/*@__PURE__*/e(a)(":contains('Go To Concerts Archive')").filter(".primary").replaceWith(T({href:"/concerts",text:"Go To Concerts Archive"}).addClass("primary")),/*@__PURE__*/e(a)(".gallery").replaceWith(z()),eO().then(t=>{console.debug("showHome: upcomingConcert:",t),/*@__PURE__*/e(a)(".upcoming").replaceWith(t?q({concert:t}):R())}),D(),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new eA,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function eO(){return(await N()).sort((e,t)=>e.when.localeCompare(t.when)).find(e=>new Date(e.when)>new Date)}function ej(e,t={navAndFooter:!0}){return()=>{t.navAndFooter&&_().appendTo(document.body),e().appendTo(document.body),t.navAndFooter&&w().appendTo(document.body)}}