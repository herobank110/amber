...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class ee extends H{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class et extends H{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const en=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new ee(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new $(this,e,t,n,i,r);case"boolean":return new j(this,e,t);case"string":return new et(this,e,t);case"function":return new _(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
...
var el={};async function ec(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e(el),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1],i=await M();return i.find(e=>e.id==n)}function eu(){return ec().then(t=>{if(!t){new/*@__PURE__*/(e(ea))({text:"Requested concert not found",type:"error",timeout:3e3,layout:"center"}).show(),v("/archive");return}/*@__PURE__*/e(a)(".concertDetails").replaceWith(eF(t))}),/*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(/*@__PURE__*/e(a)("<div>",{class:"concertDetails"}))}el=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const eB=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(S({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined"}).on("click",async()=>{if(confirm("Are you sure you want to delete this concert?")){let n=new/*@__PURE__*/(e(ea))({text:"Processing request...",type:"info",layout:"center"});n.show();let i=await K(t.id);n.close(),new/*@__PURE__*/(e(ea))({text:i?"Concert deleted successfully":"Failed to delete concert",type:i?"success":"error",timeout:3e3,layout:"center"}).show(),v("/archive")}})),eF=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(S({href:"/archive",text:"\uD83E\uDC84 Back to All Concerts",class:"backButton"}),E()?eB({id:t.id}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",hour12:!0}).format(new Date(n))),class:"when"})),t.facebook?x(t.facebook):/*@__PURE__*/e(a)())},ed={success:!0,url:"https://wales-armenia.87.org.uk/share/homePage/splash01A.jpg"};async function eh(t){let n;console.debug(`uploadFile(${t.name})`);let i=new/*@__PURE__*/(e(ea))({text:"Uploading, please wait...",type:"info",layout:"center"});if(i.show(),m())await new Promise(e=>setTimeout(e,1e3)),n=ed;else{let e=new FormData;e.append("file",t),n=await fetch("/php/upload.php",{method:"POST",body:e}).then(e=>e.json())}if(i.close(),!n.success){new/*@__PURE__*/(e(ea))({text:"Failed to upload file: "+n.error,type:"error",layout:"center",timeout:3e3}).show();return}return new/*@__PURE__*/(e(ea))({text:"File uploaded successfully",type:"success",layout:"center",timeout:3e3}).show(),n.url}async function ef(){setTimeout(()=>{console.debug("requireAdminMode()"),E()||C()});let t=await ec();if(!t)throw Error("Concert not found");console.log(`Editing concert ${t.id}`);// Start with the viewer page and modify it to the things we want.
let n=await eu();return n.append(/*@__PURE__*/e(a)("<input>",{type:"hidden",class:"idInput",value:t.id})),n.addClass("concertEditorPage"),n.find(".adminControls").remove(),n.find(".posterWrap").append(eg()),n.find(".title").replaceWith(ep({val:t.title})),n.find(".when").replaceWith(em(t.when)),n.find(".fbLink").remove(),n.find(".concertDetails").append(ev({val:t.facebook})),n.find(".concertDetails").append(eA({id:t.id})),n}const ep=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
.on("input",t=>n(/*@__PURE__*/e(a)(t.target))));return(// initialize state.
n(i.find(".titleH")),i)},eA=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(S({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(m())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;// returns a full url string, for easier parsing and validation later.
    return i.set("src",e),i.set("x",t.toString()),i.set("y",n.toString()),"https://roathchamber.org/php/resize.php?"+i.toString()}(o,160,120),l={id:t,title:n,when:i,poster:o,thumb:s};return r&&(l.facebook=r),l}(),n=new/*@__PURE__*/(e(ea))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){if(console.debug(`saveConcert(${JSON.stringify(e)})`),m())return new Promise((e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)});let t=D(g(A({},e),{// Set the operation explicitly.
    op:-1==e.id?"insert":"update"}));return new Promise((n,i)=>{fetch(z,{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),// Get the inserted ID if it was an insert, otherwise just
    // return the same ID to simplify app logic.
    n(-1==e.id?t.id:e.id)})// Reject so we can show an error message to the user.
    .catch(i)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await M(!1),new/*@__PURE__*/(e(ea))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),v(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(ea))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),S({text:"Cancel",class:"adminButton",href:-1==t.id?"/archive":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),eg=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{text:"Click to Upload",for:"posterInput"}),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",t=>{var n;let i=null===(n=t.target.files)||void 0===n?void 0:n[0];console.debug("posterControls: File changed: ",i),i&&eh(i).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
    })})),em=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),ev=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(I(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"})),ey=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eb=t=>/*@__PURE__*/e(a)("<div>",{class:"pieceList"}).append(...t.map(t=>/*@__PURE__*/e(a)("<details>",{class:"piece"}).append(/*@__PURE__*/e(a)("<summary>",{text:t.composer+" - "+t.name}),/*@__PURE__*/e(a)("<span>",{html:"Played in:&nbsp;"}),...t.concerts.map(e=>S({href:`/concert/${e.id}`,text:e.title})))));/*@__PURE__*/e(a)(()=>void(eC(),b(),window.addEventListener("popstate",eC)));const eE={"/archive":function(){Z().appendTo(document.body),w().appendTo(document.body)},"/catalogue":function(){k().appendTo(document.body),(M().then(t=>{/*@__PURE__*/e(a)("#cataloguePage .pieceList").replaceWith(eb(ey))}),ey.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),eb([]))).appendTo(document.body),w().appendTo(document.body)},"/admin":function(){eo().appendTo(document.body)},"/concert/new":ew,"/concert/:id":eI,"/concert/:id/edit":ew};function eC(){// find handler
for(let[t,n]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/e(a)("body>:not(.noty_layout)").remove(),Object.entries(eE))){let e=RegExp("^"+t.replace(/:\w+/,"\\w+")+"$");if(e.test(location.pathname)){console.log(`Route matched: '${t}' for '${location.pathname}'`),n();return}}// default handler
...
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(x("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new er,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function ew(){k().appendTo(document.body),(await ef()).appendTo(document.body),w().appendTo(document.body)}async function eI(){k().appendTo(document.body),(await eu()).appendTo(document.body),w().appendTo(document.body)}