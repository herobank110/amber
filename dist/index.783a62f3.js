...
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+V+"))|)"+k+"*\\]",M=":("+V+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+L+")*)|.*)\\)|)",P=RegExp(k+"+","g"),z=RegExp("^"+k+"*,"+k+"*"),K=RegExp("^"+k+"*([>+~]|"+k+")"+k+"*"),D=RegExp(k+"|>"),Z=new RegExp(M),W=RegExp("^"+V+"$"),O={ID:RegExp("^#("+V+")"),CLASS:RegExp("^\\.("+V+")"),TAG:RegExp("^("+V+"|[*])"),ATTR:RegExp("^"+L),PSEUDO:RegExp("^"+M),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+k+"*(even|odd|(([+-]|)(\\d*)n|)"+k+"*(?:([+-]|)"+k+"*(\\d+)|))"+k+"*\\)|)","i"),bool:RegExp("^(?:"+U+")$","i"),// For use in libraries implementing .is()
// We use this for POS matching in `select`
needsContext:RegExp("^"+k+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+k+"*((?:-\\d)?\\d*)"+k+"*\\)|)(?=[^-]|$)","i")},N=/^(?:input|select|textarea|button)$/i,H=/^h\d$/i,j=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,G=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
...
cacheLength:50,createPseudo:et,match:O,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(e){return e[1]=e[1].replace(X,J),// Move the given value to match[3] whether quoted or unquoted
...
e[4]=+(e[4]?e[5]+(e[6]||1):2*("even"===e[3]||"odd"===e[3])),e[5]=+(e[7]+e[8]||"odd"===e[3])):e[3]&&$.error(e[0]),e)},PSEUDO:function(e){var t,n=!e[6]&&e[2];return O.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":n&&Z.test(n)&&// Get excess from tokenize (recursively)
...
var t=[],n=[],i=ed(e.replace(T,"$1"));return i[m]?et(function(e,t,n,r){// Match elements unmatched by `matcher`
...
header:function(e){return H.test(e.nodeName)},input:function(e){return N.test(e.nodeName)},button:function(e){return w(e,"input")&&"button"===e.type||w(e,"button")},text:function(e){var t;return w(e,"input")&&"text"===e.type&&// Support: IE <10 only
...
type:r[0].replace(T," ")}),a=a.slice(i.length)),n.filter)(r=O[s].exec(a))&&(!c[s]||(r=c[s](r)))&&(i=r.shift(),o.push({value:i,type:s,matches:r}),a=a.slice(i.length));if(!i)break}return(// Return the length of the invalid excess
...
B=d.length;B--;)(F=d[B])&&(u=o?l.call(e,F):h[B])>-1&&(e[u]=!(s[u]=F))}}else d=eF(d===s?d.splice(p,d.length):d),o?o(null,s,d,c):g.apply(s,d)})}(B>1&&eB(h),B>1&&ec(t.slice(0,B-1).concat({value:" "===t[B-2].type?"*":""})).replace(T,"$1"),o,B<s&&e(t.slice(B,s)),s<a&&e(t=t.slice(s)),s<a&&ec(t))}h.push(o)}return eB(h)}(t[a]))[m]?c.push(F):B.push(F);// Save selector and tokenization
// Cache the compiled function
(F=Q(e,(i=c.length>0,o=B.length>0,s=function(e,t,s,a,l){var F,h,f,p=0,A="0",m=e&&[],y=[],b=r,C=e||o&&n.find.TAG("*",l),w=v+=null==b?1:Math.random()||.1,x=C.length;// Add elements passing elementMatchers directly to results
...
o=O.needsContext.test(e)?0:s.length;// Abort if we hit a combinator
...
P=E(A);var K=/^(?:parents|prev(?:Until|All))/,D={children:!0,contents:!0,next:!0,prev:!0};function Z(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}E.fn.extend({has:function(e){var t=E(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(E.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,r=this.length,o=[],s="string"!=typeof e&&E(e);// Positional selectors never match, since there's no _selection_ context
...
("object"==typeof e||"function"==typeof e)&&e.then)?r?c.call(e,s(o,n,O,r),s(o,n,N,r)):(// ...and disregard older resolution values
o++,c.call(e,s(o,n,O,r),s(o,n,N,r),s(o,n,O,n.notifyWith))):(i!==O&&(a=void 0,l=[e]),// Process the value(s)
// Default process is resolve
(r||n.resolveWith)(a,l))}},u=r?c:function(){try{c()}catch(e){E.Deferred.exceptionHook&&E.Deferred.exceptionHook(e,u.error),t+1>=o&&(i!==N&&(a=void 0,l=[e]),n.rejectWith(a,l))}};// Support: Promises/A+ section 2.3.3.3.1
...
n[0][3].add(s(0,e,f(r)?r:O,e.notifyWith)),// fulfilled_handlers.add( ... )
n[1][3].add(s(0,e,f(t)?t:O)),// rejected_handlers.add( ... )
n[2][3].add(s(0,e,f(i)?i:N))}).promise()},// Get a promise for this deferred
...
for(r in i=n.call(e),t)e.style[r]=o[r];return i},eO=RegExp(eu.join("|"),"i");function eN(e,t,n){var i,r,o,s,a=eD.test(t),// Retrieving style before computed somehow
...
(s=s.replace(T,"$1")||void 0),""!==s||eF(e)||(s=E.style(e,t)),!h.pixelBoxStyles()&&eK.test(s)&&eO.test(t)&&(// Remember the original values
...
var i=eZ(e),r=(!h.boxSizingReliable()||n)&&"border-box"===E.css(e,"boxSizing",!1,i),o=r,s=eN(e,t,i),a="offset"+t[0].toUpperCase()+t.slice(1);// Support: Firefox <=54
...
var n=eN(e,"opacity");return""===n?"1":n}}}},// Don't automatically add "px" to these possibly-unitless properties
...
(s=E.cssHooks[t]||E.cssHooks[a])&&"get"in s&&(r=s.get(e,!0,n)),void 0===r&&(r=eN(e,t,i)),"normal"===r&&t in e$&&(r=e$[t]),""===n||n)?(o=parseFloat(r),!0===n||isFinite(o)?o||0:r):r)}}),E.each(["height","width"],function(e,t){E.cssHooks[t]={get:function(e,n,i){if(n)// but it must have a current display style that would benefit
...
i=tU(tT,d,n,C)){// If request was aborted inside ajaxSend, stop there
...
return n=eN(e,t),eK.test(n)?E(e).position()[t]+"px":n})}),// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class Z extends D{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function W(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const O={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},N=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:W,toHexString:W},O,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=O.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return O.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=O.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return O.toHexString(r)}}];class H extends D{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,N.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=W(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class j extends D{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class G extends D{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class X extends D{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class J extends D{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const Y=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new X(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new G(this,e,t,n,i,r);case"boolean":return new Z(this,e,t);case"string":return new J(this,e,t);case"function":return new j(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
	 ...
	 * @returns {Controller}
	 */addColor(e,t,n=1){return new H(this,e,t,n)}/**
	 ...
	 * @returns {GUI}
	 */addFolder(e){let t=new $({parent:this,title:e});return this.root._closeFolders&&t.close(),t}/**
	 * Recalls values that were saved with `gui.save()`.
	 * @param {object} obj
	 * @param {boolean} recursive Pass false to exclude folders descending from this GUI.
	 * @returns {this}
	 */load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{!(t instanceof j)&&t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}/**
...
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!_&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(Y),_=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=o}}const ee=()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:et()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),A()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=et()}):/*@__PURE__*/e(a)()));function et(){return sessionStorage.getItem("adminLoginRedirectTo")||"/"}var en={};en=/******/function(e){/******/// The module cache
...
var e=setTimeout;return function(){return e(v,1)}}var m=Array(1e3);function v(){for(var e=0;e<c;e+=2)(0,m[e])(m[e+1]),m[e]=void 0,m[e+1]=void 0;c=0}var y=void 0;function b(e,t){var n,i=arguments,r=this,o=new this.constructor(w);void 0===o[C]&&K(o);var s=r._state;return s?(n=i[s-1],F(function(){return P(s,o,n,r._result)})):U(r,o,e,t),o}/**
  ...
  `value`
*/function E(e){if(e&&"object"==typeof e&&e.constructor===this)return e;var t=new this(w);return T(t,e),t}p?y=function(){return t.nextTick(v)}:f?(r=0,o=new f(v),s=document.createTextNode(""),o.observe(s,{characterData:!0}),y=function(){s.data=r=++r%2}):A?((a=new MessageChannel).port1.onmessage=v,y=function(){return a.port2.postMessage(0)}):y=void 0===d?function(){try{var e=n(9);return u=e.runOnLoop||e.runOnContext,void 0!==u?function(){u(v)}:g()}catch(e){return g()}}():g();var C=Math.random().toString(36).substring(16);function w(){}var I=void 0,x=new L;function S(e){try{return e.then}catch(e){return x.error=e,x}}function k(t,n,i){n.constructor===t.constructor&&i===b&&n.constructor.resolve===E?1===n._state?q(t,n._result):2===n._state?R(t,n._result):U(n,void 0,function(e){return T(t,e)},function(e){return R(t,e)}):i===x?(R(t,x.error),x.error=null):void 0===i?q(t,n):e(i)?F(function(e){var t=!1,r=function(e,t,n,i){try{e.call(t,n,i)}catch(e){return e}}(i,n,function(i){t||(t=!0,n!==i?T(e,i):q(e,i))},function(n){t||(t=!0,R(e,n))},"Settle: "+(e._label||" unknown promise"));!t&&r&&(t=!0,R(e,r))},t):q(t,n)}function T(e,t){if(e===t)R(e,TypeError("You cannot resolve a promise with itself"));else{var n;(n=typeof t,null!==t&&("object"===n||"function"===n))?k(e,t,S(t)):q(e,t)}}function Q(e){e._onerror&&e._onerror(e._result),V(e)}function q(e,t){e._state===I&&(e._result=t,e._state=1,0!==e._subscribers.length&&F(V,e))}function R(e,t){e._state===I&&(e._state=2,e._result=t,F(Q,e))}function U(e,t,n,i){var r=e._subscribers,o=r.length;e._onerror=null,r[o]=t,r[o+1]=n,r[o+2]=i,0===o&&e._state&&F(V,e)}function V(e){var t=e._subscribers,n=e._state;if(0!==t.length){for(var i=void 0,r=void 0,o=e._result,s=0;s<t.length;s+=3)i=t[s],r=t[s+n],i?P(n,i,r,o):r(o);e._subscribers.length=0}}function L(){this.error=null}var M=new L;function P(t,n,i,r){var o=e(i),s=void 0,a=void 0,l=void 0,c=void 0;if(o){if((s=function(e,t){try{return e(t)}catch(e){return M.error=e,M}}(i,r))===M?(c=!0,a=s.error,s.error=null):l=!0,n===s){R(n,TypeError("A promises callback cannot return that same promise."));return}}else s=r,l=!0;n._state!==I||(o&&l?T(n,s):c?R(n,a):1===t?q(n,s):2===t&&R(n,s))}var z=0;function K(e){e[C]=z++,e._state=void 0,e._result=void 0,e._subscribers=[]}function D(e,t){this._instanceConstructor=e,this.promise=new e(w),this.promise[C]||K(this.promise),l(t)?(this.length=t.length,this._remaining=t.length,this._result=Array(this.length),0===this.length?q(this.promise,this._result):(this.length=this.length||0,this._enumerate(t),0===this._remaining&&q(this.promise,this._result))):R(this.promise,Error("Array Methods must be provided an Array"))}/**
...
var ei={};async function er(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e(ei),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1],i=await L();return i.find(e=>e.id==n)}async function eo(){let t=await er();if(!t)throw Error("Concert not found");return /*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(ea(t))}ei=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const es=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(I({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined",href:`/php/concertDelete.php?id=${t.id}`}).on("click",e=>{confirm("Are you sure you want to delete this concert?")||e.preventDefault()})),ea=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(I({href:"/archive",text:"\uD83E\uDC84 Back to All Concerts",class:"backButton"}),es({id:t.id}),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",hour12:!0}).format(new Date(n))),class:"when"})),t.facebook?w(t.facebook):/*@__PURE__*/e(a)())},el={success:!0,url:"https://wales-armenia.87.org.uk/share/homePage/splash01A.jpg"};async function ec(t){let n;console.debug(`uploadFile(${t.name})`);let i=new/*@__PURE__*/(e(en))({text:"Uploading, please wait...",type:"info",layout:"center"});if(i.show(),A())await new Promise(e=>setTimeout(e,1e3)),n=el;else{let e=new FormData;e.append("file",t),n=await fetch("/php/upload.php",{method:"POST",body:e}).then(e=>e.json())}if(i.close(),!n.success){new/*@__PURE__*/(e(en))({text:"Failed to upload file: "+n.error,type:"error",layout:"center",timeout:3e3}).show();return}return new/*@__PURE__*/(e(en))({text:"File uploaded successfully",type:"success",layout:"center",timeout:3e3}).show(),n.url}async function eu(){setTimeout(()=>{console.debug("requireAdminMode()"),y()||b()});let t=await er();if(!t)throw Error("Concert not found");console.log(`Editing concert ${t.id}`);// Start with the viewer page and modify it to the things we want.
let n=await eo();return n.append(/*@__PURE__*/e(a)("<input>",{type:"hidden",class:"idInput",value:t.id})),n.addClass("concertEditorPage"),n.find(".adminControls").remove(),n.find(".posterWrap").append(ed()),n.find(".title").replaceWith(eB({val:t.title})),n.find(".when").replaceWith(eh(t.when)),n.find(".fbLink").remove(),n.find(".concertDetails").append(ef({val:t.facebook})),n.find(".concertDetails").append(eF({id:t.id})),n}const eB=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
.on("input",t=>n(/*@__PURE__*/e(a)(t.target))));return(// initialize state.
n(i.find(".titleH")),i)},eF=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(I({text:"Save",class:"adminButton",href:""}).on("click",t=>{(function(){console.log("fileControls: Save clicked");let t=/** @returns current gui values to send to server for saving */function(){let t=+/*@__PURE__*/e(a)(".idInput").val(),n=/*@__PURE__*/e(a)(".titleH").text(),i=/*@__PURE__*/e(a)(".when").val(),r=/*@__PURE__*/e(a)("#fbInput").val(),o=/*@__PURE__*/e(a)(".poster")[0].src,s=function(e,t,n){if(!e||t<0||n<0)throw Error(`invalid argument(s): ${e}, ${t}, ${n}`);if(A())return"https://roathchamber.org/share/resize/00316-335561172.6e7667.300x200.png";let i=new URLSearchParams;// returns a full url string, for easier parsing and validation later.
    return i.set("src",e),i.set("x",t.toString()),i.set("y",n.toString()),"https://roathchamber.org/php/resize.php?"+i.toString()}(o,160,120),l={id:t,title:n,when:i,poster:o,thumb:s};return r&&(l.facebook=r),l}(),n=new/*@__PURE__*/(e(en))({text:"Saving...",type:"info",layout:"center"});n.show(),(function(e){if(console.debug(`saveConcert(${JSON.stringify(e)})`),A())return new Promise((e,t)=>{console.log("saveConcert: (dev mode) auto resolve"),setTimeout(()=>e(1),1e3)});let t=function(e){let t=new FormData;for(let[n,i]of Object.entries(e))t.append(n,i.toString());return t}(e);return new Promise((e,n)=>{fetch("/php/concertEdit.php",{method:"POST",body:t}).then(e=>e.json()).then(t=>{console.log("saveConcert: resolved",t),e(t.id)}).catch(n)})})(t).then(async t=>{console.debug(`fileControls: Save complete : ${t}`),n.close(),console.debug("fileControls: reloading concerts cache"),await L(!1),new/*@__PURE__*/(e(en))({text:"Saved successfully",type:"success",layout:"center",timeout:3e3}).show(),g(`/concert/${t}`)}).catch(t=>{console.error("Failed to save",t),new/*@__PURE__*/(e(en))({text:"Failed to save, please try again later",type:"error",layout:"center",timeout:3e3}).show()}).finally(()=>{console.log("fileControls: Save finally complete"),n.close()})})(),t.stopPropagation()}),I({text:"Cancel",class:"adminButton",href:-1==t.id?"/archive":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),ed=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{text:"Click to Upload",for:"posterInput"}),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",t=>{var n;let i=null===(n=t.target.files)||void 0===n?void 0:n[0];console.debug("posterControls: File changed: ",i),i&&ec(i).then(t=>{t&&(console.log("posterControls: File uploaded: ",t),/*@__PURE__*/e(a)(".poster").attr("src",t));// Noty displayed already
    })})),eh=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),ef=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(C(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"})),ep=[{id:1,name:"Symphony No. 5 in C minor, Op. 67",composer:"Beethoven, Ludwig van",concerts:[{id:1,title:"Spring 2044"}]},{id:2,name:"Egmont Overture, Op. 84",composer:"Beethoven, Ludwig van",concerts:[{id:3,title:"Spring 2077"},{id:5,title:"Christmas 1653"}]},{id:3,name:"Flute Concerto No. 2 in D major, K. 314/285d",composer:"Mozart, Wolfgang Amadeus",concerts:[{id:8,title:"The Orchestra's Day Out at the Zoo"}]}],eA=t=>/*@__PURE__*/e(a)("<div>",{class:"pieceList"}).append(...t.map(t=>/*@__PURE__*/e(a)("<details>",{class:"piece"}).append(/*@__PURE__*/e(a)("<summary>",{text:t.composer+" - "+t.name}),/*@__PURE__*/e(a)("<span>",{html:"Played in:&nbsp;"}),...t.concerts.map(e=>I({href:`/concert/${e.id}`,text:e.title})))));/*@__PURE__*/e(a)(()=>void(em(),v(),window.addEventListener("popstate",em)));const eg={"/archive":function(){M().appendTo(document.body),E().appendTo(document.body)},"/catalogue":function(){x().appendTo(document.body),(L().then(t=>{/*@__PURE__*/e(a)("#cataloguePage .pieceList").replaceWith(eA(ep))}),ep.sort((e,t)=>{let n=e.composer.localeCompare(t.composer);return 0==n&&(n=e.name.localeCompare(t.name)),n}),/*@__PURE__*/e(a)("<main>",{id:"cataloguePage"}).append(/*@__PURE__*/e(a)("<h1>",{text:"Catalogue"}),eA([]))).appendTo(document.body),E().appendTo(document.body)},"/admin":function(){ee().appendTo(document.body)},"/concert/new":ev,"/concert/:id":ey,"/concert/:id/edit":ev};function em(){// find handler
for(let[t,n]of(// reset state if re-using SPA
window.scrollTo(0,0),/*@__PURE__*/e(a)("body>:not(.noty_layout)").remove(),Object.entries(eg))){let e=RegExp("^"+t.replace(/:\w+/,"\\w+")+"$");if(e.test(location.pathname)){console.log(`Route matched: '${t}' for '${location.pathname}'`),n();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=p(),x().prependTo(".t1"),E().appendTo(document.body),/** Prepare 10 year video autoplay on scroll in */function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
e.muted=!0,e.controls=!1,new IntersectionObserver(t=>{1!=t.length&&console.warn(`Expected 1 entry, got ${t.length}`),t.forEach(t=>{t.isIntersecting?(e.play(),e.controls=!0):e.pause()})},{threshold:0,rootMargin:"-50% 0% -40%"}).observe(e)}(),m("#logo",{width:["100vmin","100px"]},{timeRange:"exit 0% 50%",fill:"both",easing:"linear"}),m(".logoWrap",{height:["80lvh","100px"]},{timeRange:"exit 10% 100%",fill:"both",easing:"linear"}),m(".upcomingCover",[{visibility:"visible",opacity:1},{visibility:"hidden",opacity:0}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),m("nav",[{visibility:"hidden",opacity:0},{visibility:"visible",opacity:1}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),m(".posters",// { marginTop: ["0%", "-120%"] },
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(w("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new $,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}async function ev(){x().appendTo(document.body),(await eu()).appendTo(document.body),E().appendTo(document.body)}async function ey(){x().appendTo(document.body),(await eo()).appendTo(document.body),E().appendTo(document.body)}