...
// via an object.
(r=t[i]||t.getAttribute&&t.getAttribute(i))&&o.setAttribute(i,r);n.head.appendChild(o).parentNode.removeChild(o)}function v(e){return null==e?e+"":"object"==typeof e||"function"==typeof e?u[c.call(e)]||"object":typeof e}/* global Symbol */// Defining this global in .eslintrc.json would create a danger of using the global
...
push:a,sort:i.sort,splice:i.splice},E.extend=E.fn.extend=function(){var e,t,n,i,r,o,s=arguments[0]||{},a=1,l=arguments.length,u=!1;for("boolean"==typeof s&&(u=s,// Skip the boolean and the target
s=arguments[a]||{},a++),"object"==typeof s||f(s)||(s={}),a===l&&(s=this,a--);a<l;a++)// Only deal with non-null/undefined values
if(null!=(e=arguments[a]))for(t in e)i=e[t],"__proto__"!==t&&s!==i&&(u&&i&&(E.isPlainObject(i)||(r=Array.isArray(i)))?(n=s[t],o=r&&!Array.isArray(n)?[]:r||E.isPlainObject(n)?n:{},r=!1,// Never move original objects, clone them
s[t]=E.extend(u,o,i)):void 0!==i&&(s[t]=i));// Return the modified object
...
E.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(e,t){u["[object "+t+"]"]=t.toLowerCase()});var I=i.pop,x=i.sort,S=i.splice,k="[\\x20\\t\\r\\n\\f]",Q=RegExp("^"+k+"+|((?:^|[^\\\\])(?:\\\\.)*)"+k+"+$","g");// Note: an element does not contain itself
...
var T=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function q(e,t){return t?// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}E.escapeSelector=function(e){return(e+"").replace(T,q)},function(){var t,n,r,s,u,c,F,d,f,p,g=a,m=E.expando,v=0,y=0,b=ee(),C=ee(),T=ee(),q=ee(),R=function(e,t){return e===t&&(u=!0),0},U="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
...
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+V+"))|)"+k+"*\\]",M=":("+V+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+L+")*)|.*)\\)|)",z=RegExp(k+"+","g"),P=RegExp("^"+k+"*,"+k+"*"),K=RegExp("^"+k+"*([>+~]|"+k+")"+k+"*"),Z=RegExp(k+"|>"),D=new RegExp(M),W=RegExp("^"+V+"$"),N={ID:RegExp("^#("+V+")"),CLASS:RegExp("^\\.("+V+")"),TAG:RegExp("^("+V+"|[*])"),ATTR:RegExp("^"+L),PSEUDO:RegExp("^"+M),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+k+"*(even|odd|(([+-]|)(\\d*)n|)"+k+"*(?:([+-]|)"+k+"*(\\d+)|))"+k+"*\\)|)","i"),bool:RegExp("^(?:"+U+")$","i"),// For use in libraries implementing .is()
// We use this for POS matching in `select`
needsContext:RegExp("^"+k+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+k+"*((?:-\\d)?\\d*)"+k+"*\\)|)(?=[^-]|$)","i")},H=/^(?:input|select|textarea|button)$/i,O=/^h\d$/i,j=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,G=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
...
// error in IE/Edge.
Y=function(){es()},_=ec(function(e){return!0===e.disabled&&w(e,"fieldset")},{dir:"parentNode",next:"legend"});// Optimize for push.apply( _, NodeList )
try{g.apply(i=o.call(A.childNodes),A.childNodes),// Support: Android <=4.0
// Detect silently failing push.apply
// eslint-disable-next-line no-unused-expressions
i[A.childNodes.length].nodeType}catch(e){g={apply:function(e,t){a.apply(e,o.call(t))},call:function(e){a.apply(e,o.call(arguments,1))}}}function $(e,t,n,i){var r,o,s,a,l,u,B,F=t&&t.ownerDocument,p=t?t.nodeType:9;// Return early from calls with invalid selector or context
...
if(11!==p&&(l=j.exec(e))){// ID selector
...
if(F&&(s=F.getElementById(r))&&$.contains(t,s)&&s.id===r)return g.call(n,s),n}else if(l[2])return g.apply(n,t.getElementsByTagName(e)),n;else if((r=l[3])&&t.getElementsByClassName)return g.apply(n,t.getElementsByClassName(r)),n}// Take advantage of querySelectorAll
...
if(B=e,F=t,1===p&&(Z.test(e)||K.test(e))){for(// Expand context for sibling selectors
(F=G.test(e)&&eo(t.parentNode)||t)==t&&h.scope||((a=t.getAttribute("id"))?a=E.escapeSelector(a):t.setAttribute("id",a=m)),o=// Prefix every selector in the list
(u=el(e)).length;o--;)u[o]=(a?"#"+a:":scope")+" "+eu(u[o]);B=u.join(",")}try{return g.apply(n,F.querySelectorAll(B)),n}catch(t){q(e,!0)}finally{a===m&&t.removeAttribute("id")}}}// All others
return eh(e.replace(Q,"$1"),t,n,i)}/**
 ...
 */function es(e){var t,i=e?e.ownerDocument||e:A;return i!=c&&9===i.nodeType&&i.documentElement&&(F=// Update global variables
...
h.getById=en(function(e){return F.appendChild(e).id=E.expando,!c.getElementsByName||!c.getElementsByName(E.expando).length}),// Support: IE 9 only
...
for(t in $.matches=function(e,t){return $(e,null,null,t)},$.matchesSelector=function(e,t){if(es(e),d&&!q[t+" "]&&(!f||!f.test(t)))try{var n=p.call(e,t);// IE 9's matchesSelector returns false on disconnected nodes
if(n||h.disconnectedMatch||// As well, disconnected nodes are said to be in a document
// fragment in IE 9
e.document&&11!==e.document.nodeType)return n}catch(e){q(t,!0)}return $(t,c,null,[e]).length>0},$.contains=function(e,t){return(e.ownerDocument||e)!=c&&es(e),E.contains(e,t)},$.attr=function(e,t){// Set document vars if needed
// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(e.ownerDocument||e)!=c&&es(e);var i=n.attrHandle[t.toLowerCase()],r=i&&B.call(n.attrHandle,t.toLowerCase())?i(e,t,!d):void 0;return void 0!==r?r:e.getAttribute(t)},$.error=function(e){throw Error("Syntax error, unrecognized expression: "+e)},/**
...
u=!h.sortStable,s=!h.sortStable&&o.call(e,0),x.call(e,R),u){for(;t=e[r++];)t===e[r]&&(i=n.push(r));for(;i--;)S.call(e,n[i],1)}return(// Clear input after sorting to release objects
...
e[4]=+(e[4]?e[5]+(e[6]||1):2*("even"===e[3]||"odd"===e[3])),e[5]=+(e[7]+e[8]||"odd"===e[3])):e[3]&&$.error(e[0]),e)},PSEUDO:function(e){var t,n=!e[6]&&e[2];return N.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":n&&D.test(n)&&// Get excess from tokenize (recursively)
(t=el(n,!0))&&// advance to the next closing parenthesis
(t=n.indexOf(")",n.length-t)-n.length)&&(// excess is a negative index
e[0]=e[0].slice(0,t),e[2]=n.slice(0,t)),e.slice(0,3))}},filter:{TAG:function(e){var t=e.replace(X,J).toLowerCase();return"*"===e?function(){return!0}:function(e){return w(e,t)}},CLASS:function(e){var t=b[e+" "];return t||(t=RegExp("(^|"+k+")"+e+"("+k+"|$)"),b(e,function(e){return t.test("string"==typeof e.className&&e.className||void 0!==e.getAttribute&&e.getAttribute("class")||"")}))},ATTR:function(e,t,n){return function(i){var r=$.attr(i,e);return null==r?"!="===t:!t||((r+="","="===t)?r===n:"!="===t?r!==n:"^="===t?n&&0===r.indexOf(n):"*="===t?n&&r.indexOf(n)>-1:"$="===t?n&&r.slice(-n.length)===n:"~="===t?(" "+r.replace(z," ")+" ").indexOf(n)>-1:"|="===t&&(r===n||r.slice(0,n.length+1)===n+"-"))}},CHILD:function(e,t,n,i,r){var o="nth"!==e.slice(0,3),s="last"!==e.slice(-4),a="of-type"===t;return 1===i&&0===r?function(e){return!!e.parentNode}:function(t,n,l){var u,c,B,F,d,h=o!==s?"nextSibling":"previousSibling",f=t.parentNode,p=a&&t.nodeName.toLowerCase(),A=!l&&!a,g=!1;if(f){// :(first|last|only)-(child|of-type)
...
if(d=[s?f.firstChild:f.lastChild],s&&A){for(g=(F=(u=// Seek `elem` from a previously-cached index
(c=f[m]||(f[m]={}))[e]||[])[0]===v&&u[1])&&u[2],B=F&&f.childNodes[F];B=++F&&B&&B[h]||// Fallback to seeking `elem` from the start
(g=F=0)||d.pop();)if(1===B.nodeType&&++g&&B===t){c[e]=[v,F,g];break}}else // xml :nth-child(...)
// or :nth-last-child(...) or :nth(-last)?-of-type(...)
if(A&&(g=F=(u=(c=t[m]||(t[m]={}))[e]||[])[0]===v&&u[1]),!1===g)// Use the same loop as above to seek `elem` from the start
for(;(B=++F&&B&&B[h]||(g=F=0)||d.pop())&&(!((a?w(B,p):1===B.nodeType)&&++g)||(A&&((c=B[m]||(B[m]={}))[e]=[v,g]),B!==t)););return(// Incorporate the offset, then check against cycle size
...
var t=[],n=[],i=ed(e.replace(Q,"$1"));return i[m]?et(function(e,t,n,r){// Match elements unmatched by `matcher`
...
lang:et(function(e){return W.test(e||"")||$.error("unsupported lang: "+e),e=e.replace(X,J).toLowerCase(),function(t){var n;do if(n=d?t.lang:t.getAttribute("xml:lang")||t.getAttribute("lang"))return(n=n.toLowerCase())===e||0===n.indexOf(e+"-");while((t=t.parentNode)&&1===t.nodeType)return!1}}),// Miscellaneous
...
header:function(e){return O.test(e.nodeName)},input:function(e){return H.test(e.nodeName)},button:function(e){return w(e,"input")&&"button"===e.type||w(e,"button")},text:function(e){var t;return w(e,"input")&&"text"===e.type&&// Support: IE <10 only
...
function ea(){}function el(e,t){var i,r,o,s,a,l,u,c=C[e+" "];if(c)return t?0:c.slice(0);for(a=e,l=[],u=n.preFilter;a;){// Filters
for(s in(!i||(r=P.exec(a)))&&(r&&(a=a.slice(r[0].length)||a),l.push(o=[])),i=!1,(r=K.exec(a))&&(i=r.shift(),o.push({value:i,// Cast descendant combinators to space
type:r[0].replace(Q," ")}),a=a.slice(i.length)),n.filter)(r=N[s].exec(a))&&(!u[s]||(r=u[s](r)))&&(i=r.shift(),o.push({value:i,type:s,matches:r}),a=a.slice(i.length));if(!i)break}return(// Return the length of the invalid excess
// if we're just parsing
// Otherwise, throw an error or return tokens
t?a.length:a?$.error(e):C(e,l).slice(0))}function eu(e){for(var t=0,n=e.length,i="";t<n;t++)i+=e[t].value;return i}function ec(e,t,n){var i=t.dir,r=t.next,o=r||i,s=n&&"parentNode"===o,a=y++;return t.first?function(t,n,r){for(;t=t[i];)if(1===t.nodeType||s)return e(t,n,r);return!1}:function(t,n,l){var u,c,B=[v,a];// We can't set arbitrary data on XML nodes, so they don't benefit from combinator caching
if(l){for(;t=t[i];)if((1===t.nodeType||s)&&e(t,n,l))return!0}else for(;t=t[i];)if(1===t.nodeType||s){if(c=t[m]||(t[m]={}),r&&w(t,r))t=t[i]||t;else{if((u=c[o])&&u[0]===v&&u[1]===a)return B[2]=u[2];// A match means we're done; a fail means we have to keep checking
if(// Reuse newcache so results back-propagate to previous elements
c[o]=B,B[2]=e(t,n,l))return!0}}return!1}}function eB(e){return e.length>1?function(t,n,i){for(var r=e.length;r--;)if(!e[r](t,n,i))return!1;return!0}:e[0]}function eF(e,t,n,i,r){for(var o,s=[],a=0,l=e.length,u=null!=t;a<l;a++)(o=e[a])&&(!n||n(o,i,r))&&(s.push(o),u&&t.push(a));return s}function ed(e,t/* Internal Use Only */){var i,o,s,a,u=[],B=[],F=T[e+" "];if(!F){for(t||(t=el(e)),a=t.length;a--;)(F=function e(t){for(var i,o,s,a=t.length,u=n.relative[t[0].type],c=u||n.relative[" "],B=u?1:0,F=ec(function(e){return e===i},c,!0),d=ec(function(e){return l.call(i,e)>-1},c,!0),h=[function(e,t,n){// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
var o=!u&&(n||t!=r)||((i=t).nodeType?F(e,t,n):d(e,t,n));return(// Avoid hanging onto element
// (see https://github.com/jquery/sizzle/issues/299)
i=null,o)}];B<a;B++)if(o=n.relative[t[B].type])h=[ec(eB(h),o)];else{// Return special upon seeing a positional matcher
if((o=n.filter[t[B].type].apply(null,t[B].matches))[m]){for(// Find the next relative operator (if any) for proper handling
s=++B;s<a&&!n.relative[t[s].type];s++);return function e(t,n,i,r,o,s){return r&&!r[m]&&(r=e(r)),o&&!o[m]&&(o=e(o,s)),et(function(e,s,a,u){var c,B,F,d,h=[],f=[],p=s.length,A=e||function(e,t,n){for(var i=0,r=t.length;i<r;i++)$(e,t[i],n);return n}(n||"*",a.nodeType?[a]:a,[]),m=t&&(e||!n)?eF(A,h,t,a,u):A;// Apply postFilter
if(i?// Find primary matches
i(m,// If we have a postFinder, or filtered seed, or non-seed postFilter
// or preexisting results,
d=o||(e?t:p||r)?[]:s,a,u):d=m,r)for(c=eF(d,f),r(c,[],a,u),// Un-match failing elements by moving them back to matcherIn
B=c.length;B--;)(F=c[B])&&(d[f[B]]=!(m[f[B]]=F));if(e){if(o||t){if(o){for(// Get the final matcherOut by condensing this intermediate into postFinder contexts
c=[],B=d.length;B--;)(F=d[B])&&c.push(m[B]=F);o(null,d=[],c,u)}for(// Move matched elements from seed to results to keep them synchronized
B=d.length;B--;)(F=d[B])&&(c=o?l.call(e,F):h[B])>-1&&(e[c]=!(s[c]=F))}}else d=eF(d===s?d.splice(p,d.length):d),o?o(null,s,d,u):g.apply(s,d)})}(B>1&&eB(h),B>1&&eu(t.slice(0,B-1).concat({value:" "===t[B-2].type?"*":""})).replace(Q,"$1"),o,B<s&&e(t.slice(B,s)),s<a&&e(t=t.slice(s)),s<a&&eu(t))}h.push(o)}return eB(h)}(t[a]))[m]?u.push(F):B.push(F);// Save selector and tokenization
// Cache the compiled function
(F=T(e,(i=u.length>0,o=B.length>0,s=function(e,t,s,a,l){var F,h,f,p=0,A="0",m=e&&[],y=[],b=r,C=e||o&&n.find.TAG("*",l),w=v+=null==b?1:Math.random()||.1,x=C.length;// Add elements passing elementMatchers directly to results
...
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(r=t==c||t||l);A!==x&&null!=(F=C[A]);A++){if(o&&F){for(h=0,t||F.ownerDocument==c||(es(F),s=!d);f=B[h++];)if(f(F,t||c,s)){g.call(a,F);break}l&&(v=w)}// Track unmatched elements for set filters
i&&((F=!f&&F)&&p--,e&&m.push(F))}// Apply set filters to unmatched elements
...
p+=A,i&&A!==p){for(h=0;f=u[h++];)f(m,y,t,s);if(e){// Reintegrate element matches to eliminate the need for sorting
if(p>0)for(;A--;)m[A]||y[A]||(y[A]=I.call(a));// Discard index placeholder values to get only actual matches
y=eF(y)}// Add matches to results
g.apply(a,y),l&&!e&&y.length>0&&p+u.length>1&&E.uniqueSort(a)}return l&&(v=w,r=b),m},i?et(s):s))).selector=e}return F}/**
 ...
 */function eh(e,t,i,r){var o,s,a,l,u,c="function"==typeof e&&e,B=!r&&el(e=c.selector||e);// Try to minimize operations if there is only one selector in the list and no seed
// (the latter of which guarantees us context)
if(i=i||[],1===B.length){if(// Reduce context if the leading compound selector is an ID
(s=B[0]=B[0].slice(0)).length>2&&"ID"===(a=s[0]).type&&9===t.nodeType&&d&&n.relative[s[1].type]){if(!(t=(n.find.ID(a.matches[0].replace(X,J),t)||[])[0]))return i;c&&(t=t.parentNode),e=e.slice(s.shift().value.length)}for(// Fetch a seed set for right-to-left matching
o=N.needsContext.test(e)?0:s.length;// Abort if we hit a combinator
o--&&(a=s[o],!n.relative[l=a.type]);)if((u=n.find[l])&&(r=u(a.matches[0].replace(X,J),G.test(s[0].type)&&eo(t.parentNode)||t))){if(// If seed is empty or no tokens remain, we can return early
s.splice(o,1),!(e=r.length&&eu(s)))return g.apply(i,r),i;break}}return(// Compile and execute a filtering function if one is not provided
// Provide `match` to avoid retokenization if we modified the selector above
(c||ed(e,B))(r,t,!d,i,!t||G.test(e)&&eo(t.parentNode)||t),i)}ea.prototype=n.filters=n.pseudos,n.setFilters=new ea,// One-time assignments
...
if((i="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:P.exec(e))&&(i[1]||!t)){// HANDLE: $(html) -> $(array)
...
z=E(A);var K=/^(?:parents|prev(?:Until|All))/,Z={children:!0,contents:!0,next:!0,prev:!0};function D(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}E.fn.extend({has:function(e){var t=E(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(E.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,r=this.length,o=[],s="string"!=typeof e&&E(e);// Positional selectors never match, since there's no _selection_ context
...
r(e.contentDocument)?e.contentDocument:(w(e,"template")&&(e=e.content||e),E.merge([],e.childNodes))}},function(e,t){E.fn[e]=function(n,i){var r=E.map(this,t,n);return"Until"!==e.slice(-5)&&(i=n),i&&"string"==typeof i&&(r=E.filter(i,r)),this.length>1&&(Z[e]||E.uniqueSort(r),K.test(e)&&r.reverse()),this.pushStack(r)}});var W=/[^\x20\t\r\n\f]+/g;function N(e){return e}function H(e){throw e}function O(e,t,n,i){var r;try{// Check for promise aspect first to privilege synchronous behavior
...
e="string"==typeof e?(t=e,n={},E.each(t.match(W)||[],function(e,t){n[t]=!0}),n):E.extend({},e);var t,n,i,r,o,s,a=[],l=[],u=-1,c=function(){for(// Enforce single-firing
...
u=a.length,r=!1);e.memory||(r=!1),i=!1,s&&(a=r?[]:"")},B={// Add a callback or a collection of callbacks to the list
add:function(){return a&&(r&&!i&&(u=a.length-1,l.push(r)),function t(n){E.each(n,function(n,i){f(i)?e.unique&&B.has(i)||a.push(i):i&&i.length&&"string"!==v(i)&&t(i)})}(arguments),r&&!i&&c()),this},// Remove a callback from the list
remove:function(){return E.each(arguments,function(e,t){for(var n;(n=E.inArray(t,a,n))>-1;)a.splice(n,1),n<=u&&u--}),this},// Check if a given callback is in the list.
...
("object"==typeof e||"function"==typeof e)&&e.then)?r?u.call(e,s(o,n,N,r),s(o,n,H,r)):(// ...and disregard older resolution values
o++,u.call(e,s(o,n,N,r),s(o,n,H,r),s(o,n,N,n.notifyWith))):(i!==N&&(a=void 0,l=[e]),// Process the value(s)
// Default process is resolve
(r||n.resolveWith)(a,l))}},c=r?u:function(){try{u()}catch(e){E.Deferred.exceptionHook&&E.Deferred.exceptionHook(e,c.error),t+1>=o&&(i!==H&&(a=void 0,l=[e]),n.rejectWith(a,l))}};// Support: Promises/A+ section 2.3.3.3.1
...
n[2][3].add(s(0,e,f(i)?i:H))}).promise()},// Get a promise for this deferred
...
var j=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;// If `jQuery.Deferred.getErrorHook` is defined, `asyncError` is an error
// captured before the async barrier to get the original error cause
// which may otherwise be hidden.
E.Deferred.exceptionHook=function(t,n){// Support: IE 8 - 9 only
// Console exists when dev tools are open, which can happen at any time
e.console&&e.console.warn&&t&&j.test(t.name)&&e.console.warn("jQuery.Deferred exception: "+t.message,t.stack,n)},E.readyException=function(t){e.setTimeout(function(){throw t})};// The deferred used on DOM ready
...
var J=function(e,t,n,i,r,o,s){var a=0,l=e.length,u=null==n;// Sets many values
if("object"===v(n))for(a in r=!0,n)J(e,t,a,n[a],!0,o,s);else if(void 0!==i&&(r=!0,f(i)||(s=!0),u&&(s?(t.call(e,i),t=null):(u=t,t=function(e,t,n){return u.call(E(e),n)})),t))for(;a<l;a++)t(e[a],n,s?i:i.call(e[a],a,t(e[a],n)));return r?e:u?t.call(e):l?t(e[0],n):o},Y=/^-ms-/,_=/-([a-z])/g;// Used by camelCase as callback to replace()
...
promise:function(e,t){var n,i=1,r=E.Deferred(),o=this,s=this.length,a=function(){--i||r.resolveWith(o,[o])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";s--;)(n=ei.get(o[s],e+"queueHooks"))&&n.empty&&(i++,n.empty.add(a));return a(),r.promise(t)}});var el=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,eu=RegExp("^(?:([+-])=|)("+el+")([a-z%]*)$","i"),ec=["Top","Right","Bottom","Left"],eB=A.documentElement,eF=function(e){return E.contains(e.ownerDocument,e)},ed={composed:!0};eB.getRootNode&&(eF=function(e){return E.contains(e.ownerDocument,e)||e.getRootNode(ed)===e.ownerDocument});var eh=function(e,t){// Inline style trumps all
...
// in the document.
eF(e)&&"none"===E.css(e,"display")};function ef(e,t,n,i){var r,o,s=20,a=i?function(){return i.cur()}:function(){return E.css(e,t,"")},l=a(),u=n&&n[3]||(E.cssNumber[t]?"":"px"),c=e.nodeType&&(E.cssNumber[t]||"px"!==u&&+l)&&eu.exec(E.css(e,t));if(c&&c[3]!==u){for(// Support: Firefox <=54
...
E.style(e,t,c+u),(1-o)*(1-(o=a()/l||.5))<=0&&(s=0),c/=o;c*=2,E.style(e,t,c+u),// Make sure we update the tween properties later on
n=n||[]}return n&&(c=+c||+l||0,// Apply relative offset (+=/-=) if specified
r=n[1]?c+(n[1]+1)*n[2]:+n[2],i&&(i.unit=u,i.start=c,i.end=r)),r}var ep={};function eA(e,t){// Determine new display value for elements that need to change
...
function eE(e,t){for(var n=0,i=e.length;n<i;n++)ei.set(e[n],"globalEval",!t||ei.get(t[n],"globalEval"))}ey.tbody=ey.tfoot=ey.colgroup=ey.caption=ey.thead,ey.th=ey.td,h.option||(ey.optgroup=ey.option=[1,"<select multiple='multiple'>","</select>"]);var eC=/<|&#?\w+;/;function ew(e,t,n,i,r){for(var o,s,a,l,u,c=t.createDocumentFragment(),B=[],F=0,d=e.length;F<d;F++)if((o=e[F])||0===o){// Add nodes directly
if("object"===v(o))// push.apply(_, arraylike) throws on ancient WebKit
E.merge(B,o.nodeType?[o]:o);else if(eC.test(o)){for(s=s||c.appendChild(t.createElement("div")),a=ey[(em.exec(o)||["",""])[1].toLowerCase()]||ey._default,s.innerHTML=a[1]+E.htmlPrefilter(o)+a[2],// Descend through wrappers to the right content
...
(s=c.firstChild).textContent=""}else B.push(t.createTextNode(o))}for(// Remove wrapper from fragment
c.textContent="",F=0;o=B[F++];){// Skip elements already in the context collection (trac-4087)
if(i&&E.inArray(o,i)>-1){r&&r.push(o);continue}// Capture executables
if(l=eF(o),// Append to fragment
s=eb(c.appendChild(o),"script"),l&&eE(s),n)for(u=0;o=s[u++];)ev.test(o.type||"")&&n.push(o)}return c}var eI=/^([^.]*)(?:\.(.+)|)/;function ex(){return!0}function eS(){return!1}function ek(e,t,n,i,r,o){var s,a;// Types can be a map of types/handlers
...
function eQ(e,t,n){// Missing `isSetup` indicates a trigger call, which must force setup through jQuery.event.add
 ...
 */E.event={global:{},add:function(e,t,n,i,r){var o,s,a,l,u,c,B,F,d,h,f,p=ei.get(e);// Only attach events to objects that accept data
...
return E.event.triggered!==t.type?E.event.dispatch.apply(e,arguments):void 0}),u=// Handle multiple events separated by a space
(t=(t||"").match(W)||[""]).length;u--;)// There *must* be a type, no attaching namespace-only handlers
d=f=(a=eI.exec(t[u])||[])[1],h=(a[2]||"").split(".").sort(),d&&(// If event changes its type, use the special event handlers for the changed type
B=E.event.special[d]||{},// If selector defined, determine special event api type, otherwise given type
d=(r?B.delegateType:B.bindType)||d,// Update special based on newly reset type
B=E.event.special[d]||{},// handleObj is passed to all event handlers
c=E.extend({type:d,origType:f,data:i,handler:n,guid:n.guid,selector:r,needsContext:r&&E.expr.match.needsContext.test(r),namespace:h.join(".")},o),(F=l[d])||((F=l[d]=[]).delegateCount=0,(!B.setup||!1===B.setup.call(e,i,h,s))&&e.addEventListener&&e.addEventListener(d,s)),B.add&&(B.add.call(e,c),c.handler.guid||(c.handler.guid=n.guid)),r?F.splice(F.delegateCount++,0,c):F.push(c),// Keep track of which events have ever been used, for event optimization
E.event.global[d]=!0)},// Detach an event or set of events from an element
remove:function(e,t,n,i,r){var o,s,a,l,u,c,B,F,d,h,f,p=ei.hasData(e)&&ei.get(e);if(p&&(l=p.events)){for(u=// Once for each type.namespace in types; type may be omitted
(t=(t||"").match(W)||[""]).length;u--;){// Unbind all events (on this namespace, if provided) for the element
if(d=f=(a=eI.exec(t[u])||[])[1],h=(a[2]||"").split(".").sort(),!d){for(d in l)E.event.remove(e,d+t[u],n,i,!0);continue}for(B=E.event.special[d]||{},F=l[d=(i?B.delegateType:B.bindType)||d]||[],a=a[2]&&RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),// Remove matching events
s=o=F.length;o--;)c=F[o],(r||f===c.origType)&&(!n||n.guid===c.guid)&&(!a||a.test(c.namespace))&&(!i||i===c.selector||"**"===i&&c.selector)&&(F.splice(o,1),c.selector&&F.delegateCount--,B.remove&&B.remove.call(e,c));s&&!F.length&&(B.teardown&&!1!==B.teardown.call(e,h,p.handle)||E.removeEvent(e,d,p.handle),delete l[d])}E.isEmptyObject(l)&&ei.remove(e,"handle events")}},dispatch:function(e){var t,n,i,r,o,s,a=Array(arguments.length),l=E.event.fix(e),u=(ei.get(this,"events")||Object.create(null))[l.type]||[],c=E.event.special[l.type]||{};for(t=1,// Use the fix-ed jQuery.Event rather than the (read-only) native event
...
s=E.event.handlers.call(this,l,u),// Run delegates first; they may want to stop propagation beneath us
...
if(1===u.nodeType&&!("click"===e.type&&!0===u.disabled)){for(n=0,o=[],s={};n<l;n++)void 0===s[// Don't conflict with Object.prototype properties (trac-13203)
r=(i=t[n]).selector+" "]&&(s[r]=i.needsContext?E(r,this).index(u)>-1:E.find(r,this,null,[u]).length),s[r]&&o.push(i);o.length&&a.push({elem:u,handlers:o})}}return(// Add the remaining (directly-bound) handlers
...
return eg.test(t.type)&&t.click&&w(t,"input")&&eQ(t,"click",!0),!1},trigger:function(e){// For mutual compressibility with _default, replace `this` access with a local var.
// `|| data` is dead code meant only to preserve the variable through minification.
var t=this||e;// Return non-false to allow normal event-path propagation
return eg.test(t.type)&&t.click&&w(t,"input")&&eQ(t,"click"),!0},// For cross-browser consistency, suppress native .click() on links
...
eQ(this,e,!0),!A.documentMode)return!1;// Support: IE 9 - 11+
...
eQ(this,e),!0)},teardown:function(){var e;if(!A.documentMode)return!1;(e=ei.get(this,t)-1)?ei.set(this,t,e):(this.removeEventListener(t,n),ei.remove(this,t))},// Suppress native focus or blur if we're currently inside
...
eT=/<script|<style|<link/i,eq=/checked\s*(?:[^=]|=\s*.checked.)/i,eR=/^\s*<!\[CDATA\[|\]\]>\s*$/g;// Prefer a tbody over its parent table for containing new rows
...
function eV(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function eL(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function eM(e,t){var n,i,r,o,s,a;if(1===t.nodeType){// 1. Copy private data: events, handlers, etc.
...
t=s(t);var r,o,a,l,u,c,B=0,F=e.length,d=F-1,p=t[0],A=f(p);// We can't cloneNode fragments that contain checked, in WebKit
if(A||F>1&&"string"==typeof p&&!h.checkClone&&eq.test(p))return e.each(function(r){var o=e.eq(r);A&&(t[0]=p.call(this,r,o.html())),ez(o,t,n,i)});if(F&&(o=(r=ew(t,e[0].ownerDocument,!1,e,i)).firstChild,1===r.childNodes.length&&(r=o),o||i)){// Use the original fragment for the last item
// instead of the first because it can end up
// being emptied incorrectly in certain situations (trac-8070).
for(l=(a=E.map(eb(r,"script"),eV)).length;B<F;B++)u=r,B!==d&&(u=E.clone(u,!0,!0),l&&// push.apply(_, arraylike) throws on ancient WebKit
E.merge(a,eb(u,"script"))),n.call(e[B],u,B);if(l)// Evaluate executable scripts on first document insertion
for(c=a[a.length-1].ownerDocument,// Re-enable scripts
E.map(a,eL),B=0;B<l;B++)u=a[B],ev.test(u.type||"")&&!ei.access(u,"globalEval")&&E.contains(c,u)&&(u.src&&"module"!==(u.type||"").toLowerCase()?E._evalUrl&&!u.noModule&&E._evalUrl(u.src,{nonce:u.nonce||u.getAttribute("nonce")},c):// needed as in XML documents they're already not visible when
// inspecting element contents and in HTML documents they have no
// meaning but we're preserving that logic for backwards compatibility.
// This will be removed completely in 4.0. See gh-4904.
m(u.textContent.replace(eR,""),u,c))}return e}function eP(e,t,n){for(var i,r=t?E.filter(t,e):e,o=0;null!=(i=r[o]);o++)n||1!==i.nodeType||E.cleanData(eb(i)),i.parentNode&&(n&&eF(i)&&eE(eb(i,"script")),i.parentNode.removeChild(i));return e}E.extend({htmlPrefilter:function(e){return e},clone:function(e,t,n){var i,r,o,s,a=e.cloneNode(!0),l=eF(e);// Fix IE cloning issues
...
if(t){if(n)for(i=0,o=o||eb(e),s=s||eb(a),r=o.length;i<r;i++)eM(o[i],s[i]);else eM(e,a)}// Return the cloned set
...
(n[er.expando]=void 0)}}}),E.fn.extend({detach:function(e){return eP(this,e,!0)},remove:function(e){return eP(this,e)},text:function(e){return J(this,function(e){return void 0===e?E.text(this):this.empty().each(function(){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&(this.textContent=e)})},null,e,arguments.length)},append:function(){return ez(this,arguments,function(e){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&eU(this,e).appendChild(e)})},prepend:function(){return ez(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=eU(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return ez(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return ez(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;null!=(e=this[t]);t++)1===e.nodeType&&(// Prevent memory leaks
...
if("string"==typeof e&&!eT.test(e)&&!ey[(em.exec(e)||["",""])[1].toLowerCase()]){e=E.htmlPrefilter(e);try{for(;n<i;n++)t=this[n]||{},1===t.nodeType&&(E.cleanData(eb(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
return ez(this,arguments,function(t){var n=this.parentNode;0>E.inArray(this,e)&&(E.cleanData(eb(this)),n&&n.replaceChild(t,this));// Force callback invocation
...
a.apply(i,n.get());return this.pushStack(i)}});var eK=RegExp("^("+el+")(?!px)[a-z%]+$","i"),eZ=/^--/,eD=function(t){// Support: IE <=11 only, Firefox <=30 (trac-15098, trac-14150)
...
for(r in i=n.call(e),t)e.style[r]=o[r];return i},eN=RegExp(ec.join("|"),"i");function eH(e,t,n){var i,r,o,s,a=eZ.test(t),// Retrieving style before computed somehow
// fixes an issue with getting wrong values
// on detached elements
l=e.style;return(n=n||eD(e))&&(// Support: IE <=9 - 11+
...
(s=s.replace(Q,"$1")||void 0),""!==s||eF(e)||(s=E.style(e,t)),!h.pixelBoxStyles()&&eK.test(s)&&eN.test(t)&&(// Remember the original values
...
if(c){u.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",c.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%",eB.appendChild(u).appendChild(c);var t=e.getComputedStyle(c);i="1%"!==t.top,// Support: Android 4.0 - 4.3 only, Firefox <=3 - 44
...
c.style.position="absolute",o=12===n(c.offsetWidth/3),eB.removeChild(u),// Nullify the div so it wouldn't be stored in the memory and
// it will also be a sign that checks already performed
c=null}}function n(e){return Math.round(parseFloat(e))}var i,r,o,s,a,l,u=A.createElement("div"),c=A.createElement("div");// Finish early in limited (non-browser) environments
...
var t=e[0].toUpperCase()+e.slice(1),n=ej.length;n--;)if((e=ej[n]+t)in eG)return e}(e)||e)}var // except "table", "table-cell", or "table-caption"
...
var i=eu.exec(t);return i?Math.max(0,i[2]-(n||0))+(i[3]||"px"):t}function e0(e,t,n,i,r,o){var s="width"===t?1:0,a=0,l=0,u=0;// Adjustment may not be necessary
if(n===(i?"border":"content"))return 0;for(;s<4;s+=2)"margin"===n&&(u+=E.css(e,n+ec[s],!0,r)),i?("content"===n&&(l-=E.css(e,"padding"+ec[s],!0,r)),"margin"!==n&&(l-=E.css(e,"border"+ec[s]+"Width",!0,r))):(// Add padding
...
(l+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-o-l-a-.5))||0),l+u}function e1(e,t,n){// Start with computed style
var i=eD(e),r=(!h.boxSizingReliable()||n)&&"border-box"===E.css(e,"boxSizing",!1,i),o=r,s=eH(e,t,i),a="offset"+t[0].toUpperCase()+t.slice(1);// Support: Firefox <=54
...
var r,o,s,a=ee(t),l=eZ.test(t),u=e.style;// Check if we're setting a value
...
s&&"get"in s&&void 0!==(r=s.get(e,!1,i))?r:u[t]);// Make sure that null and NaN values aren't set (trac-7116)
"string"==(o=typeof n)&&(r=eu.exec(n))&&r[1]&&(n=ef(e,t,r),// Fixes bug trac-9237
o="number"),null!=n&&n==n&&("number"!==o||l||(n+=r&&r[3]||(E.cssNumber[a]?"":"px")),h.clearCloneStyle||""!==n||0!==t.indexOf("background")||(u[t]="inherit"),s&&"set"in s&&void 0===(n=s.set(e,n,i))||(l?u.setProperty(t,n):u[t]=n))}},css:function(e,t,n,i){var r,o,s,a=ee(t);return(// Make numeric if forced or a qualifier was provided and val looks numeric
(eZ.test(t)||(t=eJ(a)),// Try prefixed name followed by the unprefixed name
(s=E.cssHooks[t]||E.cssHooks[a])&&"get"in s&&(r=s.get(e,!0,n)),void 0===r&&(r=eH(e,t,i)),"normal"===r&&t in e$&&(r=e$[t]),""===n||n)?(o=parseFloat(r),!0===n||isFinite(o)?o||0:r):r)}}),E.each(["height","width"],function(e,t){E.cssHooks[t]={get:function(e,n,i){if(n)// but it must have a current display style that would benefit
...
delete l.elem}),l=function(){if(r)return!1;for(var t=e5||te(),n=Math.max(0,u.startTime+u.duration-t),i=1-(n/u.duration||0),o=0,s=u.tweens.length;o<s;o++)u.tweens[o].run(i);return(// If there's more to do, yield
(a.notifyWith(e,[u,i,n]),i<1&&s)?n:(s||a.notifyWith(e,[u,1,0]),// Resolve the animation and report its conclusion
a.resolveWith(e,[u]),!1))},u=a.promise({elem:e,props:E.extend({},t),opts:E.extend(!0,{specialEasing:{},easing:E.easing._default},n),originalProperties:t,originalOptions:n,startTime:e5||te(),duration:n.duration,tweens:[],createTween:function(t,n){var i=E.Tween(e,u.opts,t,n,u.opts.specialEasing[t]||u.opts.easing);return u.tweens.push(i),i},stop:function(t){var n=0,// otherwise we skip this part
...
for(n in o=s.expand(o),delete e[i],o)(n in e)||(e[n]=o[n],t[n]=r);else t[i]=r}(c,u.opts.specialEasing);o<s;o++)if(i=ti.prefilters[o].call(u,e,c,u.opts))return f(i.stop)&&(E._queueHooks(u.elem,u.opts.queue).stop=i.stop.bind(i)),i;return E.map(c,tn,u),f(u.opts.start)&&u.opts.start.call(e,u),// Attach callbacks from options
u.progress(u.opts.progress).done(u.opts.done,u.opts.complete).fail(u.opts.fail).always(u.opts.always),E.fx.timer(E.extend(l,{elem:e,anim:u,queue:u.opts.queue})),u}E.Animation=E.extend(ti,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return ef(n.elem,e,eu.exec(t),n),n}]},tweener:function(e,t){f(e)?(t=e,e=["*"]):e=e.match(W);for(var n,i=0,r=e.length;i<r;i++)n=e[i],ti.tweeners[n]=ti.tweeners[n]||[],ti.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var i,r,o,s,a,l,u,c,B="width"in t||"height"in t,F=this,d={},h=e.style,f=e.nodeType&&eh(e),p=ei.get(e,"fxshow");// Detect show/hide animations
...
F.always(function(){s.unqueued--,E.queue(e,"fx").length||s.empty.fire()})})),t)if(r=t[i],e8.test(r)){if(delete t[i],o=o||"toggle"===r,r===(f?"hide":"show")){// Pretend to be hidden if this is a "show" and
...
(u=p&&p.display)&&(u=ei.get(e,"display")),"none"===(c=E.css(e,"display"))&&(u?c=u:(// Get nonempty value(s) by temporarily forcing visibility
eA([e],!0),u=e.style.display||u,c=E.css(e,"display"),eA([e]))),("inline"===c||"inline-block"===c&&null!=u)&&"none"===E.css(e,"float")&&(l||(F.done(function(){h.display=u}),null!=u||(u="none"===(c=h.display)?"":c)),h.display="inline-block")),n.overflow&&(h.overflow="hidden",F.always(function(){h.overflow=n.overflow[0],h.overflowX=n.overflow[1],h.overflowY=n.overflow[2]})),// Implement show/hide animations
l=!1,d)l||(p?"hidden"in p&&(f=p.hidden):p=ei.access(e,"fxshow",{display:u}),o&&(p.hidden=!f),f&&eA([e],!0),/* eslint-disable no-loop-func */F.done(function(){for(i in f||eA([e]),ei.remove(e,"fxshow"),d)E.style(e,i,d[i])})),// Per-property setup
...
o=ta[s],ta[s]=r,r=null!=n(e,t,i)?s:null,ta[s]=o),r}});var tl=/^(?:input|select|textarea|button)$/i,tu=/^(?:a|area)$/i;// Strip and collapse whitespace according to HTML spec
// https://infra.spec.whatwg.org/#strip-and-collapse-ascii-whitespace
function tc(e){return(e.match(W)||[]).join(" ")}function tB(e){return e.getAttribute&&e.getAttribute("class")||""}function tF(e){return Array.isArray(e)?e:"string"==typeof e&&e.match(W)||[]}E.fn.extend({prop:function(e,t){return J(this,E.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[E.propFix[e]||e]})}}),E.extend({prop:function(e,t,n){var i,r,o=e.nodeType;// Don't get/set properties on text, comment and attribute nodes
...
var t=E.find.attr(e,"tabindex");return t?parseInt(t,10):tl.test(e.nodeName)||tu.test(e.nodeName)&&e.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),h.optSelected||(E.propHooks.selected={get:function(e){/* eslint no-unused-expressions: "off" */var t=e.parentNode;return t&&t.parentNode&&t.parentNode.selectedIndex,null},set:function(e){/* eslint no-unused-expressions: "off" */var t=e.parentNode;t&&(t.selectedIndex,t.parentNode&&t.parentNode.selectedIndex)}}),E.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){E.propFix[this.toLowerCase()]=this}),E.fn.extend({addClass:function(e){var t,n,i,r,o,s;return f(e)?this.each(function(t){E(this).addClass(e.call(this,t,tB(this)))}):(t=tF(e)).length?this.each(function(){if(i=tB(this),n=1===this.nodeType&&" "+tc(i)+" "){for(o=0;o<t.length;o++)r=t[o],0>n.indexOf(" "+r+" ")&&(n+=r+" ");i!==// Only assign if different to avoid unneeded rendering.
(s=tc(n))&&this.setAttribute("class",s)}}):this},removeClass:function(e){var t,n,i,r,o,s;return f(e)?this.each(function(t){E(this).removeClass(e.call(this,t,tB(this)))}):arguments.length?(t=tF(e)).length?this.each(function(){if(i=tB(this),// This expression is here for better compressibility (see addClass)
...
try{n=new e.DOMParser().parseFromString(t,"text/xml")}catch(e){}return i=n&&n.getElementsByTagName("parsererror")[0],(!n||i)&&E.error("Invalid XML: "+(i?E.map(i.childNodes,function(e){return e.textContent}).join("\n"):t)),n};var tA=/^(?:focusinfocus|focusoutblur)$/,tg=function(e){e.stopPropagation()};E.extend(E.event,{trigger:function(t,n,i,r){var o,s,a,l,u,c,F,d,h=[i||A],g=B.call(t,"type")?t.type:t,m=B.call(t,"namespace")?t.namespace.split("."):[];// Don't do events on text and comment nodes
...
(m=g.split(".")).shift(),m.sort()),u=0>g.indexOf(":")&&"on"+g,// Trigger bitmask: & 1 for native handlers; & 2 for jQuery (always true)
...
F=E.event.special[g]||{},r||!F.trigger||!1!==F.trigger.apply(i,n))){// Determine event propagation path in advance, per W3C events spec (trac-9951)
// Bubble up to document, then to window; watch for a global ownerDocument var (trac-9724)
if(!r&&!F.noBubble&&!p(i)){for(l=F.delegateType||g,tA.test(l+g)||(s=s.parentNode);s;s=s.parentNode)h.push(s),a=s;a===(i.ownerDocument||A)&&h.push(a.defaultView||a.parentWindow||e)}for(// Fire handlers on the event path
o=0;(s=h[o++])&&!t.isPropagationStopped();)d=s,t.type=o>1?l:F.bindType||g,// jQuery handler
(c=(ei.get(s,"events")||Object.create(null))[t.type]&&ei.get(s,"handle"))&&c.apply(s,n),// Native handler
(c=u&&s[u])&&c.apply&&et(s)&&(t.result=c.apply(s,n),!1===t.result&&t.preventDefault());return t.type=g,!r&&!t.isDefaultPrevented()&&(!F._default||!1===F._default.apply(h.pop(),n))&&et(i)&&u&&f(i[g])&&!p(i)&&(// Don't re-trigger an onFOO event when we call its FOO() method
(a=i[u])&&(i[u]=null),// Prevent re-triggering of the same event, since we already bubbled it above
E.event.triggered=g,t.isPropagationStopped()&&d.addEventListener(g,tg),i[g](),t.isPropagationStopped()&&d.removeEventListener(g,tg),E.event.triggered=void 0,a&&(i[u]=a)),t.result}},// Piggyback on a donor event to simulate a different one
...
return this.name&&!E(this).is(":disabled")&&tb.test(this.nodeName)&&!ty.test(e)&&(this.checked||!eg.test(e))}).map(function(e,t){var n=E(this).val();return null==n?null:Array.isArray(n)?E.map(n,function(e){return{name:t.name,value:e.replace(tv,"\r\n")}}):{name:t.name,value:n.replace(tv,"\r\n")}}).get()}});var tE=/%20/g,tC=/#.*$/,tw=/([?&])_=[^&]*/,tI=/^(.*?):[ \t]*([^\r\n]*)$/mg,tx=/^(?:GET|HEAD)$/,tS=/^\/\//,/* Prefilters
	 ...
	 */tQ={},tT="*/".concat("*"),tq=A.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
...
function tU(e,t,n,i){var r={},o=e===tQ;function s(a){var l;return r[a]=!0,E.each(e[a]||[],function(e,a){var u=a(t,n,i);return"string"!=typeof u||o||r[u]?o?!(l=u):void 0:(t.dataTypes.unshift(u),s(u),!1)}),l}return s(t.dataTypes[0])||!r["*"]&&s("*")}// A special extend for ajax options
...
lastModified:{},etag:{},ajaxSettings:{url:th.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(th.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",/*
		...
		traditional: false,
		headers: {},
		*/accepts:{"*":tT,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},// Data converters
...
ajaxSetup:function(e,t){return t?tV(tV(e,E.ajaxSettings),t):tV(E.ajaxSettings,e)},ajaxPrefilter:tR(tk),ajaxTransport:tR(tQ),// Main method
ajax:function(t,n){"object"==typeof t&&(n=t,t=void 0),// Force options to be an object
n=n||{};var i,r,o,s,a,l,u,c,B,F,d=E.ajaxSetup({},n),h=d.context||d,f=d.context&&(h.nodeType||h.jquery)?E(h):E.event,p=E.Deferred(),g=E.Callbacks("once memory"),m=d.statusCode||{},v={},y={},b="canceled",C={readyState:0,// Builds headers hashtable if needed
getResponseHeader:function(e){var t;if(u){if(!s)for(s={};t=tI.exec(o);)s[t[1].toLowerCase()+" "]=(s[t[1].toLowerCase()+" "]||[]).concat(t[2]);t=s[e.toLowerCase()+" "]}return null==t?null:t.join(", ")},// Raw string
getAllResponseHeaders:function(){return u?o:null},// Caches the header
setRequestHeader:function(e,t){return null==u&&(v[e=y[e.toLowerCase()]=y[e.toLowerCase()]||e]=t),this},// Overrides response content-type header
overrideMimeType:function(e){return null==u&&(d.mimeType=e),this},// Status-dependent callbacks
statusCode:function(e){var t;if(e){if(u)C.always(e[C.status]);else for(t in e)m[t]=[m[t],e[t]]}return this},// Cancel the request
...
d.url=((t||d.url||th.href)+"").replace(tS,th.protocol+"//"),// Alias method option to type as per ticket trac-12004
d.type=n.method||n.type||d.method||d.type,// Extract dataTypes list
d.dataTypes=(d.dataType||"*").toLowerCase().match(W)||[""],null==d.crossDomain){l=A.createElement("a");// Support: IE <=8 - 11, Edge 12 - 15
// IE throws exception on accessing the href property if url is malformed,
// e.g. http://example.com:80x/
try{l.href=d.url,// Support: IE <=8 - 11 only
// Anchor's host property isn't correctly set when s.url is relative
l.href=l.href,d.crossDomain=tq.protocol+"//"+tq.host!=l.protocol+"//"+l.host}catch(e){// If there is an error parsing the URL, assume it is crossDomain,
...
tU(tk,d,n,C),u)return C;// Check for headers option
...
F=d.url.slice(r.length),d.data&&(d.processData||"string"==typeof d.data)&&(r+=(tp.test(r)?"&":"?")+d.data,// trac-9682: remove data so that it's not used in an eventual retry
delete d.data),!1===d.cache&&(r=r.replace(tw,"$1"),F=(tp.test(r)?"&":"?")+"_="+tf.guid+++F),// Put hash and anti-cache on the URL that will be requested (gh-1732)
d.url=r+F),d.ifModified&&(E.lastModified[r]&&C.setRequestHeader("If-Modified-Since",E.lastModified[r]),E.etag[r]&&C.setRequestHeader("If-None-Match",E.etag[r])),(d.data&&d.hasContent&&!1!==d.contentType||n.contentType)&&C.setRequestHeader("Content-Type",d.contentType),// Set the Accepts header for the server, depending on the dataType
C.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+tT+"; q=0.01":""):d.accepts["*"]),d.headers)C.setRequestHeader(B,d.headers[B]);// Allow custom headers/mimetypes and early abort
if(d.beforeSend&&(!1===d.beforeSend.call(h,C,d)||u))return C.abort();// If no transport, we auto-abort
if(// Aborting is no longer a cancellation
b="abort",// Install callbacks on deferreds
g.add(d.complete),C.done(d.success),C.fail(d.error),// Get transport
i=tU(tQ,d,n,C)){// If request was aborted inside ajaxSend, stop there
if(C.readyState=1,c&&f.trigger("ajaxSend",[C,d]),u)return C;d.async&&d.timeout>0&&(a=e.setTimeout(function(){C.abort("timeout")},d.timeout));try{u=!1,i.send(v,w)}catch(e){// Rethrow post-completion exceptions
if(u)throw e;// Propagate others as results
w(-1,e)}}else w(-1,"No Transport");// Callback for when everything is done
function w(t,n,s,l){var B,F,A,v,y,b=n;// Ignore repeat invocations
...
if(o)return o!==l[0]&&l.unshift(o),n[o]}(d,C,s)),!B&&E.inArray("script",d.dataTypes)>-1&&0>E.inArray("json",d.dataTypes)&&(d.converters["text script"]=function(){}),// Convert no matter what (that way responseXXX fields are always set)
...
if(s&&e.throws)t=s(t);else try{t=s(t)}catch(e){return{state:"parsererror",error:s?e:"No conversion from "+l+" to "+o}}}}}return{state:"success",data:t}}(d,v,C,B),B?(d.ifModified&&((y=C.getResponseHeader("Last-Modified"))&&(E.lastModified[r]=y),(y=C.getResponseHeader("etag"))&&(E.etag[r]=y)),204===t||"HEAD"===d.type?b="nocontent":304===t?b="notmodified":(b=v.state,F=v.data,B=!(A=v.error))):(// Extract error from statusText and normalize for non-aborts
A=b,(t||!b)&&(b="error",t<0&&(t=0))),// Set data for the fake xhr object
C.status=t,C.statusText=(n||b)+"",B?p.resolveWith(h,[F,b,C]):p.rejectWith(h,[C,b,A]),// Status-dependent callbacks
C.statusCode(m),m=void 0,c&&f.trigger(B?"ajaxSuccess":"ajaxError",[C,d,B?F:A]),// Complete
g.fireWith(h,[C,b]),!c||(f.trigger("ajaxComplete",[C,d]),--E.active||E.event.trigger("ajaxStop")))}return C},getJSON:function(e,t,n){return E.get(e,t,n,"json")},getScript:function(e,t){return E.get(e,void 0,t,"script")}}),E.each(["get","post"],function(e,t){E[t]=function(e,n,i,r){// The url can be an options object (which then must have .url)
...
1223:204},tM=E.ajaxSettings.xhr();h.cors=!!tM&&"withCredentials"in tM,h.ajax=tM=!!tM,E.ajaxTransport(function(t){var n,i;// Cross domain only allowed if supported through XMLHttpRequest
if(h.cors||tM&&!t.crossDomain)return{send:function(r,o){var s,a=t.xhr();// Apply custom fields if provided
...
A.head.appendChild(t[0])},abort:function(){n&&n()}}}});var tz=[],tP=/(=)\?(?=&|$)|\?\?/;// Default jsonp settings
...
E.ajaxPrefilter("json jsonp",function(t,n,i){var r,o,s,a=!1!==t.jsonp&&(tP.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&tP.test(t.data)&&"data");// Handle iff the expected data type is "jsonp" or we have a parameter to set
if(a||"jsonp"===t.dataTypes[0])// Delegate to script
return(// Get callback name, remembering preexisting value associated with it
r=t.jsonpCallback=f(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,a?t[a]=t[a].replace(tP,"$1"+r):!1!==t.jsonp&&(t.url+=(tp.test(t.url)?"&":"?")+t.jsonp+"="+r),// Use data converter to retrieve json after script execution
...
}).always(n&&function(e,t){s.each(function(){n.apply(this,o||[e.responseText,t,e])})}),this},E.expr.pseudos.animated=function(e){return E.grep(E.timers,function(t){return e===t.elem}).length},E.offset={setOffset:function(e,t,n){var i,r,o,s,a,l,u=E.css(e,"position"),c=E(e),B={};"static"===u&&(e.style.position="relative"),a=c.offset(),o=E.css(e,"top"),l=E.css(e,"left"),("absolute"===u||"fixed"===u)&&(o+l).indexOf("auto")>-1?(s=(i=c.position()).top,r=i.left):(s=parseFloat(o)||0,r=parseFloat(l)||0),f(t)&&(t=t.call(e,n,E.extend({},a))),null!=t.top&&(B.top=t.top-a.top+s),null!=t.left&&(B.left=t.left-a.left+r),"using"in t?t.using.call(e,B):c.css(B)}},E.fn.extend({// offset() relates an element's border box to the document origin
...
return n=eH(e,t),eK.test(n)?E(e).position()[t]+"px":n})}),// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
...
!isNaN(e-parseFloat(e))},E.trim=function(e){return null==e?"":(e+"").replace(tK,"$1")},"function"==typeof define&&define.amd&&define("jquery",[],function(){return E});var tZ=e.jQuery,tD=e.$;return E.noConflict=function(t){return e.$===E&&(e.$=tD),t&&e.jQuery===E&&(e.jQuery=tZ),E},void 0===t&&(e.jQuery=e.$=E),E},"object"==typeof a?// is present, execute the factory and get jQuery.
...
let e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}/**
	 ...
	 */destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}constructor(e,t,n,i,r="div"){/**
		 ...
		 * @type {HTMLElement}
		 */this.$name=document.createElement("div"),this.$name.classList.add("name"),z.nextNameID=z.nextNameID||0,this.$name.id=`lil-gui-name-${++z.nextNameID}`,/**
...
this.domElement.addEventListener("keydown",e=>e.stopPropagation()),this.domElement.addEventListener("keyup",e=>e.stopPropagation()),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}}class P extends z{updateDisplay(){return this.$input.checked=this.getValue(),this}constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}}function K(e){let t,n;return(t=e.match(/(#|0x)?([a-f0-9]{6})/i))?n=t[2]:(t=e.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?n=parseInt(t[1]).toString(16).padStart(2,0)+parseInt(t[2]).toString(16).padStart(2,0)+parseInt(t[3]).toString(16).padStart(2,0):(t=e.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(n=t[1]+t[1]+t[2]+t[2]+t[3]+t[3]),!!n&&"#"+n}const Z={isPrimitive:!0,match:e=>"number"==typeof e,fromHexString:e=>parseInt(e.substring(1),16),toHexString:e=>"#"+e.toString(16).padStart(6,0)},D=[{isPrimitive:!0,match:e=>"string"==typeof e,fromHexString:K,toHexString:K},Z,{isPrimitive:!1,// The arrow function is here to appease tree shakers like esbuild or webpack.
// See https://esbuild.github.io/api/#tree-shaking
match:e=>Array.isArray(e),fromHexString(e,t,n=1){let i=Z.fromHexString(e);t[0]=(i>>16&255)/255*n,t[1]=(i>>8&255)/255*n,t[2]=(255&i)/255*n},toHexString([e,t,n],i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return Z.toHexString(r)}},{isPrimitive:!1,match:e=>Object(e)===e,fromHexString(e,t,n=1){let i=Z.fromHexString(e);t.r=(i>>16&255)/255*n,t.g=(i>>8&255)/255*n,t.b=(255&i)/255*n},toHexString({r:e,g:t,b:n},i=1){i=255/i;let r=e*i<<16^t*i<<8^n*i<<0;return Z.toHexString(r)}}];class W extends z{reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){let t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}constructor(e,t,n,i){var r;super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=(r=this.initialValue,D.find(e=>e.match(r))),this._rgbScale=i,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{let e=K(this.$text.value);e&&this._setValueFromHexString(e)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}}class N extends z{constructor(e,t,n){super(e,t,n,"function"),// Buttons are the only case where widget contains name
...
this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class H extends z{decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){let e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=100*t+"%"}return this._inputFocused||(this.$input.value=void 0===this._decimals?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id);// On touch devices only, use input[type=number] to force a numeric keyboard.
...
this.$input.value=this.getValue())},n=!1,i,r,o,s,a,l=e=>{if(n){let t=e.clientX-i,o=e.clientY-r;Math.abs(o)>5?(e.preventDefault(),this.$input.blur(),n=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(t)>5&&u()}// This isn't an else so that the first move counts towards dragDelta
if(!n){let t=e.clientY-o;a-=t*this._step*this._arrowKeyMultiplier(e),s+a>this._max?a=this._max-s:s+a<this._min&&(a=this._min-s),this._snapClampSetValue(s+a)}o=e.clientY},u=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",u)};this.$input.addEventListener("input",()=>{let e=parseFloat(this.$input.value);isNaN(e)||(this._stepExplicit&&(e=this._snap(e)),this.setValue(this._clamp(e)))}),this.$input.addEventListener("keydown",e=>{"Enter"===e.key&&this.$input.blur(),"ArrowUp"===e.code&&(e.preventDefault(),t(this._step*this._arrowKeyMultiplier(e))),"ArrowDown"===e.code&&(e.preventDefault(),t(-(this._step*this._arrowKeyMultiplier(e)*1)))}),this.$input.addEventListener("wheel",e=>{this._inputFocused&&(e.preventDefault(),t(this._step*this._normalizeMouseWheel(e)))},{passive:!1}),this.$input.addEventListener("mousedown",e=>{i=e.clientX,r=o=e.clientY,n=!0,s=this.getValue(),a=0,window.addEventListener("mousemove",l),window.addEventListener("mouseup",u)}),this.$input.addEventListener("focus",()=>{this._inputFocused=!0}),this.$input.addEventListener("blur",()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()})}_initSlider(){let e;this._hasSlider=!0,// Build DOM
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
let t=(e,t,n,i,r)=>(e-t)/(n-t)*(r-i)+i,n=e=>{let n=this.$slider.getBoundingClientRect(),i=t(e,n.left,n.right,this._min,this._max);this._snapClampSetValue(i)},i=e=>{n(e.clientX)},r=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",i),window.removeEventListener("mouseup",r)},o=!1,s,a,l=e=>{e.preventDefault(),this._setDraggingStyle(!0),n(e.touches[0].clientX),o=!1},u=e=>{if(o){let t=e.touches[0].clientX-s,n=e.touches[0].clientY-a;Math.abs(t)>Math.abs(n)?l(e):(// This was, in fact, an attempt to scroll. Abort.
window.removeEventListener("touchmove",u),window.removeEventListener("touchend",c))}else e.preventDefault(),n(e.touches[0].clientX)},c=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",u),window.removeEventListener("touchend",c)},B=this._callOnFinishChange.bind(this);this.$slider.addEventListener("mousedown",e=>{this._setDraggingStyle(!0),n(e.clientX),window.addEventListener("mousemove",i),window.addEventListener("mouseup",r)}),this.$slider.addEventListener("touchstart",e=>{e.touches.length>1||(this._hasScrollBar?(s=e.touches[0].clientX,a=e.touches[0].clientY,o=!0):l(e),window.addEventListener("touchmove",u,{passive:!1}),window.addEventListener("touchend",c))},{passive:!1}),this.$slider.addEventListener("wheel",t=>{// ignore vertical wheels if there's a scrollbar
...
let t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){let e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return void 0!==this._min}get _hasMax(){return void 0!==this._max}constructor(e,t,n,i,r,o){super(e,t,n,"number"),this._initInput(),this.min(i),this.max(r);let s=void 0!==o;this.step(s?o:this._getImplicitStep(),s),this.updateDisplay()}}class O extends z{options(e){return this._values=Array.isArray(e)?e:Object.values(e),this._names=Array.isArray(e)?e:Object.keys(e),this.$select.replaceChildren(),this._names.forEach(e=>{let t=document.createElement("option");t.innerHTML=e,this.$select.appendChild(t)}),this.updateDisplay(),this}updateDisplay(){let e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=-1===t?e:this._names[t],this}constructor(e,t,n,i){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.options(i)}}class j extends z{updateDisplay(){return this.$input.value=this.getValue(),this}constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",e=>{"Enter"===e.code&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}}const G=`.lil-gui {
...
@font-face {
  ...
  src: url("data:application/font-woff;charset=utf-8;base64,") format("woff");
	 ...
	 * @returns {Controller}
	 */add(e,t,n,i,r){if(Object(n)===n)return new O(this,e,t,n);let o=e[t];switch(typeof o){case"number":return new H(this,e,t,n,i,r);case"boolean":return new P(this,e,t);case"string":return new j(this,e,t);case"function":return new N(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,o)}/**
	 ...
	 * @returns {Controller}
	 */addColor(e,t,n=1){return new W(this,e,t,n)}/**
	 ...
	 * @returns {GUI}
	 */addFolder(e){let t=new J({parent:this,title:e});return this.root._closeFolders&&t.close(),t}/**
	 * Recalls values that were saved with `gui.save()`.
	 * @param {object} obj
	 * @param {boolean} recursive Pass false to exclude folders descending from this GUI.
	 * @returns {this}
	 */load(e,t=!0){return e.controllers&&this.controllers.forEach(t=>{!(t instanceof N)&&t._name in e.controllers&&t.load(e.controllers[t._name])}),t&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}/**
	 ...
	 * @param {boolean} recursive Pass false to exclude folders descending from this GUI.
	 * @returns {object}
	 */save(e=!0){let t={controllers:{},folders:{}};return this.controllers.forEach(e=>{if(!(e instanceof N)){if(e._name in t.controllers)throw Error(`Cannot save GUI with duplicate property "${e._name}"`);t.controllers[e._name]=e.save()}}),e&&this.folders.forEach(e=>{if(e._title in t.folders)throw Error(`Cannot save GUI with duplicate folder "${e._title}"`);t.folders[e._title]=e.save()}),t}/**
...
return}this.domElement.classList.add("root"),a&&this.domElement.classList.add("allow-touch-styles"),!X&&s&&(function(e){let t=document.createElement("style");t.innerHTML=e;let n=document.querySelector("head link[rel=stylesheet], head style");n?document.head.insertBefore(t,n):document.head.appendChild(t)}(G),X=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=o}}const Y=()=>/*@__PURE__*/e(a)("<div>",{class:"adminLoginPage"}).append(/*@__PURE__*/e(a)("<h2>",{text:"Admin Section"}),/*@__PURE__*/e(a)("<form>",{action:"/php/adminLogin.php",method:"post"}).append("1"==new URLSearchParams(location.search).get("e")?/*@__PURE__*/e(a)("<span>",{text:"Sorry, invalid credentials. Please try again",class:"errorMsg"}):/*@__PURE__*/e(a)(),/*@__PURE__*/e(a)("<input>",{type:"text",name:"username",placeholder:"Username",autocomplete:"username"}),/*@__PURE__*/e(a)("<input>",{type:"password",name:"password",placeholder:"Password",autocomplete:"current-password"}),/*@__PURE__*/e(a)("<input>",{type:"hidden",name:"redirectTo",value:_()}),/*@__PURE__*/e(a)("<button>",{type:"submit",text:"Login"})//
    .on("click",()=>{// preempt the admin login passing and just set true in case it worked.
    localStorage.setItem("admin","true")}),A()?/*@__PURE__*/e(a)("<button>",{text:"Bypass Login [DEV]",class:"devMode"}).on("click",e=>{e.preventDefault(),localStorage.setItem("admin","true"),window.location.href=_()}):/*@__PURE__*/e(a)()));function _(){return sessionStorage.getItem("adminLoginRedirectTo")||"/"}var $={};function ee(){if("/concert/new"===location.pathname)return function(){let t=new Date().toISOString().replace(/:\d{2}\.\d{3}Z$/,"");return console.log("defaultPoster: now",t),{id:-1,title:"",when:t,poster:/*@__PURE__*/e($),thumb:""}}();let t=/\/concert\/(\d+)/.exec(location.pathname);if(!t)throw Error("Invalid URL for concert viewer page");let n=+t[1];return C.concerts.find(e=>e.id==n)}$=s("4dA5s").getBundleURL("gb8Cc")+"placeholderConcert.b9be78f3.png";const et=()=>{let t=ee();if(!t)throw Error("Concert not found");return /*@__PURE__*/e(a)("<main>",{id:"concertDetailsPage"}).append(ei(t))},en=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Edit",class:"adminButton",href:`/concert/${t.id}/edit`}),/*@__PURE__*/e(a)("<a>",{text:"Delete",class:"adminButton outlined",href:`/php/concertDelete.php?id=${t.id}`}).on("click",e=>{confirm("Are you sure you want to delete this concert?")||e.preventDefault()})),ei=t=>{var n;return /*@__PURE__*/e(a)("<div>",{class:"concertDetails"}).append(E({href:"/archive",text:"\uD83E\uDC84 Back to All Concerts",class:"backButton"}),en({id:t.id}),/*@__PURE__*/e(a)("<div>",{class:"posterWrap"}).append(/*@__PURE__*/e(a)("<img>",{class:"poster",src:t.poster})),/*@__PURE__*/e(a)("<div>").append(/*@__PURE__*/e(a)("<h2>",{text:t.title,class:"title"}),/*@__PURE__*/e(a)("<span>",{text:(n=t.when,Intl.DateTimeFormat("en-GB",{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric",hour12:!0}).format(new Date(n))),class:"when"})),t.facebook?y(t.facebook):/*@__PURE__*/e(a)())};var er={};er=/******/function(e){/******/// The module cache
 ...
 * @param {Noty} ref
 * @return {void}
 */function(e){if(e.options.modal&&r>0&&(t.DocModalCount=r-=1,r<=0)){var n=document.querySelector(".noty_modal");n&&(i.removeClass(n,"noty_modal_open"),i.addClass(n,"noty_modal_close"),i.addListener(n,i.animationEndEvents,function(){i.remove(n)}))}},t.queueClose=F,t.dequeueClose=d,t.fire=h,t.openFlow=/**
 * @param {Noty} ref
 * @return {void}
 ...
 * @param {Noty} ref
 * @return {void}
 */function(e){delete u[e.id],e.closing=!1,h(e,"afterClose"),i.remove(e.barDom),0!==e.layoutDom.querySelectorAll(".noty_bar").length||e.options.container||i.remove(e.layoutDom),(i.inArray("docVisible",e.options.titleCount.conditions)||i.inArray("docHidden",e.options.titleCount.conditions))&&s.decrement(),c(e.options.queue)};var i=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}(n(0));t.PageHidden=!1;var r=t.DocModalCount=0,o={originalTitle:null,count:0,changed:!1},s=t.docTitle={increment:function(){o.count++,s._update()},decrement:function(){if(o.count--,o.count<=0){s._clear();return}s._update()},_update:function(){var e=document.title;o.changed?document.title="("+o.count+") "+o.originalTitle:(o.originalTitle=e,document.title="("+o.count+") "+e,o.changed=!0)},_clear:function(){o.changed&&(o.count=0,document.title=o.originalTitle,o.changed=!1)}},a=t.DefaultMaxVisible=5,l=t.Queues={global:{maxVisible:a,queue:[]}},u=t.Store={};/**
...
var e=setTimeout;return function(){return e(v,1)}}var m=Array(1e3);function v(){for(var e=0;e<u;e+=2)(0,m[e])(m[e+1]),m[e]=void 0,m[e+1]=void 0;u=0}var y=void 0;function b(e,t){var n,i=arguments,r=this,o=new this.constructor(w);void 0===o[C]&&K(o);var s=r._state;return s?(n=i[s-1],F(function(){return z(s,o,n,r._result)})):U(r,o,e,t),o}/**
  ...
  `value`
*/function E(e){if(e&&"object"==typeof e&&e.constructor===this)return e;var t=new this(w);return Q(t,e),t}p?y=function(){return t.nextTick(v)}:f?(r=0,o=new f(v),s=document.createTextNode(""),o.observe(s,{characterData:!0}),y=function(){s.data=r=++r%2}):A?((a=new MessageChannel).port1.onmessage=v,y=function(){return a.port2.postMessage(0)}):y=void 0===d?function(){try{var e=n(9);return c=e.runOnLoop||e.runOnContext,void 0!==c?function(){c(v)}:g()}catch(e){return g()}}():g();var C=Math.random().toString(36).substring(16);function w(){}var I=void 0,x=new L;function S(e){try{return e.then}catch(e){return x.error=e,x}}function k(t,n,i){n.constructor===t.constructor&&i===b&&n.constructor.resolve===E?1===n._state?q(t,n._result):2===n._state?R(t,n._result):U(n,void 0,function(e){return Q(t,e)},function(e){return R(t,e)}):i===x?(R(t,x.error),x.error=null):void 0===i?q(t,n):e(i)?F(function(e){var t=!1,r=function(e,t,n,i){try{e.call(t,n,i)}catch(e){return e}}(i,n,function(i){t||(t=!0,n!==i?Q(e,i):q(e,i))},function(n){t||(t=!0,R(e,n))},"Settle: "+(e._label||" unknown promise"));!t&&r&&(t=!0,R(e,r))},t):q(t,n)}function Q(e,t){if(e===t)R(e,TypeError("You cannot resolve a promise with itself"));else{var n;(n=typeof t,null!==t&&("object"===n||"function"===n))?k(e,t,S(t)):q(e,t)}}function T(e){e._onerror&&e._onerror(e._result),V(e)}function q(e,t){e._state===I&&(e._result=t,e._state=1,0!==e._subscribers.length&&F(V,e))}function R(e,t){e._state===I&&(e._state=2,e._result=t,F(T,e))}function U(e,t,n,i){var r=e._subscribers,o=r.length;e._onerror=null,r[o]=t,r[o+1]=n,r[o+2]=i,0===o&&e._state&&F(V,e)}function V(e){var t=e._subscribers,n=e._state;if(0!==t.length){for(var i=void 0,r=void 0,o=e._result,s=0;s<t.length;s+=3)i=t[s],r=t[s+n],i?z(n,i,r,o):r(o);e._subscribers.length=0}}function L(){this.error=null}var M=new L;function z(t,n,i,r){var o=e(i),s=void 0,a=void 0,l=void 0,u=void 0;if(o){if((s=function(e,t){try{return e(t)}catch(e){return M.error=e,M}}(i,r))===M?(u=!0,a=s.error,s.error=null):l=!0,n===s){R(n,TypeError("A promises callback cannot return that same promise."));return}}else s=r,l=!0;n._state!==I||(o&&l?Q(n,s):u?R(n,a):1===t?q(n,s):2===t&&R(n,s))}var P=0;function K(e){e[C]=P++,e._state=void 0,e._result=void 0,e._subscribers=[]}function Z(e,t){this._instanceConstructor=e,this.promise=new e(w),this.promise[C]||K(this.promise),l(t)?(this.length=t.length,this._remaining=t.length,this._result=Array(this.length),0===this.length?q(this.promise,this._result):(this.length=this.length||0,this._enumerate(t),0===this._remaining&&q(this.promise,this._result))):R(this.promise,Error("Array Methods must be provided an Array"))}/**
  ...
  Useful for tooling.
  @constructor
*/function D(e){this[C]=P++,this._result=this._state=void 0,this._subscribers=[],w!==e&&("function"!=typeof e&&function(){throw TypeError("You must pass a resolver function as the first argument to the promise constructor")}(),this instanceof D?function(e,t){try{t(function(t){Q(e,t)},function(t){R(e,t)})}catch(t){R(e,t)}}(this,e):function(){throw TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.")}())}return Z.prototype._enumerate=function(e){for(var t=0;this._state===I&&t<e.length;t++)this._eachEntry(e[t],t)},Z.prototype._eachEntry=function(e,t){var n=this._instanceConstructor,i=n.resolve;if(i===E){var r=S(e);if(r===b&&e._state!==I)this._settledAt(e._state,t,e._result);else if("function"!=typeof r)this._remaining--,this._result[t]=e;else if(n===D){var o=new n(w);k(o,e,r),this._willSettleAt(o,t)}else this._willSettleAt(new n(function(t){return t(e)}),t)}else this._willSettleAt(i(e),t)},Z.prototype._settledAt=function(e,t,n){var i=this.promise;i._state===I&&(this._remaining--,2===e?R(i,n):this._result[t]=n),0===this._remaining&&q(i,this._result)},Z.prototype._willSettleAt=function(e,t){var n=this;U(e,void 0,function(e){return n._settledAt(1,t,e)},function(e){return n._settledAt(2,t,e)})},D.all=/**
  ...
  @static
*/function(e){return new Z(this,e).promise},D.race=/**
  ...
  promise to settle.
*/function(e){/*jshint validthis:true */var t=this;return new t(l(e)?function(n,i){for(var r=e.length,o=0;o<r;o++)t.resolve(e[o]).then(n,i)}:function(e,t){return t(TypeError("You must pass an array to race."))})},D.resolve=E,D.reject=/**
...
*/function(e){var t=new this(w);return R(t,e),t},D._setScheduler=function(e){B=e},D._setAsap=function(e){F=e},D._asap=F,D.prototype={constructor:D,/**
...
D.polyfill=/*global self*/function(){var e=void 0;if(void 0!==i)e=i;else if("undefined"!=typeof self)e=self;else try{e=Function("return this")()}catch(e){throw Error("polyfill failed because global object is unavailable in this environment")}var t=e.Promise;if(t){var n=null;try{n=Object.prototype.toString.call(t.resolve())}catch(e){// silently ignored
}if("[object Promise]"===n&&!t.cast)return}e.Promise=D},D.Promise=D,D}();//# sourceMappingURL=es6-promise.map
/* WEBPACK VAR INJECTION */}).call(t,n(7),n(8));/***/},/* 5 *//***/function(e,t){// removed by extract-text-webpack-plugin
/***/},/* 6 *//***/function(e,t,n){Object.defineProperty(t,"__esModule",{value:!0});var i,r=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();/* global VERSION */n(5);var o=(i=n(4))&&i.__esModule?i:{default:i},s=c(n(0)),a=c(n(1)),l=n(2),u=n(3);function c(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}var B=function(){/**
   * @param {object} options
   * @return {Noty}
...
return n.call(this,e,0)}}}!function(){try{n="function"==typeof setTimeout?setTimeout:s}catch(e){n=s}try{i="function"==typeof clearTimeout?clearTimeout:a}catch(e){i=a}}();var u=[],c=!1,B=-1;function F(){c&&r&&(c=!1,r.length?u=r.concat(u):B=-1,u.length&&d())}function d(){if(!c){var e=l(F);c=!0;for(var t=u.length;t;){for(r=u,u=[];++B<t;)r&&r[B].run();B=-1,t=u.length}r=null,c=!1,function(e){if(i===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
...
e.exports=n;/***/},/* 9 *//***/function(e,t){/* (ignored) *//***/}]);const eo=t=>{function n(e){e.siblings(".placeholder").toggleClass("hidden",""!=e.text())}let i=/*@__PURE__*/e(a)("<div>",{class:"title"}).append(/*@__PURE__*/e(a)("<span>",{text:"Concert Title",class:"placeholder"}),/*@__PURE__*/e(a)("<h2>",{contenteditable:!0,text:t.val,class:"titleH"})//
.on("input",t=>n(/*@__PURE__*/e(a)(t.target))));return(// initialize state.
n(i.find(".titleH")),i)},es=t=>/*@__PURE__*/e(a)("<div>",{class:"adminControls"}).append(E({text:"Save",class:"adminButton",href:""}).on("click",t=>{let n=/** @returns current gui values to send to server for saving */function(){let t=/*@__PURE__*/e(a)(".titleH").text(),n=/*@__PURE__*/e(a)(".when").val(),i=/*@__PURE__*/e(a)("#fbInput").val(),r=/*@__PURE__*/e(a)(".poster")[0].src,o={id:ee().id,title:t,when:n,poster:r,thumb:r};return i&&(o.facebook=i),o}();console.log("fileControls: Save clicked",n),function(t,n="info"){new/*@__PURE__*/(e(er))({text:"Sex",type:"success"}).show()}(0),t.stopPropagation()}),E({text:"Cancel",class:"adminButton",href:-1==t.id?"/archive":`/concert/${t.id}`}).on("click",e=>{confirm("Are you sure you want to discard changes?")||e.stopPropagation()})),ea=()=>/*@__PURE__*/e(a)("<div>",{class:"posterControlsWrap"}).append(/*@__PURE__*/e(a)("<label>",{text:"⤒ Upload",for:"posterInput"}),/*@__PURE__*/e(a)("<input>",{id:"posterInput",type:"file",accept:"image/png,image/jpeg"}).on("change",e=>{var t;console.log("File changed",null===(t=e.target.files)||void 0===t?void 0:t[0])})),el=t=>/*@__PURE__*/e(a)("<input>",{type:"datetime-local",value:t,class:"when"}),eu=t=>/*@__PURE__*/e(a)("<div>",{class:"fbLink"}).append(v(),/*@__PURE__*/e(a)("<input>",{id:"fbInput",type:"text",value:t.val,placeholder:"Event Link (optional)"}));/*@__PURE__*/e(a)(()=>void(eB(),q(),window.addEventListener(b,eB),window.addEventListener("popstate",eB)));const ec={"/archive":function(){U().appendTo(document.body),m().appendTo(document.body)},"/admin":function(){Y().appendTo(document.body)},"/concert/new":eF,"/concert/:id":function(){w().appendTo(document.body),et().appendTo(document.body),m().appendTo(document.body)},"/concert/:id/edit":eF};function eB(){// find handler
for(let[e,t]of(// reset state if re-using SPA
window.scrollTo(0,0),document.body.innerHTML="",Object.entries(ec))){let n=RegExp("^"+e.replace(/:\w+/,"\\w+")+"$");if(n.test(location.pathname)){console.log(`Route matched: '${e}' for '${location.pathname}'`),t();return}}// default handler
console.log(`Using default home route for ${location.pathname}`),document.body.innerHTML=p(),w().prependTo(".t1"),m().appendTo(document.body),/** Prepare 10 year video autoplay on scroll in */function(){let e=document.querySelector(".tenYears video");if(!e)throw Error("Couldn't find ten year video");if(!(e instanceof HTMLVideoElement))throw Error("Invalid ten year element type");e.currentTime=2,// can only play pause without input event if muted
e.muted=!0,e.controls=!1,new IntersectionObserver(t=>{1!=t.length&&console.warn(`Expected 1 entry, got ${t.length}`),t.forEach(t=>{t.isIntersecting?(e.play(),e.controls=!0):e.pause()})},{threshold:0,rootMargin:"-50% 0% -40%"}).observe(e)}(),g("#logo",{width:["100vmin","100px"]},{timeRange:"exit 0% 50%",fill:"both",easing:"linear"}),g(".logoWrap",{height:["80lvh","100px"]},{timeRange:"exit 10% 100%",fill:"both",easing:"linear"}),g(".upcomingCover",[{visibility:"visible",opacity:1},{visibility:"hidden",opacity:0}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),g("nav",[{visibility:"hidden",opacity:0},{visibility:"visible",opacity:1}],{timeRange:"exit 40% 100%",fill:"both",easing:"linear"}),g(".posters",// { marginTop: ["0%", "-120%"] },
{marginTop:["-25lvh","25lvh"]},{timeRange:"cover 0% 100%",fill:"both",easing:"linear"}),/*@__PURE__*/e(a)("a.primary").eq(0).replaceWith(y("https://www.facebook.com/events/177429568773354")),function(){let e=window.location.hash;if(""!=e){let t=document.querySelector(e);if(t){let e=t.getBoundingClientRect().top;window.scrollTo(0,e)}}}(),function(){if("localhost"==window.location.hostname){let e=new J,t={opacity:100};e.add(t,"opacity",0,100,1).onChange(()=>{document.body.style.setProperty("--debug-opacity",t.opacity+"%")})}}()}function eF(){w().appendTo(document.body),(function(){let e=ee();if(!e)throw Error("Concert not found");console.log(`Editing concert ${e.id}`);// Start with the viewer page and modify it to the things we want.
let t=et();return t.addClass("concertEditorPage"),t.find(".adminControls").remove(),t.find(".posterWrap").append(ea()),t.find(".title").replaceWith(eo({val:e.title})),t.find(".when").replaceWith(el(e.when)),t.find(".fbLink").remove(),t.find(".concertDetails").append(eu({val:e.facebook})),t.find(".concertDetails").append(es({id:e.id})),t})().appendTo(document.body),m().appendTo(document.body)}